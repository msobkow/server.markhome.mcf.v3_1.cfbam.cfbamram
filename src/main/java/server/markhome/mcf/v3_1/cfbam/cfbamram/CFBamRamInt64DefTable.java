	...
	implements ICFBamInt64DefTable
{
	...
	public ICFBamInt64Def createInt64Def( ICFSecAuthorization Authorization,
		ICFBamInt64Def iBuff )
	{
		final String S_ProcName = "createInt64Def";
		
		CFBamBuffInt64Def Buff = (CFBamBuffInt64Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt64Def.CLASS_CODE) {
	...
	public ICFBamInt64Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Def.lockDerived";
		ICFBamInt64Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt64Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffInt64Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public ICFBamInt64Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Def.readRec";
		ICFBamInt64Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt64Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt64Def.readAllRec";
		ICFBamInt64Def buff;
		ArrayList<ICFBamInt64Def> filteredList = new ArrayList<ICFBamInt64Def>();
		...
		int revision )
	{
		...
		return( (CFBamBuffInt64Def)editCur );
	}
	...
	public ICFBamInt64Def updateInt64Def( ICFSecAuthorization Authorization,
		ICFBamInt64Def iBuff )
	{
		CFBamBuffInt64Def Buff = (CFBamBuffInt64Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt64Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffInt64Def > subdict;
		...
		ICFBamInt64Def iBuff )
	{
		...
		CFBamBuffInt64Def Buff = (CFBamBuffInt64Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt64Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffInt64Def cur;
		LinkedList<CFBamBuffInt64Def> matchSet = new LinkedList<CFBamBuffInt64Def>();
		Iterator<CFBamBuffInt64Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt64Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt64Def)(schema.getTableInt64Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamInt64Def.CLASS_CODE == subClassCode ) {
