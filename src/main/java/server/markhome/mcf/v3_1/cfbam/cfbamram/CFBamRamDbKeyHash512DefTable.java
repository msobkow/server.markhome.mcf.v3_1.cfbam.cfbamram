...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash512Def.
	...
	implements ICFBamDbKeyHash512DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash512Def > dictByPKey
	...
	public ICFBamDbKeyHash512Def createDbKeyHash512Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash512Def";
		
		CFBamBuffDbKeyHash512Def Buff = (CFBamBuffDbKeyHash512Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash512Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash512Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Def.lockDerived";
		ICFBamDbKeyHash512Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash512Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash512Def[] retList = new ICFBamDbKeyHash512Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash512Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash512Def ) {
			return( (ICFBamDbKeyHash512Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash512Def ) ) {
					filteredList.add( (ICFBamDbKeyHash512Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash512Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash512Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Def.readRec";
		ICFBamDbKeyHash512Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash512Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Def.readAllRec";
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash512Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash512Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash512Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash512Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Def buff;
		ArrayList<ICFBamDbKeyHash512Def> filteredList = new ArrayList<ICFBamDbKeyHash512Def>();
		ICFBamDbKeyHash512Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash512Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash512Def)editCur );
	}
	...
	public ICFBamDbKeyHash512Def updateDbKeyHash512Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Def iBuff )
	{
		CFBamBuffDbKeyHash512Def Buff = (CFBamBuffDbKeyHash512Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash512Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Def > subdict;
		...
		ICFBamDbKeyHash512Def iBuff )
	{
		...
		CFBamBuffDbKeyHash512Def Buff = (CFBamBuffDbKeyHash512Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash512Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffDbKeyHash512Def cur;
		LinkedList<CFBamBuffDbKeyHash512Def> matchSet = new LinkedList<CFBamBuffDbKeyHash512Def>();
		Iterator<CFBamBuffDbKeyHash512Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash512Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash512Def)(schema.getTableDbKeyHash512Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash512Def.CLASS_CODE == subClassCode ) {
