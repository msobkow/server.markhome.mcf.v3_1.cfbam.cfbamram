	...
	implements ICFBamScopeTable
{
		...
		ICFBamScope iBuff )
	{
		...
		CFBamBuffScopeByTenantIdxKey keyTenantIdx = (CFBamBuffScopeByTenantIdxKey)schema.getCFBamBuffFactory().getFactoryScope().newByTenantIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffScope > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< ICFLibKeyHash256, CFBamBuffScope >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamScope.CLASS_CODE) {
				CFBamBuffScope retbuff = ((CFBamBuffScope)(schema.getCFBamBuffFactory().getFactoryScope().newRec()));
				retbuff.set(Buff);
				return( retbuff );
			}
				...
				CFBamBuffClearDep retbuff = ((CFBamBuffClearDep)(schema.getCFBamBuffFactory().getFactoryClearDep().newRec()));
				...
				CFBamBuffClearSubDep3 retbuff = ((CFBamBuffClearSubDep3)(schema.getCFBamBuffFactory().getFactoryClearSubDep3().newRec()));
				...
				CFBamBuffDelDep retbuff = ((CFBamBuffDelDep)(schema.getCFBamBuffFactory().getFactoryDelDep().newRec()));
				...
				CFBamBuffDelSubDep2 retbuff = ((CFBamBuffDelSubDep2)(schema.getCFBamBuffFactory().getFactoryDelSubDep2().newRec()));
				...
				CFBamBuffPopDep retbuff = ((CFBamBuffPopDep)(schema.getCFBamBuffFactory().getFactoryPopDep().newRec()));
				retbuff.set((ICFBamPopDep)Buff);
				return( retbuff );
			}
			else if (classCode == ICFBamPopSubDep1.CLASS_CODE) {
				CFBamBuffPopSubDep1 retbuff = ((CFBamBuffPopSubDep1)(schema.getCFBamBuffFactory().getFactoryPopSubDep1().newRec()));
				...
				CFBamBuffPopSubDep3 retbuff = ((CFBamBuffPopSubDep3)(schema.getCFBamBuffFactory().getFactoryPopSubDep3().newRec()));
				retbuff.set((ICFBamPopSubDep3)Buff);
				return( retbuff );
			}
			else if (classCode == ICFBamPopTopDep.CLASS_CODE) {
				CFBamBuffPopTopDep retbuff = ((CFBamBuffPopTopDep)(schema.getCFBamBuffFactory().getFactoryPopTopDep().newRec()));
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffScope > subdictTenantIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffScope >();
		...
		ICFBamScope iBuff )
	{
		...
		CFBamBuffScopeByTenantIdxKey existingKeyTenantIdx = (CFBamBuffScopeByTenantIdxKey)schema.getCFBamBuffFactory().getFactoryScope().newByTenantIdxKey();
		existingKeyTenantIdx.setRequiredTenantId( existing.getRequiredTenantId() );

		CFBamBuffScopeByTenantIdxKey newKeyTenantIdx = (CFBamBuffScopeByTenantIdxKey)schema.getCFBamBuffFactory().getFactoryScope().newByTenantIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffScope > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffScope >();
