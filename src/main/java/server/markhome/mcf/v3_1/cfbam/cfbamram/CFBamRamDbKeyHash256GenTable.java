...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash256Gen.
	...
	implements ICFBamDbKeyHash256GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Gen > dictByPKey
	...
	public ICFBamDbKeyHash256Gen createDbKeyHash256Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Gen iBuff )
	{
		final String S_ProcName = "createDbKeyHash256Gen";
		
		CFBamBuffDbKeyHash256Gen Buff = (CFBamBuffDbKeyHash256Gen)(schema.getTableDbKeyHash256Type().createDbKeyHash256Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash256Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash256Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash256Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.lockDerived";
		ICFBamDbKeyHash256Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash256Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash256Gen[] retList = new ICFBamDbKeyHash256Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash256Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash256Gen ) {
			return( (ICFBamDbKeyHash256Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash256Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash256Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash256Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash256Type buffList[] = schema.getTableDbKeyHash256Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash256Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readRec";
		ICFBamDbKeyHash256Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash256Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readAllRec";
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash256Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash256Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash256Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash256Gen buff;
		ArrayList<ICFBamDbKeyHash256Gen> filteredList = new ArrayList<ICFBamDbKeyHash256Gen>();
		ICFBamDbKeyHash256Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash256Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash256Gen)editCur );
	}
	...
	public ICFBamDbKeyHash256Gen updateDbKeyHash256Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Gen iBuff )
	{
		CFBamBuffDbKeyHash256Gen Buff = (CFBamBuffDbKeyHash256Gen)(schema.getTableDbKeyHash256Type().updateDbKeyHash256Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash256Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Gen > subdict;
		...
		ICFBamDbKeyHash256Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash256Gen Buff = (CFBamBuffDbKeyHash256Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash256Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash256Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash256Gen> matchSet = new LinkedList<CFBamBuffDbKeyHash256Gen>();
		Iterator<CFBamBuffDbKeyHash256Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash256Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash256Gen)(schema.getTableDbKeyHash256Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
