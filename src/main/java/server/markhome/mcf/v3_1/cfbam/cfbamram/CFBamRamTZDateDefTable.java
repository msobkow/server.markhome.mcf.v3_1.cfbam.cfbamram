...
// Description: Java 25 in-memory RAM DbIO implementation for TZDateDef.
	...
	implements ICFBamTZDateDefTable
{
		...
		ICFBamTZDateDef iBuff )
	{
		...
		CFBamBuffTZDateDef Buff = (CFBamBuffTZDateDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZDateDef.CLASS_CODE) {
	...
	public ICFBamTZDateDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateDef.lockDerived";
		ICFBamTZDateDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZDateDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffTZDateDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTZDateDef ) {
			return( (ICFBamTZDateDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTZDateDef ) ) {
					filteredList.add( (ICFBamTZDateDef)buff );
				}
			}
	...
	public ICFBamTZDateDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateDef.readRec";
		ICFBamTZDateDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZDateDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public ICFBamTZDateDef[] readAllRec( ICFSecAuthorization Authorization )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZDateDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTZDateDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTZDateDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTZDateDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZDateDef buff;
		ArrayList<ICFBamTZDateDef> filteredList = new ArrayList<ICFBamTZDateDef>();
		ICFBamTZDateDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffTZDateDef)editCur );
	}
	...
	public ICFBamTZDateDef updateTZDateDef( ICFSecAuthorization Authorization,
		ICFBamTZDateDef iBuff )
	{
		CFBamBuffTZDateDef Buff = (CFBamBuffTZDateDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZDateDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffTZDateDef > subdict;
		...
		ICFBamTZDateDef iBuff )
	{
		...
		CFBamBuffTZDateDef Buff = (CFBamBuffTZDateDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZDateDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffTZDateDef cur;
		LinkedList<CFBamBuffTZDateDef> matchSet = new LinkedList<CFBamBuffTZDateDef>();
		Iterator<CFBamBuffTZDateDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZDateDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZDateDef)(schema.getTableTZDateDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamTZDateDef.CLASS_CODE == subClassCode ) {
