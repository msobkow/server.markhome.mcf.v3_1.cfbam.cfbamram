...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash128Def.
	...
	implements ICFBamDbKeyHash128DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash128Def > dictByPKey
	...
	public ICFBamDbKeyHash128Def createDbKeyHash128Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash128Def";
		
		CFBamBuffDbKeyHash128Def Buff = (CFBamBuffDbKeyHash128Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash128Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash128Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Def.lockDerived";
		ICFBamDbKeyHash128Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash128Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash128Def[] retList = new ICFBamDbKeyHash128Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash128Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash128Def ) {
			return( (ICFBamDbKeyHash128Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash128Def ) ) {
					filteredList.add( (ICFBamDbKeyHash128Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash128Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash128Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Def.readRec";
		ICFBamDbKeyHash128Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash128Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Def.readAllRec";
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash128Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash128Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash128Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash128Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Def buff;
		ArrayList<ICFBamDbKeyHash128Def> filteredList = new ArrayList<ICFBamDbKeyHash128Def>();
		ICFBamDbKeyHash128Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash128Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash128Def)editCur );
	}
	...
	public ICFBamDbKeyHash128Def updateDbKeyHash128Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Def iBuff )
	{
		CFBamBuffDbKeyHash128Def Buff = (CFBamBuffDbKeyHash128Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash128Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Def > subdict;
		...
		ICFBamDbKeyHash128Def iBuff )
	{
		...
		CFBamBuffDbKeyHash128Def Buff = (CFBamBuffDbKeyHash128Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash128Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffDbKeyHash128Def cur;
		LinkedList<CFBamBuffDbKeyHash128Def> matchSet = new LinkedList<CFBamBuffDbKeyHash128Def>();
		Iterator<CFBamBuffDbKeyHash128Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash128Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash128Def)(schema.getTableDbKeyHash128Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash128Def.CLASS_CODE == subClassCode ) {
