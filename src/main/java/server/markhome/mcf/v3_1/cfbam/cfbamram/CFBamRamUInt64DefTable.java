...
// Description: Java 25 in-memory RAM DbIO implementation for UInt64Def.
	...
	implements ICFBamUInt64DefTable
{
	...
	public ICFBamUInt64Def createUInt64Def( ICFSecAuthorization Authorization,
		ICFBamUInt64Def iBuff )
	{
		final String S_ProcName = "createUInt64Def";
		
		CFBamBuffUInt64Def Buff = (CFBamBuffUInt64Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt64Def.CLASS_CODE) {
	...
	public ICFBamUInt64Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Def.lockDerived";
		ICFBamUInt64Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt64Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt64Def[] retList = new ICFBamUInt64Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt64Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt64Def ) {
			return( (ICFBamUInt64Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt64Def ) ) {
					filteredList.add( (ICFBamUInt64Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt64Def[0] ) );
		}
	}
	...
	public ICFBamUInt64Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Def.readRec";
		ICFBamUInt64Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt64Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt64Def.readAllRec";
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt64Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt64Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt64Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt64Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Def buff;
		ArrayList<ICFBamUInt64Def> filteredList = new ArrayList<ICFBamUInt64Def>();
		ICFBamUInt64Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt64Def)editCur );
	}
	...
	public ICFBamUInt64Def updateUInt64Def( ICFSecAuthorization Authorization,
		ICFBamUInt64Def iBuff )
	{
		CFBamBuffUInt64Def Buff = (CFBamBuffUInt64Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt64Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt64Def > subdict;
		...
		ICFBamUInt64Def iBuff )
	{
		...
		CFBamBuffUInt64Def Buff = (CFBamBuffUInt64Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt64Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffUInt64Def cur;
		LinkedList<CFBamBuffUInt64Def> matchSet = new LinkedList<CFBamBuffUInt64Def>();
		Iterator<CFBamBuffUInt64Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt64Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt64Def)(schema.getTableUInt64Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamUInt64Def.CLASS_CODE == subClassCode ) {
