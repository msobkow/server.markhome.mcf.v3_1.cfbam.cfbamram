...
// Description: Java 25 in-memory RAM DbIO implementation for TimestampDef.
	...
	implements ICFBamTimestampDefTable
{
	...
	public ICFBamTimestampDef createTimestampDef( ICFSecAuthorization Authorization,
		ICFBamTimestampDef iBuff )
	{
		final String S_ProcName = "createTimestampDef";
		
		CFBamBuffTimestampDef Buff = (CFBamBuffTimestampDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTimestampDef.CLASS_CODE) {
	...
	public ICFBamTimestampDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTimestampDef.lockDerived";
		ICFBamTimestampDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTimestampDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffTimestampDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public ICFBamTimestampDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTimestampDef.readRec";
		ICFBamTimestampDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTimestampDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTimestampDef.readAllRec";
		ICFBamTimestampDef buff;
		ArrayList<ICFBamTimestampDef> filteredList = new ArrayList<ICFBamTimestampDef>();
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTimestampDef)cur );
		}
		...
		return( (CFBamBuffTimestampDef)editCur );
	}
	...
	public ICFBamTimestampDef updateTimestampDef( ICFSecAuthorization Authorization,
		ICFBamTimestampDef iBuff )
	{
		CFBamBuffTimestampDef Buff = (CFBamBuffTimestampDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTimestampDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffTimestampDef > subdict;
		...
		ICFBamTimestampDef iBuff )
	{
		...
		CFBamBuffTimestampDef Buff = (CFBamBuffTimestampDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTimestampDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamTimestampDef.CLASS_CODE == subClassCode ) {
