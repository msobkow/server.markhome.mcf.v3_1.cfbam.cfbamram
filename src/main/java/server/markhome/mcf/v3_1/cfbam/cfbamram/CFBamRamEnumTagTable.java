	...
	implements ICFBamEnumTagTable
{
		...
		ICFBamEnumTag iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffEnumTag > subdictEnumIdx;
		if( dictByEnumIdx.containsKey( keyEnumIdx ) ) {
			subdictEnumIdx = dictByEnumIdx.get( keyEnumIdx );
		}
		else {
			subdictEnumIdx = new HashMap< ICFLibKeyHash256, CFBamBuffEnumTag >();
			dictByEnumIdx.put( keyEnumIdx, subdictEnumIdx );
		}
		subdictEnumIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFBamBuffEnumTag > subdictDefSchemaIdx;
		if( dictByDefSchemaIdx.containsKey( keyDefSchemaIdx ) ) {
			subdictDefSchemaIdx = dictByDefSchemaIdx.get( keyDefSchemaIdx );
		}
		else {
			subdictDefSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffEnumTag >();
		...
		ICFLibKeyHash256 EnumId )
	{
		...
		if( dictByEnumIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffEnumTag > subdictEnumIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffEnumTag >();
		...
		ICFBamEnumTag iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffEnumTag > subdict;
		...
		if( dictByEnumIdx.containsKey( newKeyEnumIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffEnumTag >();
		...
		ICFBamEnumTag iBuff )
	{
		...
		ICFLibKeyHash256 varEnumId = existing.getRequiredEnumId();
