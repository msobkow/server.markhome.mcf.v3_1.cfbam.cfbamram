...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash160Gen.
	...
	implements ICFBamDbKeyHash160GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Gen > dictByPKey
	...
	public ICFBamDbKeyHash160Gen createDbKeyHash160Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Gen iBuff )
	{
		final String S_ProcName = "createDbKeyHash160Gen";
		
		CFBamBuffDbKeyHash160Gen Buff = (CFBamBuffDbKeyHash160Gen)(schema.getTableDbKeyHash160Type().createDbKeyHash160Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash160Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash160Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash160Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.lockDerived";
		ICFBamDbKeyHash160Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash160Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash160Gen[] retList = new ICFBamDbKeyHash160Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash160Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash160Gen ) {
			return( (ICFBamDbKeyHash160Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash160Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash160Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash160Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash160Type buffList[] = schema.getTableDbKeyHash160Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash160Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readRec";
		ICFBamDbKeyHash160Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash160Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readAllRec";
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash160Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash160Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash160Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash160Gen buff;
		ArrayList<ICFBamDbKeyHash160Gen> filteredList = new ArrayList<ICFBamDbKeyHash160Gen>();
		ICFBamDbKeyHash160Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash160Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash160Gen)editCur );
	}
	...
	public ICFBamDbKeyHash160Gen updateDbKeyHash160Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Gen iBuff )
	{
		CFBamBuffDbKeyHash160Gen Buff = (CFBamBuffDbKeyHash160Gen)(schema.getTableDbKeyHash160Type().updateDbKeyHash160Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash160Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Gen > subdict;
		...
		ICFBamDbKeyHash160Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash160Gen Buff = (CFBamBuffDbKeyHash160Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash160Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash160Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash160Gen> matchSet = new LinkedList<CFBamBuffDbKeyHash160Gen>();
		Iterator<CFBamBuffDbKeyHash160Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash160Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash160Gen)(schema.getTableDbKeyHash160Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
