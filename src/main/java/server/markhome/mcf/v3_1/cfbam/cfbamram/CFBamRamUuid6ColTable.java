	...
	implements ICFBamUuid6ColTable
{
		...
		ICFBamUuid6Col iBuff )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey keyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Col >();
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey key = (CFBamBuffUuid6ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Col().newByTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUuid6Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Col >();
		...
		ICFBamUuid6Col iBuff )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuid6ColByTableIdxKey newKeyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Col >();
