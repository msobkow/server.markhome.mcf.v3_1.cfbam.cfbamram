	...
	implements ICFBamUuid6ColTable
{
		...
		ICFBamUuid6Col iBuff )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey keyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getFactoryUuid6Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey key = (CFBamBuffUuid6ColByTableIdxKey)schema.getFactoryUuid6Col().newByTableIdxKey();
		...
		ICFBamUuid6Col iBuff )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getFactoryUuid6Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuid6ColByTableIdxKey newKeyTableIdx = (CFBamBuffUuid6ColByTableIdxKey)schema.getFactoryUuid6Col().newByTableIdxKey();
