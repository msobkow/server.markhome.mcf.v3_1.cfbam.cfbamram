...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash384Def.
	...
	implements ICFBamDbKeyHash384DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Def > dictByPKey
	...
	public ICFBamDbKeyHash384Def createDbKeyHash384Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash384Def";
		
		CFBamBuffDbKeyHash384Def Buff = (CFBamBuffDbKeyHash384Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash384Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash384Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Def.lockDerived";
		ICFBamDbKeyHash384Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash384Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash384Def[] retList = new ICFBamDbKeyHash384Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash384Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash384Def ) {
			return( (ICFBamDbKeyHash384Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash384Def ) ) {
					filteredList.add( (ICFBamDbKeyHash384Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash384Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash384Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Def.readRec";
		ICFBamDbKeyHash384Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash384Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Def.readAllRec";
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash384Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash384Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash384Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Def buff;
		ArrayList<ICFBamDbKeyHash384Def> filteredList = new ArrayList<ICFBamDbKeyHash384Def>();
		ICFBamDbKeyHash384Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash384Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash384Def)editCur );
	}
	...
	public ICFBamDbKeyHash384Def updateDbKeyHash384Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Def iBuff )
	{
		CFBamBuffDbKeyHash384Def Buff = (CFBamBuffDbKeyHash384Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash384Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Def > subdict;
		...
		ICFBamDbKeyHash384Def iBuff )
	{
		...
		CFBamBuffDbKeyHash384Def Buff = (CFBamBuffDbKeyHash384Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash384Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffDbKeyHash384Def cur;
		LinkedList<CFBamBuffDbKeyHash384Def> matchSet = new LinkedList<CFBamBuffDbKeyHash384Def>();
		Iterator<CFBamBuffDbKeyHash384Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash384Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash384Def)(schema.getTableDbKeyHash384Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash384Def.CLASS_CODE == subClassCode ) {
