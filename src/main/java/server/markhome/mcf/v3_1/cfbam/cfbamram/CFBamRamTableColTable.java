	...
	implements ICFBamTableColTable
{
		...
		ICFBamTableCol iBuff )
	{
		...
		CFBamBuffTableColByTableIdxKey keyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getFactoryTableCol().newByTableIdxKey();
		keyTableIdx.setRequiredTableId( Buff.getRequiredTableId() );

		CFBamBuffTableColByDataIdxKey keyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getFactoryTableCol().newByDataIdxKey();
		...
		ICFBamTableCol iBuff )
	{
		...
		CFBamBuffTableColByTableIdxKey existingKeyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getFactoryTableCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTableColByTableIdxKey newKeyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getFactoryTableCol().newByTableIdxKey();
		newKeyTableIdx.setRequiredTableId( Buff.getRequiredTableId() );

		CFBamBuffTableColByDataIdxKey existingKeyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getFactoryTableCol().newByDataIdxKey();
		existingKeyDataIdx.setOptionalDataId( existing.getOptionalDataId() );

		CFBamBuffTableColByDataIdxKey newKeyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getFactoryTableCol().newByDataIdxKey();
