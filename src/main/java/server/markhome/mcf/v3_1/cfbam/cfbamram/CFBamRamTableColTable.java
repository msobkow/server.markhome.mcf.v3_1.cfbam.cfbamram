	...
	implements ICFBamTableColTable
{
		...
		ICFBamTableCol iBuff )
	{
		...
		CFBamBuffTableColByTableIdxKey keyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByTableIdxKey();
		keyTableIdx.setRequiredTableId( Buff.getRequiredTableId() );

		CFBamBuffTableColByDataIdxKey keyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByDataIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTableColByTableIdxKey key = (CFBamBuffTableColByTableIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 DataId )
	{
		...
		CFBamBuffTableColByDataIdxKey key = (CFBamBuffTableColByDataIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByDataIdxKey();
		...
		ICFBamTableCol iBuff )
	{
		...
		CFBamBuffTableColByTableIdxKey existingKeyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTableColByTableIdxKey newKeyTableIdx = (CFBamBuffTableColByTableIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByTableIdxKey();
		newKeyTableIdx.setRequiredTableId( Buff.getRequiredTableId() );

		CFBamBuffTableColByDataIdxKey existingKeyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByDataIdxKey();
		existingKeyDataIdx.setOptionalDataId( existing.getOptionalDataId() );

		CFBamBuffTableColByDataIdxKey newKeyDataIdx = (CFBamBuffTableColByDataIdxKey)schema.getCFBamFactory().getFactoryTableCol().newByDataIdxKey();
