	...
	implements ICFBamDbKeyHash512TypeTable
{
		...
		ICFBamDbKeyHash512Type iBuff )
	{
		...
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type >();
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type >();
		...
		ICFBamDbKeyHash512Type iBuff )
	{
		...
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash512TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Type >();
