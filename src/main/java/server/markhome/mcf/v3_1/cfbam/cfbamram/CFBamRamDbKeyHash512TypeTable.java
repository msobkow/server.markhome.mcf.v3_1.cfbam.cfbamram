	...
	implements ICFBamDbKeyHash512TypeTable
{
		...
		ICFBamDbKeyHash512Type iBuff )
	{
		...
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash512Type iBuff )
	{
		...
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash512TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
