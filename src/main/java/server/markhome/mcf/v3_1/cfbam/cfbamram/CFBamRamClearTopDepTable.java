	...
	implements ICFBamClearTopDepTable
{
		...
		ICFBamClearTopDep iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearTopDep > subdictClrTopDepTblIdx;
		if( dictByClrTopDepTblIdx.containsKey( keyClrTopDepTblIdx ) ) {
			...
			subdictClrTopDepTblIdx = new HashMap< ICFLibKeyHash256, CFBamBuffClearTopDep >();
		...
		Map< ICFLibKeyHash256, CFBamBuffClearTopDep > subdictPrevIdx;
		if( dictByPrevIdx.containsKey( keyPrevIdx ) ) {
			subdictPrevIdx = dictByPrevIdx.get( keyPrevIdx );
		}
		else {
			subdictPrevIdx = new HashMap< ICFLibKeyHash256, CFBamBuffClearTopDep >();
			dictByPrevIdx.put( keyPrevIdx, subdictPrevIdx );
		}
		subdictPrevIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFBamBuffClearTopDep > subdictNextIdx;
		if( dictByNextIdx.containsKey( keyNextIdx ) ) {
			subdictNextIdx = dictByNextIdx.get( keyNextIdx );
		}
		else {
			subdictNextIdx = new HashMap< ICFLibKeyHash256, CFBamBuffClearTopDep >();
		...
		ICFLibKeyHash256 TableId )
	{
		...
		if( dictByClrTopDepTblIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffClearTopDep > subdictClrTopDepTblIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffClearTopDep >();
		...
		ICFBamClearTopDep iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearTopDep > subdict;
		...
		if( dictByClrTopDepTblIdx.containsKey( newKeyClrTopDepTblIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffClearTopDep >();
