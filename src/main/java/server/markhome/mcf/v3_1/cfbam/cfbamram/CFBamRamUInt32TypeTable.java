	...
	implements ICFBamUInt32TypeTable
{
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey key = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getFactoryUInt32Type().newBySchemaIdxKey();
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getFactoryUInt32Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt32TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getFactoryUInt32Type().newBySchemaIdxKey();
