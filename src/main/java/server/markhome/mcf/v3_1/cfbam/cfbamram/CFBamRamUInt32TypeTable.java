...
// Description: Java 25 in-memory RAM DbIO implementation for UInt32Type.
	...
	implements ICFBamUInt32TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt32Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt32Type >();
	private Map< CFBamBuffUInt32TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt32Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffUInt32TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt32Type >>();
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32Type Buff = (CFBamBuffUInt32Type)(schema.getTableUInt32Def().createUInt32Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUInt32Type.CLASS_CODE ) {
		...
		CFBamBuffUInt32TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt32Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt32Type.CLASS_CODE) {
	...
	public ICFBamUInt32Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Type.lockDerived";
		ICFBamUInt32Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt32Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt32Type[] retList = new ICFBamUInt32Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt32Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt32Type ) {
			return( (ICFBamUInt32Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt32Type ) ) {
					filteredList.add( (ICFBamUInt32Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt32Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey key = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamUInt32Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUInt32Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamUInt32Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffUInt32Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt32Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamUInt32Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt32Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Type.readRec";
		ICFBamUInt32Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt32Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt32Type.readAllRec";
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt32Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt32Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt32Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt32Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt32Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUInt32Type.readRecBySchemaIdx() ";
		ICFBamUInt32Type buff;
		ArrayList<ICFBamUInt32Type> filteredList = new ArrayList<ICFBamUInt32Type>();
		ICFBamUInt32Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt32Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffUInt32Type)cur );
		}
		...
		return( (CFBamBuffUInt32Type)editCur );
	}
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt32TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt32Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Type >();
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32Type Buff = (CFBamBuffUInt32Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt32Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUInt32Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUInt32Type> matchSet = new LinkedList<CFBamBuffUInt32Type>();
		Iterator<CFBamBuffUInt32Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt32Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt32Type)(schema.getTableUInt32Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
