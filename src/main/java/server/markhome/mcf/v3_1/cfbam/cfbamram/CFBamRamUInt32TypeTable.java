	...
	implements ICFBamUInt32TypeTable
{
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey key = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		...
		ICFBamUInt32Type iBuff )
	{
		...
		CFBamBuffUInt32TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt32Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt32TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt32TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt32Type().newBySchemaIdxKey();
