	...
	implements ICFBamDelSubDep2Table
{
		...
		ICFBamDelSubDep2 iBuff )
	{
		...
		CFBamBuffDelSubDep2ByContDelDep1IdxKey keyContDelDep1Idx = (CFBamBuffDelSubDep2ByContDelDep1IdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByContDelDep1IdxKey();
		keyContDelDep1Idx.setRequiredDelSubDep1Id( Buff.getRequiredDelSubDep1Id() );

		CFBamBuffDelSubDep2ByUNameIdxKey keyUNameIdx = (CFBamBuffDelSubDep2ByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByUNameIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep2 > subdictContDelDep1Idx;
		if( dictByContDelDep1Idx.containsKey( keyContDelDep1Idx ) ) {
			subdictContDelDep1Idx = dictByContDelDep1Idx.get( keyContDelDep1Idx );
		}
		else {
			subdictContDelDep1Idx = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep2 >();
		...
		ICFLibKeyHash256 DelSubDep1Id )
	{
		...
		CFBamBuffDelSubDep2ByContDelDep1IdxKey key = (CFBamBuffDelSubDep2ByContDelDep1IdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByContDelDep1IdxKey();
		...
		if( dictByContDelDep1Idx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDelSubDep2 > subdictContDelDep1Idx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep2 >();
		...
		String Name )
	{
		...
		CFBamBuffDelSubDep2ByUNameIdxKey key = (CFBamBuffDelSubDep2ByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByUNameIdxKey();
		...
		ICFBamDelSubDep2 iBuff )
	{
		...
		CFBamBuffDelSubDep2ByContDelDep1IdxKey existingKeyContDelDep1Idx = (CFBamBuffDelSubDep2ByContDelDep1IdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByContDelDep1IdxKey();
		existingKeyContDelDep1Idx.setRequiredDelSubDep1Id( existing.getRequiredDelSubDep1Id() );

		CFBamBuffDelSubDep2ByContDelDep1IdxKey newKeyContDelDep1Idx = (CFBamBuffDelSubDep2ByContDelDep1IdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByContDelDep1IdxKey();
		newKeyContDelDep1Idx.setRequiredDelSubDep1Id( Buff.getRequiredDelSubDep1Id() );

		CFBamBuffDelSubDep2ByUNameIdxKey existingKeyUNameIdx = (CFBamBuffDelSubDep2ByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByUNameIdxKey();
		existingKeyUNameIdx.setRequiredDelSubDep1Id( existing.getRequiredDelSubDep1Id() );
		existingKeyUNameIdx.setRequiredName( existing.getRequiredName() );

		CFBamBuffDelSubDep2ByUNameIdxKey newKeyUNameIdx = (CFBamBuffDelSubDep2ByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryDelSubDep2().newByUNameIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep2 > subdict;
		...
		if( dictByContDelDep1Idx.containsKey( newKeyContDelDep1Idx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep2 >();
