...
// Description: Java 25 in-memory RAM DbIO implementation for Uuid6Gen.
	...
	implements ICFBamUuid6GenTable
{
	...
	public ICFBamUuid6Gen createUuid6Gen( ICFSecAuthorization Authorization,
		ICFBamUuid6Gen iBuff )
	{
		final String S_ProcName = "createUuid6Gen";
		
		CFBamBuffUuid6Gen Buff = (CFBamBuffUuid6Gen)(schema.getTableUuid6Type().createUuid6Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUuid6Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuid6Gen.CLASS_CODE) {
	...
	public ICFBamUuid6Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.lockDerived";
		ICFBamUuid6Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuid6Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuid6Gen[] retList = new ICFBamUuid6Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuid6Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuid6Gen ) {
			return( (ICFBamUuid6Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuid6Gen ) ) {
					filteredList.add( (ICFBamUuid6Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuid6Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamUuid6Type buffList[] = schema.getTableUuid6Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamUuid6Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readRec";
		ICFBamUuid6Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuid6Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readAllRec";
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuid6Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuid6Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuid6Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuid6Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamUuid6Gen buff;
		ArrayList<ICFBamUuid6Gen> filteredList = new ArrayList<ICFBamUuid6Gen>();
		ICFBamUuid6Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffUuid6Gen)editCur );
	}
	...
	public ICFBamUuid6Gen updateUuid6Gen( ICFSecAuthorization Authorization,
		ICFBamUuid6Gen iBuff )
	{
		CFBamBuffUuid6Gen Buff = (CFBamBuffUuid6Gen)(schema.getTableUuid6Type().updateUuid6Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuid6Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Gen > subdict;
		...
		ICFBamUuid6Gen iBuff )
	{
		...
		CFBamBuffUuid6Gen Buff = (CFBamBuffUuid6Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuid6Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUuid6Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUuid6Gen> matchSet = new LinkedList<CFBamBuffUuid6Gen>();
		Iterator<CFBamBuffUuid6Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuid6Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUuid6Gen)(schema.getTableUuid6Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
