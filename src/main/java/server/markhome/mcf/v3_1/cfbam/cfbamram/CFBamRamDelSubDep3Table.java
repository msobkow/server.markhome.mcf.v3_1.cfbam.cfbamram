	...
	implements ICFBamDelSubDep3Table
{
		...
		ICFBamDelSubDep3 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep3 > subdictDelSubDep2Idx;
		if( dictByDelSubDep2Idx.containsKey( keyDelSubDep2Idx ) ) {
			subdictDelSubDep2Idx = dictByDelSubDep2Idx.get( keyDelSubDep2Idx );
		}
		else {
			subdictDelSubDep2Idx = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep3 >();
		...
		ICFLibKeyHash256 DelSubDep2Id )
	{
		...
		if( dictByDelSubDep2Idx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDelSubDep3 > subdictDelSubDep2Idx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep3 >();
		...
		ICFBamDelSubDep3 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep3 > subdict;
		...
		if( dictByDelSubDep2Idx.containsKey( newKeyDelSubDep2Idx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep3 >();
