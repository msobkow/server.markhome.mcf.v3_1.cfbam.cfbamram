...
// Description: Java 25 in-memory RAM DbIO implementation for UInt32Def.
	...
	implements ICFBamUInt32DefTable
{
	...
	public ICFBamUInt32Def createUInt32Def( ICFSecAuthorization Authorization,
		ICFBamUInt32Def iBuff )
	{
		final String S_ProcName = "createUInt32Def";
		
		CFBamBuffUInt32Def Buff = (CFBamBuffUInt32Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt32Def.CLASS_CODE) {
	...
	public ICFBamUInt32Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Def.lockDerived";
		ICFBamUInt32Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt32Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt32Def[] retList = new ICFBamUInt32Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt32Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt32Def ) {
			return( (ICFBamUInt32Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt32Def ) ) {
					filteredList.add( (ICFBamUInt32Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt32Def[0] ) );
		}
	}
	...
	public ICFBamUInt32Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Def.readRec";
		ICFBamUInt32Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt32Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt32Def.readAllRec";
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt32Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt32Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt32Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt32Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Def buff;
		ArrayList<ICFBamUInt32Def> filteredList = new ArrayList<ICFBamUInt32Def>();
		ICFBamUInt32Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt32Def)editCur );
	}
	...
	public ICFBamUInt32Def updateUInt32Def( ICFSecAuthorization Authorization,
		ICFBamUInt32Def iBuff )
	{
		CFBamBuffUInt32Def Buff = (CFBamBuffUInt32Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt32Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt32Def > subdict;
		...
		ICFBamUInt32Def iBuff )
	{
		...
		CFBamBuffUInt32Def Buff = (CFBamBuffUInt32Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt32Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffUInt32Def cur;
		LinkedList<CFBamBuffUInt32Def> matchSet = new LinkedList<CFBamBuffUInt32Def>();
		Iterator<CFBamBuffUInt32Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt32Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt32Def)(schema.getTableUInt32Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamUInt32Def.CLASS_CODE == subClassCode ) {
