	...
	implements ICFBamDbKeyHash512GenTable
{
	...
	{
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
