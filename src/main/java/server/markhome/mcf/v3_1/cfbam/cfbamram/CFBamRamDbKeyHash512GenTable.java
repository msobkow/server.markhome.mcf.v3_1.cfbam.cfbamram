...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash512Gen.
	...
	implements ICFBamDbKeyHash512GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash512Gen > dictByPKey
	...
	public ICFBamDbKeyHash512Gen createDbKeyHash512Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Gen iBuff )
	{
		final String S_ProcName = "createDbKeyHash512Gen";
		
		CFBamBuffDbKeyHash512Gen Buff = (CFBamBuffDbKeyHash512Gen)(schema.getTableDbKeyHash512Type().createDbKeyHash512Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash512Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash512Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash512Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.lockDerived";
		ICFBamDbKeyHash512Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash512Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash512Gen[] retList = new ICFBamDbKeyHash512Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash512Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash512Gen ) {
			return( (ICFBamDbKeyHash512Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash512Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash512Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash512Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash512Type buffList[] = schema.getTableDbKeyHash512Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash512Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readRec";
		ICFBamDbKeyHash512Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash512Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readAllRec";
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash512Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash512Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash512Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash512Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash512Gen buff;
		ArrayList<ICFBamDbKeyHash512Gen> filteredList = new ArrayList<ICFBamDbKeyHash512Gen>();
		ICFBamDbKeyHash512Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash512Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash512Gen)editCur );
	}
	...
	public ICFBamDbKeyHash512Gen updateDbKeyHash512Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Gen iBuff )
	{
		CFBamBuffDbKeyHash512Gen Buff = (CFBamBuffDbKeyHash512Gen)(schema.getTableDbKeyHash512Type().updateDbKeyHash512Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash512Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Gen > subdict;
		...
		ICFBamDbKeyHash512Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash512Gen Buff = (CFBamBuffDbKeyHash512Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash512Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash512TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash512TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Type().newBySchemaIdxKey();
	...
	{
		CFBamBuffDbKeyHash512Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash512Gen> matchSet = new LinkedList<CFBamBuffDbKeyHash512Gen>();
		Iterator<CFBamBuffDbKeyHash512Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash512Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash512Gen)(schema.getTableDbKeyHash512Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
