	...
	implements ICFBamUInt16TypeTable
{
		...
		ICFBamUInt16Type iBuff )
	{
		...
		CFBamBuffUInt16TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getFactoryUInt16Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt16TypeBySchemaIdxKey key = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getFactoryUInt16Type().newBySchemaIdxKey();
		...
		ICFBamUInt16Type iBuff )
	{
		...
		CFBamBuffUInt16TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getFactoryUInt16Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt16TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getFactoryUInt16Type().newBySchemaIdxKey();
