	...
	implements ICFBamUInt16TypeTable
{
		...
		ICFBamUInt16Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt16Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUInt16Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Type >();
		...
		ICFBamUInt16Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt16Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Type >();
