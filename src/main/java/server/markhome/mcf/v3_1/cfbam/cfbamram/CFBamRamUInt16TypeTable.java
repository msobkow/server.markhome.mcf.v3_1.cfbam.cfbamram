...
// Description: Java 25 in-memory RAM DbIO implementation for UInt16Type.
	...
	implements ICFBamUInt16TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt16Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt16Type >();
	private Map< CFBamBuffUInt16TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt16Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffUInt16TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt16Type >>();
	...
	public ICFBamUInt16Type createUInt16Type( ICFSecAuthorization Authorization,
		ICFBamUInt16Type iBuff )
	{
		final String S_ProcName = "createUInt16Type";
		
		CFBamBuffUInt16Type Buff = (CFBamBuffUInt16Type)(schema.getTableUInt16Def().createUInt16Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUInt16Type.CLASS_CODE ) {
		...
		CFBamBuffUInt16TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt16Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt16Type.CLASS_CODE) {
	...
	public ICFBamUInt16Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Type.lockDerived";
		ICFBamUInt16Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt16Type[] retList = new ICFBamUInt16Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt16Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt16Type ) {
			return( (ICFBamUInt16Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt16Type ) ) {
					filteredList.add( (ICFBamUInt16Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt16Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt16TypeBySchemaIdxKey key = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamUInt16Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUInt16Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamUInt16Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffUInt16Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt16Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamUInt16Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt16Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Type.readRec";
		ICFBamUInt16Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt16Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt16Type.readAllRec";
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt16Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt16Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt16Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt16Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt16Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUInt16Type.readRecBySchemaIdx() ";
		ICFBamUInt16Type buff;
		ArrayList<ICFBamUInt16Type> filteredList = new ArrayList<ICFBamUInt16Type>();
		ICFBamUInt16Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt16Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffUInt16Type)cur );
		}
		...
		return( (CFBamBuffUInt16Type)editCur );
	}
	...
	public ICFBamUInt16Type updateUInt16Type( ICFSecAuthorization Authorization,
		ICFBamUInt16Type iBuff )
	{
		CFBamBuffUInt16Type Buff = (CFBamBuffUInt16Type)(schema.getTableUInt16Def().updateUInt16Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt16Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt16TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt16TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt16Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Type >();
		...
		ICFBamUInt16Type iBuff )
	{
		...
		CFBamBuffUInt16Type Buff = (CFBamBuffUInt16Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt16Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
