	...
	implements ICFBamIndexColTable
{
		...
		ICFLibKeyHash256 IndexId )
	{
		...
		if( dictByIndexIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffIndexCol > subdictIndexIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffIndexCol >();
		...
		ICFBamIndexCol iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffIndexCol > subdict;
		...
		if( dictByIndexIdx.containsKey( newKeyIndexIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffIndexCol >();
		...
		ICFBamIndexCol iBuff )
	{
		...
		ICFLibKeyHash256 varIndexId = existing.getRequiredIndexId();
