...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash224Gen.
	...
	implements ICFBamDbKeyHash224GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Gen > dictByPKey
		...
		ICFBamDbKeyHash224Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash224Gen Buff = (CFBamBuffDbKeyHash224Gen)(schema.getTableDbKeyHash224Type().createDbKeyHash224Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash224Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash224Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash224Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.lockDerived";
		ICFBamDbKeyHash224Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash224Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffDbKeyHash224Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash224Gen ) {
			return( (ICFBamDbKeyHash224Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash224Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash224Gen)buff );
				}
			}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash224Type buffList[] = schema.getTableDbKeyHash224Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash224Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readRec";
		ICFBamDbKeyHash224Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash224Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public ICFBamDbKeyHash224Gen[] readAllRec( ICFSecAuthorization Authorization )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash224Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash224Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash224Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash224Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash224Gen buff;
		ArrayList<ICFBamDbKeyHash224Gen> filteredList = new ArrayList<ICFBamDbKeyHash224Gen>();
		ICFBamDbKeyHash224Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash224Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash224Gen)editCur );
	}
		...
		ICFBamDbKeyHash224Gen iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Gen > subdict;
		...
		ICFBamDbKeyHash224Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash224Gen Buff = (CFBamBuffDbKeyHash224Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash224Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash224Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash224Gen> matchSet = new LinkedList<CFBamBuffDbKeyHash224Gen>();
		Iterator<CFBamBuffDbKeyHash224Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash224Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash224Gen)(schema.getTableDbKeyHash224Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
