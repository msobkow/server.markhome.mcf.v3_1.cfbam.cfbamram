	...
	implements ICFBamBoolColTable
{
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolColByTableIdxKey keyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBoolColByTableIdxKey key = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolColByTableIdxKey existingKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBoolColByTableIdxKey newKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
