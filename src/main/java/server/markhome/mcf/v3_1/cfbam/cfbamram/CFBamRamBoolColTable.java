...
// Description: Java 25 in-memory RAM DbIO implementation for BoolCol.
	...
	implements ICFBamBoolColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffBoolCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffBoolCol >();
	private Map< CFBamBuffBoolColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBoolCol >> dictByTableIdx
		= new HashMap< CFBamBuffBoolColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBoolCol >>();
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolCol Buff = (CFBamBuffBoolCol)(schema.getTableBoolDef().createBoolDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamBoolCol.CLASS_CODE ) {
		...
		CFBamBuffBoolColByTableIdxKey keyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBoolCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBoolCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffBoolCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBoolCol.CLASS_CODE) {
	...
	public ICFBamBoolCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBoolCol.lockDerived";
		ICFBamBoolCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamBoolCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffBoolCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBoolCol ) {
			return( (ICFBamBoolCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBoolCol ) ) {
					filteredList.add( (ICFBamBoolCol)buff );
				}
			}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffBoolColByTableIdxKey key = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBoolCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamBoolCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffBoolCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamBoolCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffBoolCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffBoolCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffBoolCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamBoolCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamBoolCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBoolCol.readRec";
		ICFBamBoolCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBoolCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public ICFBamBoolCol[] readAllRec( ICFSecAuthorization Authorization )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBoolCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBoolCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBoolCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBoolCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamBoolCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamBoolCol.readRecByTableIdx() ";
		ICFBamBoolCol buff;
		ArrayList<ICFBamBoolCol> filteredList = new ArrayList<ICFBamBoolCol>();
		ICFBamBoolCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBoolCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffBoolCol)editCur );
	}
	...
	public ICFBamBoolCol updateBoolCol( ICFSecAuthorization Authorization,
		ICFBamBoolCol iBuff )
	{
		CFBamBuffBoolCol Buff = (CFBamBuffBoolCol)(schema.getTableBoolDef().updateBoolDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffBoolCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBoolColByTableIdxKey existingKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBoolCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBoolColByTableIdxKey newKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBoolCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBoolCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffBoolCol >();
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolCol Buff = (CFBamBuffBoolCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBoolCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffBoolCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffBoolCol> matchSet = new LinkedList<CFBamBuffBoolCol>();
		Iterator<CFBamBuffBoolCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffBoolCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffBoolCol)(schema.getTableBoolCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
