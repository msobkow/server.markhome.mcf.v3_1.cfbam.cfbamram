	...
	implements ICFBamBoolColTable
{
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolColByTableIdxKey keyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getFactoryBoolCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBoolColByTableIdxKey key = (CFBamBuffBoolColByTableIdxKey)schema.getFactoryBoolCol().newByTableIdxKey();
		...
		ICFBamBoolCol iBuff )
	{
		...
		CFBamBuffBoolColByTableIdxKey existingKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getFactoryBoolCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBoolColByTableIdxKey newKeyTableIdx = (CFBamBuffBoolColByTableIdxKey)schema.getFactoryBoolCol().newByTableIdxKey();
