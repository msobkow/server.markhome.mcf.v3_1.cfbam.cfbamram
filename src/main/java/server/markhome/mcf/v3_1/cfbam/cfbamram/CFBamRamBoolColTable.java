	...
	implements ICFBamBoolColTable
{
		...
		ICFBamBoolCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBoolCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffBoolCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffBoolCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffBoolCol >();
		...
		ICFBamBoolCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBoolCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffBoolCol >();
