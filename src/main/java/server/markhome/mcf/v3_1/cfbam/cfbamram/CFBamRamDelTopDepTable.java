	...
	implements ICFBamDelTopDepTable
{
		...
		ICFBamDelTopDep iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelTopDep > subdictDelTopDepTblIdx;
		if( dictByDelTopDepTblIdx.containsKey( keyDelTopDepTblIdx ) ) {
			...
			subdictDelTopDepTblIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDelTopDep >();
		...
		ICFLibKeyHash256 TableId )
	{
		...
		if( dictByDelTopDepTblIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDelTopDep > subdictDelTopDepTblIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDelTopDep >();
		...
		ICFBamDelTopDep iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelTopDep > subdict;
		...
		if( dictByDelTopDepTblIdx.containsKey( newKeyDelTopDepTblIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDelTopDep >();
