...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash256Def.
	...
	implements ICFBamDbKeyHash256DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Def > dictByPKey
	...
	public ICFBamDbKeyHash256Def createDbKeyHash256Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash256Def";
		
		CFBamBuffDbKeyHash256Def Buff = (CFBamBuffDbKeyHash256Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash256Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash256Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash256Def[] retList = new ICFBamDbKeyHash256Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash256Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash256Def ) {
			return( (ICFBamDbKeyHash256Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash256Def ) ) {
					filteredList.add( (ICFBamDbKeyHash256Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash256Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash256Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Def.readRec";
		ICFBamDbKeyHash256Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash256Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Def.readAllRec";
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash256Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash256Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash256Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Def buff;
		ArrayList<ICFBamDbKeyHash256Def> filteredList = new ArrayList<ICFBamDbKeyHash256Def>();
		ICFBamDbKeyHash256Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash256Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash256Def)editCur );
	}
	...
	public ICFBamDbKeyHash256Def updateDbKeyHash256Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Def iBuff )
	{
		CFBamBuffDbKeyHash256Def Buff = (CFBamBuffDbKeyHash256Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash256Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Def > subdict;
		...
		ICFBamDbKeyHash256Def iBuff )
	{
		...
		CFBamBuffDbKeyHash256Def Buff = (CFBamBuffDbKeyHash256Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash256Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffDbKeyHash256Def cur;
		LinkedList<CFBamBuffDbKeyHash256Def> matchSet = new LinkedList<CFBamBuffDbKeyHash256Def>();
		Iterator<CFBamBuffDbKeyHash256Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash256Def> iterMatch = matchSet.iterator();
