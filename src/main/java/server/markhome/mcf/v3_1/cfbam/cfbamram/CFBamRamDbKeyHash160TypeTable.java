...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash160Type.
	...
	implements ICFBamDbKeyHash160TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Type >();
	private Map< CFBamBuffDbKeyHash160TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash160Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffDbKeyHash160TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash160Type >>();
	...
	public ICFBamDbKeyHash160Type createDbKeyHash160Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Type iBuff )
	{
		final String S_ProcName = "createDbKeyHash160Type";
		
		CFBamBuffDbKeyHash160Type Buff = (CFBamBuffDbKeyHash160Type)(schema.getTableDbKeyHash160Def().createDbKeyHash160Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash160Type.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash160Type.CLASS_CODE) {
	...
	public ICFBamDbKeyHash160Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.lockDerived";
		ICFBamDbKeyHash160Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash160Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash160Type[] retList = new ICFBamDbKeyHash160Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash160Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash160Type ) {
			return( (ICFBamDbKeyHash160Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash160Type ) ) {
					filteredList.add( (ICFBamDbKeyHash160Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash160Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDbKeyHash160Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDbKeyHash160Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDbKeyHash160Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDbKeyHash160Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash160Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readRec";
		ICFBamDbKeyHash160Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash160Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readAllRec";
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash160Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash160Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash160Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash160Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readRecBySchemaIdx() ";
		ICFBamDbKeyHash160Type buff;
		ArrayList<ICFBamDbKeyHash160Type> filteredList = new ArrayList<ICFBamDbKeyHash160Type>();
		ICFBamDbKeyHash160Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash160Type)cur );
		}
		...
		return( (CFBamBuffDbKeyHash160Type)editCur );
	}
	...
	public ICFBamDbKeyHash160Type updateDbKeyHash160Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Type iBuff )
	{
		CFBamBuffDbKeyHash160Type Buff = (CFBamBuffDbKeyHash160Type)(schema.getTableDbKeyHash160Def().updateDbKeyHash160Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash160Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash160TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Type >();
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		CFBamBuffDbKeyHash160Type Buff = (CFBamBuffDbKeyHash160Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash160Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamDbKeyHash160TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffDbKeyHash160Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash160Type> matchSet = new LinkedList<CFBamBuffDbKeyHash160Type>();
		Iterator<CFBamBuffDbKeyHash160Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash160Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash160Type)(schema.getTableDbKeyHash160Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash160Type.CLASS_CODE == subClassCode ) {
