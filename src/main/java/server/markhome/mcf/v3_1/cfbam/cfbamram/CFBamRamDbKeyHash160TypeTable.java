	...
	implements ICFBamDbKeyHash160TypeTable
{
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		CFBamBuffDbKeyHash160TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash160TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash160TypeBySchemaIdxKey)schema.getFactoryDbKeyHash160Type().newBySchemaIdxKey();
