	...
	implements ICFBamDbKeyHash160TypeTable
{
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type >();
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Type >();
