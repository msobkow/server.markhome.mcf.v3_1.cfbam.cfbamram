...
// Description: Java 25 in-memory RAM DbIO implementation for UuidDef.
	...
	implements ICFBamUuidDefTable
{
		...
		ICFBamUuidDef iBuff )
	{
		...
		CFBamBuffUuidDef Buff = (CFBamBuffUuidDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuidDef.CLASS_CODE) {
	...
	public ICFBamUuidDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidDef.lockDerived";
		ICFBamUuidDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuidDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuidDef[] retList = new ICFBamUuidDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuidDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuidDef ) {
			return( (ICFBamUuidDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuidDef ) ) {
					filteredList.add( (ICFBamUuidDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuidDef[0] ) );
		}
	}
	...
	public ICFBamUuidDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidDef.readRec";
		ICFBamUuidDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuidDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuidDef.readAllRec";
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuidDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuidDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuidDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidDef buff;
		ArrayList<ICFBamUuidDef> filteredList = new ArrayList<ICFBamUuidDef>();
		ICFBamUuidDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffUuidDef)editCur );
	}
	...
	public ICFBamUuidDef updateUuidDef( ICFSecAuthorization Authorization,
		ICFBamUuidDef iBuff )
	{
		CFBamBuffUuidDef Buff = (CFBamBuffUuidDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuidDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidDef > subdict;
		...
		ICFBamUuidDef iBuff )
	{
		...
		CFBamBuffUuidDef Buff = (CFBamBuffUuidDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuidDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamUuidDef.CLASS_CODE == subClassCode ) {
