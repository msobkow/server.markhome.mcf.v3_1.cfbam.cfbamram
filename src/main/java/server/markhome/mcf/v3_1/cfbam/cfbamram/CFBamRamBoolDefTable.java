...
// Description: Java 25 in-memory RAM DbIO implementation for BoolDef.
	...
	implements ICFBamBoolDefTable
{
		...
		ICFBamBoolDef iBuff )
	{
		...
		CFBamBuffBoolDef Buff = (CFBamBuffBoolDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBoolDef.CLASS_CODE) {
	...
	public ICFBamBoolDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamBoolDef[] retList = new ICFBamBoolDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffBoolDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBoolDef ) {
			return( (ICFBamBoolDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBoolDef ) ) {
					filteredList.add( (ICFBamBoolDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamBoolDef[0] ) );
		}
	}
	...
	public ICFBamBoolDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBoolDef.readRec";
		ICFBamBoolDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBoolDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamBoolDef.readAllRec";
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBoolDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBoolDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBoolDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBoolDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolDef buff;
		ArrayList<ICFBamBoolDef> filteredList = new ArrayList<ICFBamBoolDef>();
		ICFBamBoolDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffBoolDef)editCur );
	}
	...
	public ICFBamBoolDef updateBoolDef( ICFSecAuthorization Authorization,
		ICFBamBoolDef iBuff )
	{
		CFBamBuffBoolDef Buff = (CFBamBuffBoolDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffBoolDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffBoolDef > subdict;
		...
		ICFBamBoolDef iBuff )
	{
		...
		CFBamBuffBoolDef Buff = (CFBamBuffBoolDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBoolDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffBoolDef cur;
		LinkedList<CFBamBuffBoolDef> matchSet = new LinkedList<CFBamBuffBoolDef>();
		Iterator<CFBamBuffBoolDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffBoolDef> iterMatch = matchSet.iterator();
