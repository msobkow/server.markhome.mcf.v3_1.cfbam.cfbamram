...
// Description: Java 25 in-memory RAM DbIO implementation for Int16Def.
	...
	implements ICFBamInt16DefTable
{
	...
	public ICFBamInt16Def createInt16Def( ICFSecAuthorization Authorization,
		ICFBamInt16Def iBuff )
	{
		final String S_ProcName = "createInt16Def";
		
		CFBamBuffInt16Def Buff = (CFBamBuffInt16Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
	...
	public ICFBamInt16Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Def.lockDerived";
		ICFBamInt16Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt16Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt16Def[] retList = new ICFBamInt16Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt16Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt16Def ) {
			return( (ICFBamInt16Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt16Def ) ) {
					filteredList.add( (ICFBamInt16Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt16Def[0] ) );
		}
	}
	...
	public ICFBamInt16Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Def.readRec";
		ICFBamInt16Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt16Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt16Def.readAllRec";
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt16Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt16Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt16Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt16Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Def buff;
		ArrayList<ICFBamInt16Def> filteredList = new ArrayList<ICFBamInt16Def>();
		ICFBamInt16Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffInt16Def)editCur );
	}
	...
	public ICFBamInt16Def updateInt16Def( ICFSecAuthorization Authorization,
		ICFBamInt16Def iBuff )
	{
		CFBamBuffInt16Def Buff = (CFBamBuffInt16Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt16Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffInt16Def > subdict;
		...
		ICFBamInt16Def iBuff )
	{
		...
		CFBamBuffInt16Def Buff = (CFBamBuffInt16Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt16Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamInt16Def.CLASS_CODE == subClassCode ) {
