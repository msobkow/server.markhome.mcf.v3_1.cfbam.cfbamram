...
// Description: Java 25 in-memory RAM DbIO implementation for TokenDef.
	...
	implements ICFBamTokenDefTable
{
	...
	public ICFBamTokenDef createTokenDef( ICFSecAuthorization Authorization,
		ICFBamTokenDef iBuff )
	{
		final String S_ProcName = "createTokenDef";
		
		CFBamBuffTokenDef Buff = (CFBamBuffTokenDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTokenDef.CLASS_CODE) {
	...
	public ICFBamTokenDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenDef.lockDerived";
		ICFBamTokenDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTokenDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTokenDef[] retList = new ICFBamTokenDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTokenDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTokenDef ) {
			return( (ICFBamTokenDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTokenDef ) ) {
					filteredList.add( (ICFBamTokenDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTokenDef[0] ) );
		}
	}
	...
	public ICFBamTokenDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenDef.readRec";
		ICFBamTokenDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTokenDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTokenDef.readAllRec";
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTokenDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTokenDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTokenDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTokenDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenDef buff;
		ArrayList<ICFBamTokenDef> filteredList = new ArrayList<ICFBamTokenDef>();
		ICFBamTokenDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffTokenDef)editCur );
	}
	...
	public ICFBamTokenDef updateTokenDef( ICFSecAuthorization Authorization,
		ICFBamTokenDef iBuff )
	{
		CFBamBuffTokenDef Buff = (CFBamBuffTokenDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTokenDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffTokenDef > subdict;
		...
		ICFBamTokenDef iBuff )
	{
		...
		CFBamBuffTokenDef Buff = (CFBamBuffTokenDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTokenDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffTokenDef cur;
		LinkedList<CFBamBuffTokenDef> matchSet = new LinkedList<CFBamBuffTokenDef>();
		Iterator<CFBamBuffTokenDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTokenDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTokenDef)(schema.getTableTokenDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamTokenDef.CLASS_CODE == subClassCode ) {
