	...
	implements ICFBamDateTypeTable
{
		...
		ICFBamDateType iBuff )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDateType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey key = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDateType().newBySchemaIdxKey();
		...
		ICFBamDateType iBuff )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDateType().newBySchemaIdxKey();
