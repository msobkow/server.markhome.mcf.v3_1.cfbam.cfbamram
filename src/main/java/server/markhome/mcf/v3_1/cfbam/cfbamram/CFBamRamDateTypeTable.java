...
// Description: Java 25 in-memory RAM DbIO implementation for DateType.
	...
	implements ICFBamDateTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDateType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDateType >();
	private Map< CFBamBuffDateTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDateType >> dictBySchemaIdx
		= new HashMap< CFBamBuffDateTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDateType >>();
	...
	public ICFBamDateType createDateType( ICFSecAuthorization Authorization,
		ICFBamDateType iBuff )
	{
		final String S_ProcName = "createDateType";
		
		CFBamBuffDateType Buff = (CFBamBuffDateType)(schema.getTableDateDef().createDateDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDateType.CLASS_CODE ) {
		...
		CFBamBuffDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDateType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDateType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDateType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDateType.CLASS_CODE) {
	...
	public ICFBamDateType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDateType.lockDerived";
		ICFBamDateType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDateType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDateType[] retList = new ICFBamDateType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDateType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDateType ) {
			return( (ICFBamDateType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDateType ) ) {
					filteredList.add( (ICFBamDateType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDateType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey key = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDateType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDateType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDateType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDateType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDateType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDateType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDateType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDateType[0];
		}
		return( recArray );
	}
	...
	public ICFBamDateType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDateType.readRec";
		ICFBamDateType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDateType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDateType.readAllRec";
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDateType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDateType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDateType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDateType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDateType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDateType.readRecBySchemaIdx() ";
		ICFBamDateType buff;
		ArrayList<ICFBamDateType> filteredList = new ArrayList<ICFBamDateType>();
		ICFBamDateType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDateType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffDateType)editCur );
	}
	...
	public ICFBamDateType updateDateType( ICFSecAuthorization Authorization,
		ICFBamDateType iBuff )
	{
		CFBamBuffDateType Buff = (CFBamBuffDateType)(schema.getTableDateDef().updateDateDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDateType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDateType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDateType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDateType >();
		...
		ICFBamDateType iBuff )
	{
		...
		CFBamBuffDateType Buff = (CFBamBuffDateType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDateType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDateType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDateType> matchSet = new LinkedList<CFBamBuffDateType>();
		Iterator<CFBamBuffDateType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDateType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDateType)(schema.getTableDateType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
