	...
	implements ICFBamDateTypeTable
{
		...
		ICFBamDateType iBuff )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getFactoryDateType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey key = (CFBamBuffDateTypeBySchemaIdxKey)schema.getFactoryDateType().newBySchemaIdxKey();
		...
		ICFBamDateType iBuff )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getFactoryDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDateTypeBySchemaIdxKey)schema.getFactoryDateType().newBySchemaIdxKey();
