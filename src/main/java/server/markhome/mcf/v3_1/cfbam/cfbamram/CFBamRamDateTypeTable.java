	...
	implements ICFBamDateTypeTable
{
		...
		ICFBamDateType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDateType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDateType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDateType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDateType >();
		...
		ICFBamDateType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDateType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDateType >();
