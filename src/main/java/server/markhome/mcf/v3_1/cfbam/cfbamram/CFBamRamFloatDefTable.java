...
// Description: Java 25 in-memory RAM DbIO implementation for FloatDef.
	...
	implements ICFBamFloatDefTable
{
	...
	public ICFBamFloatDef createFloatDef( ICFSecAuthorization Authorization,
		ICFBamFloatDef iBuff )
	{
		final String S_ProcName = "createFloatDef";
		
		CFBamBuffFloatDef Buff = (CFBamBuffFloatDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamFloatDef.CLASS_CODE) {
	...
	public ICFBamFloatDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatDef.lockDerived";
		ICFBamFloatDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamFloatDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamFloatDef[] retList = new ICFBamFloatDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffFloatDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamFloatDef ) {
			return( (ICFBamFloatDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamFloatDef ) ) {
					filteredList.add( (ICFBamFloatDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamFloatDef[0] ) );
		}
	}
	...
	public ICFBamFloatDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatDef.readRec";
		ICFBamFloatDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamFloatDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamFloatDef.readAllRec";
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamFloatDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamFloatDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamFloatDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamFloatDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatDef buff;
		ArrayList<ICFBamFloatDef> filteredList = new ArrayList<ICFBamFloatDef>();
		ICFBamFloatDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffFloatDef)editCur );
	}
	...
	public ICFBamFloatDef updateFloatDef( ICFSecAuthorization Authorization,
		ICFBamFloatDef iBuff )
	{
		CFBamBuffFloatDef Buff = (CFBamBuffFloatDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffFloatDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffFloatDef > subdict;
		...
		ICFBamFloatDef iBuff )
	{
		...
		CFBamBuffFloatDef Buff = (CFBamBuffFloatDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffFloatDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffFloatDef cur;
		LinkedList<CFBamBuffFloatDef> matchSet = new LinkedList<CFBamBuffFloatDef>();
		Iterator<CFBamBuffFloatDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffFloatDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffFloatDef)(schema.getTableFloatDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamFloatDef.CLASS_CODE == subClassCode ) {
