...
// Description: Java 25 in-memory RAM DbIO implementation for NmTokenDef.
	...
	implements ICFBamNmTokenDefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNmTokenDef > dictByPKey
	...
	public ICFBamNmTokenDef createNmTokenDef( ICFSecAuthorization Authorization,
		ICFBamNmTokenDef iBuff )
	{
		final String S_ProcName = "createNmTokenDef";
		
		CFBamBuffNmTokenDef Buff = (CFBamBuffNmTokenDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNmTokenDef.CLASS_CODE) {
	...
	public ICFBamNmTokenDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokenDef.lockDerived";
		ICFBamNmTokenDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNmTokenDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNmTokenDef[] retList = new ICFBamNmTokenDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNmTokenDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNmTokenDef ) {
			return( (ICFBamNmTokenDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNmTokenDef ) ) {
					filteredList.add( (ICFBamNmTokenDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNmTokenDef[0] ) );
		}
	}
	...
	public ICFBamNmTokenDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokenDef.readRec";
		ICFBamNmTokenDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNmTokenDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNmTokenDef.readAllRec";
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokenDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNmTokenDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNmTokenDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNmTokenDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokenDef buff;
		ArrayList<ICFBamNmTokenDef> filteredList = new ArrayList<ICFBamNmTokenDef>();
		ICFBamNmTokenDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNmTokenDef)cur );
		}
		...
		return( (CFBamBuffNmTokenDef)editCur );
	}
	...
	public ICFBamNmTokenDef updateNmTokenDef( ICFSecAuthorization Authorization,
		ICFBamNmTokenDef iBuff )
	{
		CFBamBuffNmTokenDef Buff = (CFBamBuffNmTokenDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNmTokenDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokenDef > subdict;
		...
		ICFBamNmTokenDef iBuff )
	{
		...
		CFBamBuffNmTokenDef Buff = (CFBamBuffNmTokenDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNmTokenDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamNmTokenDef.CLASS_CODE == subClassCode ) {
