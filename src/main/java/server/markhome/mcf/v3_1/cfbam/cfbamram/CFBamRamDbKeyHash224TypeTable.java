	...
	implements ICFBamDbKeyHash224TypeTable
{
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash224TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getFactoryDbKeyHash224Type().newBySchemaIdxKey();
