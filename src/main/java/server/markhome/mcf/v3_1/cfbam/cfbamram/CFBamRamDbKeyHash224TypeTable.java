	...
	implements ICFBamDbKeyHash224TypeTable
{
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type >();
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Type >();
