...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash224Type.
	...
	implements ICFBamDbKeyHash224TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Type >();
	private Map< CFBamBuffDbKeyHash224TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash224Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffDbKeyHash224TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash224Type >>();
	...
	public ICFBamDbKeyHash224Type createDbKeyHash224Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Type iBuff )
	{
		final String S_ProcName = "createDbKeyHash224Type";
		
		CFBamBuffDbKeyHash224Type Buff = (CFBamBuffDbKeyHash224Type)(schema.getTableDbKeyHash224Def().createDbKeyHash224Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash224Type.CLASS_CODE ) {
			...
			if( tail != null ) {
				...
				Buff.setOptionalLookupPrev((ICFLibKeyHash256)null);
			}
		}
		ICFLibKeyHash256 pkey;
		pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type >();
		...
		if( tail != null ) {
			...
			if( tailClassCode == ICFBamValue.CLASS_CODE ) {
				ICFBamValue tailEdit = schema.getCFBamBuffFactory().getFactoryValue().newRec();
				...
				ICFBamAtom tailEdit = schema.getCFBamBuffFactory().getFactoryAtom().newRec();
				...
				ICFBamBlobDef tailEdit = schema.getCFBamBuffFactory().getFactoryBlobDef().newRec();
				...
				ICFBamBlobType tailEdit = schema.getCFBamBuffFactory().getFactoryBlobType().newRec();
				...
				ICFBamBlobCol tailEdit = schema.getCFBamBuffFactory().getFactoryBlobCol().newRec();
				...
				ICFBamBoolDef tailEdit = schema.getCFBamBuffFactory().getFactoryBoolDef().newRec();
				...
				ICFBamBoolType tailEdit = schema.getCFBamBuffFactory().getFactoryBoolType().newRec();
				...
				ICFBamBoolCol tailEdit = schema.getCFBamBuffFactory().getFactoryBoolCol().newRec();
				...
				ICFBamDateDef tailEdit = schema.getCFBamBuffFactory().getFactoryDateDef().newRec();
				...
				ICFBamDateType tailEdit = schema.getCFBamBuffFactory().getFactoryDateType().newRec();
				...
				ICFBamDateCol tailEdit = schema.getCFBamBuffFactory().getFactoryDateCol().newRec();
				...
				ICFBamDoubleDef tailEdit = schema.getCFBamBuffFactory().getFactoryDoubleDef().newRec();
				...
				ICFBamDoubleType tailEdit = schema.getCFBamBuffFactory().getFactoryDoubleType().newRec();
				...
				ICFBamDoubleCol tailEdit = schema.getCFBamBuffFactory().getFactoryDoubleCol().newRec();
				...
				ICFBamFloatDef tailEdit = schema.getCFBamBuffFactory().getFactoryFloatDef().newRec();
				...
				ICFBamFloatType tailEdit = schema.getCFBamBuffFactory().getFactoryFloatType().newRec();
				...
				ICFBamFloatCol tailEdit = schema.getCFBamBuffFactory().getFactoryFloatCol().newRec();
				...
				ICFBamInt16Def tailEdit = schema.getCFBamBuffFactory().getFactoryInt16Def().newRec();
				...
				ICFBamInt16Type tailEdit = schema.getCFBamBuffFactory().getFactoryInt16Type().newRec();
				...
				ICFBamId16Gen tailEdit = schema.getCFBamBuffFactory().getFactoryId16Gen().newRec();
				...
				ICFBamEnumDef tailEdit = schema.getCFBamBuffFactory().getFactoryEnumDef().newRec();
				...
				ICFBamEnumType tailEdit = schema.getCFBamBuffFactory().getFactoryEnumType().newRec();
				...
				ICFBamInt16Col tailEdit = schema.getCFBamBuffFactory().getFactoryInt16Col().newRec();
				...
				ICFBamInt32Def tailEdit = schema.getCFBamBuffFactory().getFactoryInt32Def().newRec();
				...
				ICFBamInt32Type tailEdit = schema.getCFBamBuffFactory().getFactoryInt32Type().newRec();
				...
				ICFBamId32Gen tailEdit = schema.getCFBamBuffFactory().getFactoryId32Gen().newRec();
				...
				ICFBamInt32Col tailEdit = schema.getCFBamBuffFactory().getFactoryInt32Col().newRec();
				...
				ICFBamInt64Def tailEdit = schema.getCFBamBuffFactory().getFactoryInt64Def().newRec();
				...
				ICFBamInt64Type tailEdit = schema.getCFBamBuffFactory().getFactoryInt64Type().newRec();
				...
				ICFBamId64Gen tailEdit = schema.getCFBamBuffFactory().getFactoryId64Gen().newRec();
				...
				ICFBamInt64Col tailEdit = schema.getCFBamBuffFactory().getFactoryInt64Col().newRec();
				...
				ICFBamNmTokenDef tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokenDef().newRec();
				...
				ICFBamNmTokenType tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokenType().newRec();
				...
				ICFBamNmTokenCol tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokenCol().newRec();
				...
				ICFBamNmTokensDef tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokensDef().newRec();
				...
				ICFBamNmTokensType tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokensType().newRec();
				...
				ICFBamNmTokensCol tailEdit = schema.getCFBamBuffFactory().getFactoryNmTokensCol().newRec();
				...
				ICFBamNumberDef tailEdit = schema.getCFBamBuffFactory().getFactoryNumberDef().newRec();
				...
				ICFBamNumberType tailEdit = schema.getCFBamBuffFactory().getFactoryNumberType().newRec();
				...
				ICFBamNumberCol tailEdit = schema.getCFBamBuffFactory().getFactoryNumberCol().newRec();
				...
				ICFBamDbKeyHash128Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash128Def().newRec();
				...
				ICFBamDbKeyHash128Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash128Col().newRec();
				...
				ICFBamDbKeyHash128Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash128Type().newRec();
				...
				ICFBamDbKeyHash128Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash128Gen().newRec();
				...
				ICFBamDbKeyHash160Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash160Def().newRec();
				...
				ICFBamDbKeyHash160Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash160Col().newRec();
				...
				ICFBamDbKeyHash160Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash160Type().newRec();
				...
				ICFBamDbKeyHash160Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash160Gen().newRec();
				...
				ICFBamDbKeyHash224Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash224Def().newRec();
				...
				ICFBamDbKeyHash224Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash224Col().newRec();
				...
				ICFBamDbKeyHash224Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash224Type().newRec();
				...
				ICFBamDbKeyHash224Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash224Gen().newRec();
				...
				ICFBamDbKeyHash256Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash256Def().newRec();
				...
				ICFBamDbKeyHash256Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash256Col().newRec();
				...
				ICFBamDbKeyHash256Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash256Type().newRec();
				...
				ICFBamDbKeyHash256Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash256Gen().newRec();
				...
				ICFBamDbKeyHash384Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash384Def().newRec();
				...
				ICFBamDbKeyHash384Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash384Col().newRec();
				...
				ICFBamDbKeyHash384Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash384Type().newRec();
				...
				ICFBamDbKeyHash384Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash384Gen().newRec();
				...
				ICFBamDbKeyHash512Def tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash512Def().newRec();
				...
				ICFBamDbKeyHash512Col tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash512Col().newRec();
				...
				ICFBamDbKeyHash512Type tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash512Type().newRec();
				...
				ICFBamDbKeyHash512Gen tailEdit = schema.getCFBamBuffFactory().getFactoryDbKeyHash512Gen().newRec();
				...
				ICFBamStringDef tailEdit = schema.getCFBamBuffFactory().getFactoryStringDef().newRec();
				...
				ICFBamStringType tailEdit = schema.getCFBamBuffFactory().getFactoryStringType().newRec();
				...
				ICFBamStringCol tailEdit = schema.getCFBamBuffFactory().getFactoryStringCol().newRec();
				...
				ICFBamTZDateDef tailEdit = schema.getCFBamBuffFactory().getFactoryTZDateDef().newRec();
				...
				ICFBamTZDateType tailEdit = schema.getCFBamBuffFactory().getFactoryTZDateType().newRec();
				...
				ICFBamTZDateCol tailEdit = schema.getCFBamBuffFactory().getFactoryTZDateCol().newRec();
				...
				ICFBamTZTimeDef tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimeDef().newRec();
				...
				ICFBamTZTimeType tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimeType().newRec();
				...
				ICFBamTZTimeCol tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimeCol().newRec();
				...
				ICFBamTZTimestampDef tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimestampDef().newRec();
				...
				ICFBamTZTimestampType tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimestampType().newRec();
				...
				ICFBamTZTimestampCol tailEdit = schema.getCFBamBuffFactory().getFactoryTZTimestampCol().newRec();
				...
				ICFBamTextDef tailEdit = schema.getCFBamBuffFactory().getFactoryTextDef().newRec();
				...
				ICFBamTextType tailEdit = schema.getCFBamBuffFactory().getFactoryTextType().newRec();
				...
				ICFBamTextCol tailEdit = schema.getCFBamBuffFactory().getFactoryTextCol().newRec();
				...
				ICFBamTimeDef tailEdit = schema.getCFBamBuffFactory().getFactoryTimeDef().newRec();
				...
				ICFBamTimeType tailEdit = schema.getCFBamBuffFactory().getFactoryTimeType().newRec();
				...
				ICFBamTimeCol tailEdit = schema.getCFBamBuffFactory().getFactoryTimeCol().newRec();
				...
				ICFBamTimestampDef tailEdit = schema.getCFBamBuffFactory().getFactoryTimestampDef().newRec();
				...
				ICFBamTimestampType tailEdit = schema.getCFBamBuffFactory().getFactoryTimestampType().newRec();
				...
				ICFBamTimestampCol tailEdit = schema.getCFBamBuffFactory().getFactoryTimestampCol().newRec();
				...
				ICFBamTokenDef tailEdit = schema.getCFBamBuffFactory().getFactoryTokenDef().newRec();
				...
				ICFBamTokenType tailEdit = schema.getCFBamBuffFactory().getFactoryTokenType().newRec();
				...
				ICFBamTokenCol tailEdit = schema.getCFBamBuffFactory().getFactoryTokenCol().newRec();
				...
				ICFBamUInt16Def tailEdit = schema.getCFBamBuffFactory().getFactoryUInt16Def().newRec();
				...
				ICFBamUInt16Type tailEdit = schema.getCFBamBuffFactory().getFactoryUInt16Type().newRec();
				...
				ICFBamUInt16Col tailEdit = schema.getCFBamBuffFactory().getFactoryUInt16Col().newRec();
				...
				ICFBamUInt32Def tailEdit = schema.getCFBamBuffFactory().getFactoryUInt32Def().newRec();
				...
				ICFBamUInt32Type tailEdit = schema.getCFBamBuffFactory().getFactoryUInt32Type().newRec();
				...
				ICFBamUInt32Col tailEdit = schema.getCFBamBuffFactory().getFactoryUInt32Col().newRec();
				...
				ICFBamUInt64Def tailEdit = schema.getCFBamBuffFactory().getFactoryUInt64Def().newRec();
				...
				ICFBamUInt64Type tailEdit = schema.getCFBamBuffFactory().getFactoryUInt64Type().newRec();
				...
				ICFBamUInt64Col tailEdit = schema.getCFBamBuffFactory().getFactoryUInt64Col().newRec();
				...
				ICFBamUuidDef tailEdit = schema.getCFBamBuffFactory().getFactoryUuidDef().newRec();
				...
				ICFBamUuidType tailEdit = schema.getCFBamBuffFactory().getFactoryUuidType().newRec();
				...
				ICFBamUuidGen tailEdit = schema.getCFBamBuffFactory().getFactoryUuidGen().newRec();
				...
				ICFBamUuidCol tailEdit = schema.getCFBamBuffFactory().getFactoryUuidCol().newRec();
				...
				ICFBamUuid6Def tailEdit = schema.getCFBamBuffFactory().getFactoryUuid6Def().newRec();
				...
				ICFBamUuid6Type tailEdit = schema.getCFBamBuffFactory().getFactoryUuid6Type().newRec();
				...
				ICFBamUuid6Gen tailEdit = schema.getCFBamBuffFactory().getFactoryUuid6Gen().newRec();
				...
				ICFBamUuid6Col tailEdit = schema.getCFBamBuffFactory().getFactoryUuid6Col().newRec();
				...
				ICFBamTableCol tailEdit = schema.getCFBamBuffFactory().getFactoryTableCol().newRec();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash224Type.CLASS_CODE) {
	...
	public ICFBamDbKeyHash224Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.lockDerived";
		ICFBamDbKeyHash224Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash224Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash224Type[] retList = new ICFBamDbKeyHash224Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash224Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash224Type ) {
			return( (ICFBamDbKeyHash224Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash224Type ) ) {
					filteredList.add( (ICFBamDbKeyHash224Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash224Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDbKeyHash224Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDbKeyHash224Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDbKeyHash224Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDbKeyHash224Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash224Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readRec";
		ICFBamDbKeyHash224Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash224Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readAllRec";
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash224Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash224Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash224Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash224Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash224Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readRecBySchemaIdx() ";
		ICFBamDbKeyHash224Type buff;
		ArrayList<ICFBamDbKeyHash224Type> filteredList = new ArrayList<ICFBamDbKeyHash224Type>();
		ICFBamDbKeyHash224Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash224Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash224Type)cur );
		}
		...
		return( (CFBamBuffDbKeyHash224Type)editCur );
	}
	...
	public ICFBamDbKeyHash224Type updateDbKeyHash224Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Type iBuff )
	{
		CFBamBuffDbKeyHash224Type Buff = (CFBamBuffDbKeyHash224Type)(schema.getTableDbKeyHash224Def().updateDbKeyHash224Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash224Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash224TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash224TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash224TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Type >();
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		CFBamBuffDbKeyHash224Type Buff = (CFBamBuffDbKeyHash224Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash224Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 varSchemaDefId = existing.getRequiredSchemaDefId();
		...
		ICFBamDbKeyHash224TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffDbKeyHash224Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash224Type> matchSet = new LinkedList<CFBamBuffDbKeyHash224Type>();
		Iterator<CFBamBuffDbKeyHash224Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash224Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash224Type)(schema.getTableDbKeyHash224Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash224Type.CLASS_CODE == subClassCode ) {
