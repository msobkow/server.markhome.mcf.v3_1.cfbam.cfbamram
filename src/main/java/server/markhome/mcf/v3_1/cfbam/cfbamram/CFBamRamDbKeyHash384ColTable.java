	...
	implements ICFBamDbKeyHash384ColTable
{
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col >();
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Col >();
