...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash384Col.
	...
	implements ICFBamDbKeyHash384ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Col >();
	private Map< CFBamBuffDbKeyHash384ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash384Col >> dictByTableIdx
		= new HashMap< CFBamBuffDbKeyHash384ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash384Col >>();
	...
	public ICFBamDbKeyHash384Col createDbKeyHash384Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Col iBuff )
	{
		final String S_ProcName = "createDbKeyHash384Col";
		
		CFBamBuffDbKeyHash384Col Buff = (CFBamBuffDbKeyHash384Col)(schema.getTableDbKeyHash384Def().createDbKeyHash384Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash384Col.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash384Col.CLASS_CODE) {
	...
	public ICFBamDbKeyHash384Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.lockDerived";
		ICFBamDbKeyHash384Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash384Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash384Col[] retList = new ICFBamDbKeyHash384Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash384Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash384Col ) {
			return( (ICFBamDbKeyHash384Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash384Col ) ) {
					filteredList.add( (ICFBamDbKeyHash384Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash384Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey key = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDbKeyHash384Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDbKeyHash384Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDbKeyHash384Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDbKeyHash384Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash384Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readRec";
		ICFBamDbKeyHash384Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash384Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readAllRec";
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash384Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash384Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash384Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash384Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readRecByTableIdx() ";
		ICFBamDbKeyHash384Col buff;
		ArrayList<ICFBamDbKeyHash384Col> filteredList = new ArrayList<ICFBamDbKeyHash384Col>();
		ICFBamDbKeyHash384Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash384Col)cur );
		}
		...
		return( (CFBamBuffDbKeyHash384Col)editCur );
	}
	...
	public ICFBamDbKeyHash384Col updateDbKeyHash384Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Col iBuff )
	{
		CFBamBuffDbKeyHash384Col Buff = (CFBamBuffDbKeyHash384Col)(schema.getTableDbKeyHash384Def().updateDbKeyHash384Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash384Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash384ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Col >();
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		CFBamBuffDbKeyHash384Col Buff = (CFBamBuffDbKeyHash384Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash384Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash384Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash384Col> matchSet = new LinkedList<CFBamBuffDbKeyHash384Col>();
		Iterator<CFBamBuffDbKeyHash384Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash384Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash384Col)(schema.getTableDbKeyHash384Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
