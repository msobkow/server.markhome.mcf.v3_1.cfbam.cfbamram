	...
	implements ICFBamDbKeyHash384ColTable
{
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey key = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash384ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash384ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash384Col().newByTableIdxKey();
