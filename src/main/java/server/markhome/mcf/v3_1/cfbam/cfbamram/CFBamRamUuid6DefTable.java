	...
	implements ICFBamUuid6DefTable
{
	...
	public ICFBamUuid6Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Def.lockDerived";
		ICFBamUuid6Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuid6Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Def.readRec";
	...
	{
		final String S_ProcName = "CFBamRamUuid6Def.readAllRec";
		ICFBamUuid6Def buff;
		ArrayList<ICFBamUuid6Def> filteredList = new ArrayList<ICFBamUuid6Def>();
	...
	public ICFBamUuid6Def updateUuid6Def( ICFSecAuthorization Authorization,
		ICFBamUuid6Def iBuff )
	{
		CFBamBuffUuid6Def Buff = (CFBamBuffUuid6Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Def > subdict;
		...
		ICFBamUuid6Def iBuff )
	{
		...
		CFBamBuffUuid6Def Buff = (CFBamBuffUuid6Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuid6Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffUuid6Def cur;
		LinkedList<CFBamBuffUuid6Def> matchSet = new LinkedList<CFBamBuffUuid6Def>();
		Iterator<CFBamBuffUuid6Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuid6Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUuid6Def)(schema.getTableUuid6Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamUuid6Def.CLASS_CODE == subClassCode ) {
