	...
	implements ICFBamTZTimeTypeTable
{
		...
		ICFBamTZTimeType iBuff )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getFactoryTZTimeType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey key = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getFactoryTZTimeType().newBySchemaIdxKey();
		...
		ICFBamTZTimeType iBuff )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getFactoryTZTimeType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimeTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getFactoryTZTimeType().newBySchemaIdxKey();
