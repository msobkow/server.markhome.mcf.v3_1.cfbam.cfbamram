	...
	implements ICFBamTZTimeTypeTable
{
		...
		ICFBamTZTimeType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimeType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTZTimeType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeType >();
		...
		ICFBamTZTimeType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimeType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeType >();
