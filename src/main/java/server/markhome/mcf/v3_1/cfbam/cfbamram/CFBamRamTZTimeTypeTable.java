	...
	implements ICFBamTZTimeTypeTable
{
		...
		ICFBamTZTimeType iBuff )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey key = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		...
		ICFBamTZTimeType iBuff )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimeTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimeType().newBySchemaIdxKey();
