...
// Description: Java 25 in-memory RAM DbIO implementation for TZTimeType.
	...
	implements ICFBamTZTimeTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTZTimeType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTZTimeType >();
	private Map< CFBamBuffTZTimeTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimeType >> dictBySchemaIdx
		= new HashMap< CFBamBuffTZTimeTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimeType >>();
	...
	public ICFBamTZTimeType createTZTimeType( ICFSecAuthorization Authorization,
		ICFBamTZTimeType iBuff )
	{
		final String S_ProcName = "createTZTimeType";
		
		CFBamBuffTZTimeType Buff = (CFBamBuffTZTimeType)(schema.getTableTZTimeDef().createTZTimeDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTZTimeType.CLASS_CODE ) {
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimeType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimeType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZTimeType.CLASS_CODE) {
	...
	public ICFBamTZTimeType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimeType.lockDerived";
		ICFBamTZTimeType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZTimeType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTZTimeType[] retList = new ICFBamTZTimeType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTZTimeType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTZTimeType ) {
			return( (ICFBamTZTimeType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTZTimeType ) ) {
					filteredList.add( (ICFBamTZTimeType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTZTimeType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey key = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimeType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamTZTimeType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTZTimeType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamTZTimeType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffTZTimeType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTZTimeType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTZTimeType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamTZTimeType[0];
		}
		return( recArray );
	}
	...
	public ICFBamTZTimeType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimeType.readRec";
		ICFBamTZTimeType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZTimeType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTZTimeType.readAllRec";
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimeType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTZTimeType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTZTimeType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTZTimeType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTZTimeType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamTZTimeType.readRecBySchemaIdx() ";
		ICFBamTZTimeType buff;
		ArrayList<ICFBamTZTimeType> filteredList = new ArrayList<ICFBamTZTimeType>();
		ICFBamTZTimeType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimeType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTZTimeType)cur );
		}
		...
		return( (CFBamBuffTZTimeType)editCur );
	}
	...
	public ICFBamTZTimeType updateTZTimeType( ICFSecAuthorization Authorization,
		ICFBamTZTimeType iBuff )
	{
		CFBamBuffTZTimeType Buff = (CFBamBuffTZTimeType)(schema.getTableTZTimeDef().updateTZTimeDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZTimeType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimeTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimeTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimeType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimeType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimeType >();
		...
		ICFBamTZTimeType iBuff )
	{
		...
		CFBamBuffTZTimeType Buff = (CFBamBuffTZTimeType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZTimeType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTZTimeType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTZTimeType> matchSet = new LinkedList<CFBamBuffTZTimeType>();
		Iterator<CFBamBuffTZTimeType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZTimeType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZTimeType)(schema.getTableTZTimeType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
