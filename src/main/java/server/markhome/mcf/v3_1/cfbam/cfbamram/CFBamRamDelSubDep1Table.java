	...
	implements ICFBamDelSubDep1Table
{
		...
		ICFBamDelSubDep1 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep1 > subdictDelTopDepIdx;
		if( dictByDelTopDepIdx.containsKey( keyDelTopDepIdx ) ) {
			subdictDelTopDepIdx = dictByDelTopDepIdx.get( keyDelTopDepIdx );
		}
		else {
			subdictDelTopDepIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep1 >();
		...
		ICFLibKeyHash256 DelTopDepId )
	{
		...
		if( dictByDelTopDepIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDelSubDep1 > subdictDelTopDepIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep1 >();
		...
		ICFBamDelSubDep1 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDelSubDep1 > subdict;
		...
		if( dictByDelTopDepIdx.containsKey( newKeyDelTopDepIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDelSubDep1 >();
