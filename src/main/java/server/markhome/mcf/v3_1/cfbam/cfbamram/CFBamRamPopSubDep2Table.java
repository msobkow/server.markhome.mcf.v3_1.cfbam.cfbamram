	...
	implements ICFBamPopSubDep2Table
{
		...
		ICFBamPopSubDep2 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffPopSubDep2 > subdictPopSubDep1Idx;
		if( dictByPopSubDep1Idx.containsKey( keyPopSubDep1Idx ) ) {
			subdictPopSubDep1Idx = dictByPopSubDep1Idx.get( keyPopSubDep1Idx );
		}
		else {
			subdictPopSubDep1Idx = new HashMap< ICFLibKeyHash256, CFBamBuffPopSubDep2 >();
		...
		ICFLibKeyHash256 PopSubDep1Id )
	{
		...
		if( dictByPopSubDep1Idx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffPopSubDep2 > subdictPopSubDep1Idx
				= new HashMap< ICFLibKeyHash256, CFBamBuffPopSubDep2 >();
		...
		ICFBamPopSubDep2 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffPopSubDep2 > subdict;
		...
		if( dictByPopSubDep1Idx.containsKey( newKeyPopSubDep1Idx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffPopSubDep2 >();
