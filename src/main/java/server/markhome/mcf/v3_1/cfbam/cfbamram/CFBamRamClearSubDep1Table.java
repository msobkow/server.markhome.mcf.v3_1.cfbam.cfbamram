	...
	implements ICFBamClearSubDep1Table
{
		...
		ICFBamClearSubDep1 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearSubDep1 > subdictClearTopDepIdx;
		if( dictByClearTopDepIdx.containsKey( keyClearTopDepIdx ) ) {
			subdictClearTopDepIdx = dictByClearTopDepIdx.get( keyClearTopDepIdx );
		}
		else {
			subdictClearTopDepIdx = new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep1 >();
		...
		ICFLibKeyHash256 ClearTopDepId )
	{
		...
		if( dictByClearTopDepIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffClearSubDep1 > subdictClearTopDepIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep1 >();
		...
		ICFBamClearSubDep1 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearSubDep1 > subdict;
		...
		if( dictByClearTopDepIdx.containsKey( newKeyClearTopDepIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep1 >();
