	...
	implements ICFBamTableTweakTable
{
		...
		ICFBamTableTweak iBuff )
	{
		...
		CFBamBuffTableTweakByTableIdxKey keyTableIdx = (CFBamBuffTableTweakByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTableTweak().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTableTweak > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTableTweak >();
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTableTweakByTableIdxKey key = (CFBamBuffTableTweakByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTableTweak().newByTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTableTweak > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTableTweak >();
		...
		ICFBamTableTweak iBuff )
	{
		...
		CFBamBuffTableTweakByTableIdxKey existingKeyTableIdx = (CFBamBuffTableTweakByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTableTweak().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTableTweakByTableIdxKey newKeyTableIdx = (CFBamBuffTableTweakByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTableTweak().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTableTweak > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTableTweak >();
