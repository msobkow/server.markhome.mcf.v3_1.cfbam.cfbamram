...
// Description: Java 25 in-memory RAM DbIO implementation for TZTimestampDef.
	...
	implements ICFBamTZTimestampDefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTZTimestampDef > dictByPKey
		...
		ICFBamTZTimestampDef iBuff )
	{
		...
		CFBamBuffTZTimestampDef Buff = (CFBamBuffTZTimestampDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZTimestampDef.CLASS_CODE) {
	...
	public ICFBamTZTimestampDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampDef.lockDerived";
		ICFBamTZTimestampDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZTimestampDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffTZTimestampDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTZTimestampDef ) {
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTZTimestampDef ) ) {
	...
	public ICFBamTZTimestampDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampDef.readRec";
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampDef buff;
		ArrayList<ICFBamTZTimestampDef> filteredList = new ArrayList<ICFBamTZTimestampDef>();
		ICFBamTZTimestampDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTZTimestampDef)cur );
		}
		...
		return( (CFBamBuffTZTimestampDef)editCur );
	}
	...
	public ICFBamTZTimestampDef updateTZTimestampDef( ICFSecAuthorization Authorization,
		ICFBamTZTimestampDef iBuff )
	{
		CFBamBuffTZTimestampDef Buff = (CFBamBuffTZTimestampDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZTimestampDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimestampDef > subdict;
		...
		ICFBamTZTimestampDef iBuff )
	{
		...
		CFBamBuffTZTimestampDef Buff = (CFBamBuffTZTimestampDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZTimestampDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffTZTimestampDef cur;
		LinkedList<CFBamBuffTZTimestampDef> matchSet = new LinkedList<CFBamBuffTZTimestampDef>();
		Iterator<CFBamBuffTZTimestampDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZTimestampDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZTimestampDef)(schema.getTableTZTimestampDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamTZTimestampDef.CLASS_CODE == subClassCode ) {
