...
// Description: Java 25 in-memory RAM DbIO implementation for UuidCol.
	...
	implements ICFBamUuidColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUuidCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUuidCol >();
	private Map< CFBamBuffUuidColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuidCol >> dictByTableIdx
		= new HashMap< CFBamBuffUuidColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuidCol >>();
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidCol Buff = (CFBamBuffUuidCol)(schema.getTableUuidDef().createUuidDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUuidCol.CLASS_CODE ) {
		...
		CFBamBuffUuidColByTableIdxKey keyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuidCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUuidCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuidCol.CLASS_CODE) {
	...
	public ICFBamUuidCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidCol.lockDerived";
		ICFBamUuidCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuidCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuidCol[] retList = new ICFBamUuidCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuidCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuidCol ) {
			return( (ICFBamUuidCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuidCol ) ) {
					filteredList.add( (ICFBamUuidCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuidCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffUuidColByTableIdxKey key = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuidCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamUuidCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUuidCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamUuidCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffUuidCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUuidCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUuidCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamUuidCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamUuidCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidCol.readRec";
		ICFBamUuidCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuidCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuidCol.readAllRec";
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuidCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuidCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuidCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUuidCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamUuidCol.readRecByTableIdx() ";
		ICFBamUuidCol buff;
		ArrayList<ICFBamUuidCol> filteredList = new ArrayList<ICFBamUuidCol>();
		ICFBamUuidCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUuidCol)editCur );
	}
	...
	public ICFBamUuidCol updateUuidCol( ICFSecAuthorization Authorization,
		ICFBamUuidCol iBuff )
	{
		CFBamBuffUuidCol Buff = (CFBamBuffUuidCol)(schema.getTableUuidDef().updateUuidDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuidCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuidColByTableIdxKey existingKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuidCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuidColByTableIdxKey newKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUuidCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUuidCol >();
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidCol Buff = (CFBamBuffUuidCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuidCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUuidCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUuidCol> matchSet = new LinkedList<CFBamBuffUuidCol>();
		Iterator<CFBamBuffUuidCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuidCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUuidCol)(schema.getTableUuidCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
