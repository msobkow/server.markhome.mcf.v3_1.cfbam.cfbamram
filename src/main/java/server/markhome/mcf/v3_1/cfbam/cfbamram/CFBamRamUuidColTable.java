	...
	implements ICFBamUuidColTable
{
		...
		ICFBamUuidCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUuidCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUuidCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUuidCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUuidCol >();
		...
		ICFBamUuidCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUuidCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUuidCol >();
