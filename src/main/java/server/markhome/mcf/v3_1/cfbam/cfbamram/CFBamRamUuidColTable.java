	...
	implements ICFBamUuidColTable
{
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidColByTableIdxKey keyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUuidColByTableIdxKey key = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidColByTableIdxKey existingKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuidColByTableIdxKey newKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
