	...
	implements ICFBamUuidColTable
{
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidColByTableIdxKey keyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getFactoryUuidCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUuidColByTableIdxKey key = (CFBamBuffUuidColByTableIdxKey)schema.getFactoryUuidCol().newByTableIdxKey();
		...
		ICFBamUuidCol iBuff )
	{
		...
		CFBamBuffUuidColByTableIdxKey existingKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getFactoryUuidCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuidColByTableIdxKey newKeyTableIdx = (CFBamBuffUuidColByTableIdxKey)schema.getFactoryUuidCol().newByTableIdxKey();
