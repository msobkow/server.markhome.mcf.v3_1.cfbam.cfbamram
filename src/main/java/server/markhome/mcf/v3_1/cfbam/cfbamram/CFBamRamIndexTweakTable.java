	...
	implements ICFBamIndexTweakTable
{
		...
		ICFBamIndexTweak iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffIndexTweak > subdictIndexIdx;
		if( dictByIndexIdx.containsKey( keyIndexIdx ) ) {
			subdictIndexIdx = dictByIndexIdx.get( keyIndexIdx );
		}
		else {
			subdictIndexIdx = new HashMap< ICFLibKeyHash256, CFBamBuffIndexTweak >();
		...
		ICFLibKeyHash256 IndexId )
	{
		...
		if( dictByIndexIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffIndexTweak > subdictIndexIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffIndexTweak >();
		...
		ICFBamIndexTweak iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffIndexTweak > subdict;
		...
		if( dictByIndexIdx.containsKey( newKeyIndexIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffIndexTweak >();
