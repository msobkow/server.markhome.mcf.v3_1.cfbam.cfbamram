...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash128Type.
	...
	implements ICFBamDbKeyHash128TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash128Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash128Type >();
	private Map< CFBamBuffDbKeyHash128TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash128Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffDbKeyHash128TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash128Type >>();
	...
	public ICFBamDbKeyHash128Type createDbKeyHash128Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Type iBuff )
	{
		final String S_ProcName = "createDbKeyHash128Type";
		
		CFBamBuffDbKeyHash128Type Buff = (CFBamBuffDbKeyHash128Type)(schema.getTableDbKeyHash128Def().createDbKeyHash128Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash128Type.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash128Type.CLASS_CODE) {
	...
	public ICFBamDbKeyHash128Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.lockDerived";
		ICFBamDbKeyHash128Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash128Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash128Type[] retList = new ICFBamDbKeyHash128Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash128Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash128Type ) {
			return( (ICFBamDbKeyHash128Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash128Type ) ) {
					filteredList.add( (ICFBamDbKeyHash128Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash128Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDbKeyHash128Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDbKeyHash128Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDbKeyHash128Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDbKeyHash128Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash128Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readRec";
		ICFBamDbKeyHash128Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash128Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readAllRec";
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash128Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash128Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash128Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash128Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash128Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readRecBySchemaIdx() ";
		ICFBamDbKeyHash128Type buff;
		ArrayList<ICFBamDbKeyHash128Type> filteredList = new ArrayList<ICFBamDbKeyHash128Type>();
		ICFBamDbKeyHash128Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash128Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash128Type)cur );
		}
		...
		return( (CFBamBuffDbKeyHash128Type)editCur );
	}
	...
	public ICFBamDbKeyHash128Type updateDbKeyHash128Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Type iBuff )
	{
		CFBamBuffDbKeyHash128Type Buff = (CFBamBuffDbKeyHash128Type)(schema.getTableDbKeyHash128Def().updateDbKeyHash128Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash128Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash128TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Type >();
		...
		ICFBamDbKeyHash128Type iBuff )
	{
		...
		CFBamBuffDbKeyHash128Type Buff = (CFBamBuffDbKeyHash128Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash128Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamDbKeyHash128TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffDbKeyHash128Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash128Type> matchSet = new LinkedList<CFBamBuffDbKeyHash128Type>();
		Iterator<CFBamBuffDbKeyHash128Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash128Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash128Type)(schema.getTableDbKeyHash128Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash128Type.CLASS_CODE == subClassCode ) {
