	...
	implements ICFBamDbKeyHash128TypeTable
{
		...
		ICFBamDbKeyHash128Type iBuff )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash128Type iBuff )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash128TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash128TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Type().newBySchemaIdxKey();
