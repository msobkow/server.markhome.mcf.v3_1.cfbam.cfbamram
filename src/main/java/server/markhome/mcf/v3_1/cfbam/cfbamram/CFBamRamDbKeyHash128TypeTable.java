	...
	implements ICFBamDbKeyHash128TypeTable
{
		...
		ICFBamDbKeyHash128Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type >();
		...
		ICFBamDbKeyHash128Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash128Type >();
