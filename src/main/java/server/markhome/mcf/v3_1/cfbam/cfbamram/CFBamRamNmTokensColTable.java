...
// Description: Java 25 in-memory RAM DbIO implementation for NmTokensCol.
	...
	implements ICFBamNmTokensColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNmTokensCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffNmTokensCol >();
	private Map< CFBamBuffNmTokensColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokensCol >> dictByTableIdx
		= new HashMap< CFBamBuffNmTokensColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokensCol >>();
	...
	public ICFBamNmTokensCol createNmTokensCol( ICFSecAuthorization Authorization,
		ICFBamNmTokensCol iBuff )
	{
		final String S_ProcName = "createNmTokensCol";
		
		CFBamBuffNmTokensCol Buff = (CFBamBuffNmTokensCol)(schema.getTableNmTokensDef().createNmTokensDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamNmTokensCol.CLASS_CODE ) {
		...
		CFBamBuffNmTokensColByTableIdxKey keyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokensCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNmTokensCol.CLASS_CODE) {
	...
	public ICFBamNmTokensCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensCol.lockDerived";
		ICFBamNmTokensCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNmTokensCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNmTokensCol[] retList = new ICFBamNmTokensCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNmTokensCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNmTokensCol ) {
			return( (ICFBamNmTokensCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNmTokensCol ) ) {
					filteredList.add( (ICFBamNmTokensCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNmTokensCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey key = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamNmTokensCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffNmTokensCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamNmTokensCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffNmTokensCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffNmTokensCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamNmTokensCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamNmTokensCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensCol.readRec";
		ICFBamNmTokensCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNmTokensCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNmTokensCol.readAllRec";
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokensCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNmTokensCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNmTokensCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNmTokensCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamNmTokensCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamNmTokensCol.readRecByTableIdx() ";
		ICFBamNmTokensCol buff;
		ArrayList<ICFBamNmTokensCol> filteredList = new ArrayList<ICFBamNmTokensCol>();
		ICFBamNmTokensCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokensCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNmTokensCol)cur );
		}
		...
		return( (CFBamBuffNmTokensCol)editCur );
	}
	...
	public ICFBamNmTokensCol updateNmTokensCol( ICFSecAuthorization Authorization,
		ICFBamNmTokensCol iBuff )
	{
		CFBamBuffNmTokensCol Buff = (CFBamBuffNmTokensCol)(schema.getTableNmTokensDef().updateNmTokensDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNmTokensCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNmTokensColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokensColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokensCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensCol >();
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensCol Buff = (CFBamBuffNmTokensCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNmTokensCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffNmTokensCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffNmTokensCol> matchSet = new LinkedList<CFBamBuffNmTokensCol>();
		Iterator<CFBamBuffNmTokensCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNmTokensCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNmTokensCol)(schema.getTableNmTokensCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
