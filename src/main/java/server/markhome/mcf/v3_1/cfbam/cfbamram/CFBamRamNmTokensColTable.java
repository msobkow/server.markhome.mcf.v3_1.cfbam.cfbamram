	...
	implements ICFBamNmTokensColTable
{
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey keyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getFactoryNmTokensCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey key = (CFBamBuffNmTokensColByTableIdxKey)schema.getFactoryNmTokensCol().newByTableIdxKey();
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getFactoryNmTokensCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokensColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getFactoryNmTokensCol().newByTableIdxKey();
