	...
	implements ICFBamNmTokensColTable
{
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey keyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey key = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokensColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokensColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
