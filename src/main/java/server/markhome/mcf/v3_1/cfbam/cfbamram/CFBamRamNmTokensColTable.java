	...
	implements ICFBamNmTokensColTable
{
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokensCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffNmTokensCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensCol >();
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokensCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensCol >();
