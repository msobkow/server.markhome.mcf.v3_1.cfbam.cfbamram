...
// Description: Java 25 in-memory RAM DbIO implementation for NmTokensDef.
	...
	implements ICFBamNmTokensDefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNmTokensDef > dictByPKey
	...
	public ICFBamNmTokensDef createNmTokensDef( ICFSecAuthorization Authorization,
		ICFBamNmTokensDef iBuff )
	{
		final String S_ProcName = "createNmTokensDef";
		
		CFBamBuffNmTokensDef Buff = (CFBamBuffNmTokensDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNmTokensDef.CLASS_CODE) {
	...
	public ICFBamNmTokensDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensDef.lockDerived";
		ICFBamNmTokensDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNmTokensDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNmTokensDef[] retList = new ICFBamNmTokensDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNmTokensDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNmTokensDef ) {
			return( (ICFBamNmTokensDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNmTokensDef ) ) {
					filteredList.add( (ICFBamNmTokensDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNmTokensDef[0] ) );
		}
	}
	...
	public ICFBamNmTokensDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensDef.readRec";
		ICFBamNmTokensDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNmTokensDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNmTokensDef.readAllRec";
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokensDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNmTokensDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNmTokensDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNmTokensDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensDef buff;
		ArrayList<ICFBamNmTokensDef> filteredList = new ArrayList<ICFBamNmTokensDef>();
		ICFBamNmTokensDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNmTokensDef)cur );
		}
		...
		return( (CFBamBuffNmTokensDef)editCur );
	}
	...
	public ICFBamNmTokensDef updateNmTokensDef( ICFSecAuthorization Authorization,
		ICFBamNmTokensDef iBuff )
	{
		CFBamBuffNmTokensDef Buff = (CFBamBuffNmTokensDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNmTokensDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokensDef > subdict;
		...
		ICFBamNmTokensDef iBuff )
	{
		...
		CFBamBuffNmTokensDef Buff = (CFBamBuffNmTokensDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNmTokensDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffNmTokensDef cur;
		LinkedList<CFBamBuffNmTokensDef> matchSet = new LinkedList<CFBamBuffNmTokensDef>();
		Iterator<CFBamBuffNmTokensDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNmTokensDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNmTokensDef)(schema.getTableNmTokensDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamNmTokensDef.CLASS_CODE == subClassCode ) {
