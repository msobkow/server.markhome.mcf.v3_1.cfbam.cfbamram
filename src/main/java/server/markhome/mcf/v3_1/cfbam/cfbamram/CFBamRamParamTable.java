	...
	implements ICFBamParamTable
{
	...
	public CFBamBuffParam ensureRec(ICFBamParam rec) {
		return (((CFBamBuffParamFactoryService)(schema.getCFBamBuffFactory().getFactoryParam())).ensureRec(rec));
	}
		...
		ICFBamParam iBuff )
	{
		...
		CFBamBuffParamByUNameIdxKey keyUNameIdx = (CFBamBuffParamByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByUNameIdxKey();
		keyUNameIdx.setRequiredServerMethodId( Buff.getRequiredServerMethodId() );
		keyUNameIdx.setRequiredName( Buff.getRequiredName() );

		CFBamBuffParamByServerMethodIdxKey keyServerMethodIdx = (CFBamBuffParamByServerMethodIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerMethodIdxKey();
		keyServerMethodIdx.setRequiredServerMethodId( Buff.getRequiredServerMethodId() );

		CFBamBuffParamByDefSchemaIdxKey keyDefSchemaIdx = (CFBamBuffParamByDefSchemaIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByDefSchemaIdxKey();
		keyDefSchemaIdx.setOptionalDefSchemaId( Buff.getOptionalDefSchemaId() );

		CFBamBuffParamByServerTypeIdxKey keyServerTypeIdx = (CFBamBuffParamByServerTypeIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerTypeIdxKey();
		keyServerTypeIdx.setOptionalTypeId( Buff.getOptionalTypeId() );

		CFBamBuffParamByPrevIdxKey keyPrevIdx = (CFBamBuffParamByPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByPrevIdxKey();
		keyPrevIdx.setOptionalPrevId( Buff.getOptionalPrevId() );

		CFBamBuffParamByNextIdxKey keyNextIdx = (CFBamBuffParamByNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByNextIdxKey();
		keyNextIdx.setOptionalNextId( Buff.getOptionalNextId() );

		CFBamBuffParamByContPrevIdxKey keyContPrevIdx = (CFBamBuffParamByContPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContPrevIdxKey();
		...
		CFBamBuffParamByContNextIdxKey keyContNextIdx = (CFBamBuffParamByContNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContNextIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffParam > subdictServerMethodIdx;
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamParam.CLASS_CODE) {
				CFBamBuffParam retbuff = ((CFBamBuffParam)(schema.getCFBamBuffFactory().getFactoryParam().newRec()));
				retbuff.set(Buff);
				return( retbuff );
			}
			else {
		...
		String Name )
	{
		...
		CFBamBuffParamByUNameIdxKey key = (CFBamBuffParamByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByUNameIdxKey();
		...
		ICFLibKeyHash256 ServerMethodId )
	{
		...
		CFBamBuffParamByServerMethodIdxKey key = (CFBamBuffParamByServerMethodIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerMethodIdxKey();
		...
		if( dictByServerMethodIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffParam > subdictServerMethodIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffParam >();
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		CFBamBuffParamByDefSchemaIdxKey key = (CFBamBuffParamByDefSchemaIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByDefSchemaIdxKey();
		...
		ICFLibKeyHash256 TypeId )
	{
		...
		CFBamBuffParamByServerTypeIdxKey key = (CFBamBuffParamByServerTypeIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerTypeIdxKey();
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		CFBamBuffParamByPrevIdxKey key = (CFBamBuffParamByPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByPrevIdxKey();
		...
		ICFLibKeyHash256 NextId )
	{
		...
		CFBamBuffParamByNextIdxKey key = (CFBamBuffParamByNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByNextIdxKey();
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		CFBamBuffParamByContPrevIdxKey key = (CFBamBuffParamByContPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContPrevIdxKey();
		...
		ICFLibKeyHash256 NextId )
	{
		...
		CFBamBuffParamByContNextIdxKey key = (CFBamBuffParamByContNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContNextIdxKey();
		...
		int revision )
	{
		...
		ICFBamParam newInstance;
			if( classCode == ICFBamParam.CLASS_CODE ) {
				newInstance = schema.getCFBamBuffFactory().getFactoryParam().newRec();
			}
			else {
		...
		ICFBamParam iBuff )
	{
		...
		CFBamBuffParamByUNameIdxKey existingKeyUNameIdx = (CFBamBuffParamByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByUNameIdxKey();
		existingKeyUNameIdx.setRequiredServerMethodId( existing.getRequiredServerMethodId() );
		existingKeyUNameIdx.setRequiredName( existing.getRequiredName() );

		CFBamBuffParamByUNameIdxKey newKeyUNameIdx = (CFBamBuffParamByUNameIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByUNameIdxKey();
		newKeyUNameIdx.setRequiredServerMethodId( Buff.getRequiredServerMethodId() );
		newKeyUNameIdx.setRequiredName( Buff.getRequiredName() );

		CFBamBuffParamByServerMethodIdxKey existingKeyServerMethodIdx = (CFBamBuffParamByServerMethodIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerMethodIdxKey();
		existingKeyServerMethodIdx.setRequiredServerMethodId( existing.getRequiredServerMethodId() );

		CFBamBuffParamByServerMethodIdxKey newKeyServerMethodIdx = (CFBamBuffParamByServerMethodIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerMethodIdxKey();
		newKeyServerMethodIdx.setRequiredServerMethodId( Buff.getRequiredServerMethodId() );

		CFBamBuffParamByDefSchemaIdxKey existingKeyDefSchemaIdx = (CFBamBuffParamByDefSchemaIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByDefSchemaIdxKey();
		existingKeyDefSchemaIdx.setOptionalDefSchemaId( existing.getOptionalDefSchemaId() );

		CFBamBuffParamByDefSchemaIdxKey newKeyDefSchemaIdx = (CFBamBuffParamByDefSchemaIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByDefSchemaIdxKey();
		newKeyDefSchemaIdx.setOptionalDefSchemaId( Buff.getOptionalDefSchemaId() );

		CFBamBuffParamByServerTypeIdxKey existingKeyServerTypeIdx = (CFBamBuffParamByServerTypeIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerTypeIdxKey();
		existingKeyServerTypeIdx.setOptionalTypeId( existing.getOptionalTypeId() );

		CFBamBuffParamByServerTypeIdxKey newKeyServerTypeIdx = (CFBamBuffParamByServerTypeIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByServerTypeIdxKey();
		newKeyServerTypeIdx.setOptionalTypeId( Buff.getOptionalTypeId() );

		CFBamBuffParamByPrevIdxKey existingKeyPrevIdx = (CFBamBuffParamByPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByPrevIdxKey();
		existingKeyPrevIdx.setOptionalPrevId( existing.getOptionalPrevId() );

		CFBamBuffParamByPrevIdxKey newKeyPrevIdx = (CFBamBuffParamByPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByPrevIdxKey();
		newKeyPrevIdx.setOptionalPrevId( Buff.getOptionalPrevId() );

		CFBamBuffParamByNextIdxKey existingKeyNextIdx = (CFBamBuffParamByNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByNextIdxKey();
		existingKeyNextIdx.setOptionalNextId( existing.getOptionalNextId() );

		CFBamBuffParamByNextIdxKey newKeyNextIdx = (CFBamBuffParamByNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByNextIdxKey();
		newKeyNextIdx.setOptionalNextId( Buff.getOptionalNextId() );

		CFBamBuffParamByContPrevIdxKey existingKeyContPrevIdx = (CFBamBuffParamByContPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContPrevIdxKey();
		...
		CFBamBuffParamByContPrevIdxKey newKeyContPrevIdx = (CFBamBuffParamByContPrevIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContPrevIdxKey();
		...
		CFBamBuffParamByContNextIdxKey existingKeyContNextIdx = (CFBamBuffParamByContNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContNextIdxKey();
		...
		CFBamBuffParamByContNextIdxKey newKeyContNextIdx = (CFBamBuffParamByContNextIdxKey)schema.getCFBamBuffFactory().getFactoryParam().newByContNextIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffParam > subdict;
		...
		if( dictByServerMethodIdx.containsKey( newKeyServerMethodIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffParam >();
		...
		ICFBamParam iBuff )
	{
		...
		ICFLibKeyHash256 varServerMethodId = existing.getRequiredServerMethodId();
		...
		if( ( prevId != null ) )
		{
			...
			classCode = prev.getClassCode();
			if( classCode == ICFBamParam.CLASS_CODE ) {
				editPrev = (CFBamBuffParam)(schema.getCFBamBuffFactory().getFactoryParam().newRec());
			}
			else {
		...
		if( ( nextId != null ) )
		{
			...
			classCode = next.getClassCode();
			if( classCode == ICFBamParam.CLASS_CODE ) {
				editNext = (CFBamBuffParam)(schema.getCFBamBuffFactory().getFactoryParam().newRec());
			}
			else {
