...
// Description: Java 25 in-memory RAM DbIO implementation for TextType.
	...
	implements ICFBamTextTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTextType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTextType >();
	private Map< CFBamBuffTextTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTextType >> dictBySchemaIdx
		= new HashMap< CFBamBuffTextTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTextType >>();
	...
	public ICFBamTextType createTextType( ICFSecAuthorization Authorization,
		ICFBamTextType iBuff )
	{
		final String S_ProcName = "createTextType";
		
		CFBamBuffTextType Buff = (CFBamBuffTextType)(schema.getTableTextDef().createTextDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTextType.CLASS_CODE ) {
		...
		CFBamBuffTextTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTextType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTextType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTextType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTextType.CLASS_CODE) {
	...
	public ICFBamTextType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTextType.lockDerived";
		ICFBamTextType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTextType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTextType[] retList = new ICFBamTextType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTextType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTextType ) {
			return( (ICFBamTextType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTextType ) ) {
					filteredList.add( (ICFBamTextType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTextType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey key = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTextType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamTextType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTextType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamTextType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffTextType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTextType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTextType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamTextType[0];
		}
		return( recArray );
	}
	...
	public ICFBamTextType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTextType.readRec";
		ICFBamTextType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTextType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTextType.readAllRec";
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTextType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTextType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTextType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTextType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTextType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamTextType.readRecBySchemaIdx() ";
		ICFBamTextType buff;
		ArrayList<ICFBamTextType> filteredList = new ArrayList<ICFBamTextType>();
		ICFBamTextType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTextType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffTextType)editCur );
	}
	...
	public ICFBamTextType updateTextType( ICFSecAuthorization Authorization,
		ICFBamTextType iBuff )
	{
		CFBamBuffTextType Buff = (CFBamBuffTextType)(schema.getTableTextDef().updateTextDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTextType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTextTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTextType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTextTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTextType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTextType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTextType >();
		...
		ICFBamTextType iBuff )
	{
		...
		CFBamBuffTextType Buff = (CFBamBuffTextType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTextType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTextType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTextType> matchSet = new LinkedList<CFBamBuffTextType>();
		Iterator<CFBamBuffTextType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTextType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTextType)(schema.getTableTextType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
