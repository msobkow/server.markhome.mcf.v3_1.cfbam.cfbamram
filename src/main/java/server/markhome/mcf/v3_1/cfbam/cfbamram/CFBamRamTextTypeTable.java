	...
	implements ICFBamTextTypeTable
{
		...
		ICFBamTextType iBuff )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getFactoryTextType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey key = (CFBamBuffTextTypeBySchemaIdxKey)schema.getFactoryTextType().newBySchemaIdxKey();
		...
		ICFBamTextType iBuff )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getFactoryTextType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTextTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getFactoryTextType().newBySchemaIdxKey();
