	...
	implements ICFBamTextTypeTable
{
		...
		ICFBamTextType iBuff )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTextType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey key = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTextType().newBySchemaIdxKey();
		...
		ICFBamTextType iBuff )
	{
		...
		CFBamBuffTextTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTextType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTextTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTextTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTextType().newBySchemaIdxKey();
