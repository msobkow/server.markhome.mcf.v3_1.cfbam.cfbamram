	...
	implements ICFBamTextTypeTable
{
		...
		ICFBamTextType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTextType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTextType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTextType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTextType >();
		...
		ICFBamTextType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTextType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTextType >();
