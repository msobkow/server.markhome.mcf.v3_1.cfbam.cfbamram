	...
	implements ICFBamDbKeyHash256ColTable
{
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col >();
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Col >();
