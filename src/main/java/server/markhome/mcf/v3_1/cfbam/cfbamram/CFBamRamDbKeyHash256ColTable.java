	...
	implements ICFBamDbKeyHash256ColTable
{
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getFactoryDbKeyHash256Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey key = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getFactoryDbKeyHash256Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getFactoryDbKeyHash256Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash256ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getFactoryDbKeyHash256Col().newByTableIdxKey();
