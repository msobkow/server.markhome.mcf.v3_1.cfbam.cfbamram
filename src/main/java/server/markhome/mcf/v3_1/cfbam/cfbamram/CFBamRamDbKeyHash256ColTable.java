...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash256Col.
	...
	implements ICFBamDbKeyHash256ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Col >();
	private Map< CFBamBuffDbKeyHash256ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash256Col >> dictByTableIdx
		= new HashMap< CFBamBuffDbKeyHash256ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash256Col >>();
	...
	public ICFBamDbKeyHash256Col createDbKeyHash256Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Col iBuff )
	{
		final String S_ProcName = "createDbKeyHash256Col";
		
		CFBamBuffDbKeyHash256Col Buff = (CFBamBuffDbKeyHash256Col)(schema.getTableDbKeyHash256Def().createDbKeyHash256Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash256Col.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash256Col.CLASS_CODE) {
	...
	public ICFBamDbKeyHash256Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.lockDerived";
		ICFBamDbKeyHash256Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash256Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash256Col[] retList = new ICFBamDbKeyHash256Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash256Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash256Col ) {
			return( (ICFBamDbKeyHash256Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash256Col ) ) {
					filteredList.add( (ICFBamDbKeyHash256Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash256Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey key = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDbKeyHash256Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDbKeyHash256Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDbKeyHash256Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDbKeyHash256Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash256Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readRec";
		ICFBamDbKeyHash256Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash256Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readAllRec";
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash256Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash256Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash256Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash256Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readRecByTableIdx() ";
		ICFBamDbKeyHash256Col buff;
		ArrayList<ICFBamDbKeyHash256Col> filteredList = new ArrayList<ICFBamDbKeyHash256Col>();
		ICFBamDbKeyHash256Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash256Col)cur );
		}
		...
		return( (CFBamBuffDbKeyHash256Col)editCur );
	}
	...
	public ICFBamDbKeyHash256Col updateDbKeyHash256Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Col iBuff )
	{
		CFBamBuffDbKeyHash256Col Buff = (CFBamBuffDbKeyHash256Col)(schema.getTableDbKeyHash256Def().updateDbKeyHash256Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash256Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash256ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash256ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash256ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Col >();
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		CFBamBuffDbKeyHash256Col Buff = (CFBamBuffDbKeyHash256Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash256Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash256Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash256Col> matchSet = new LinkedList<CFBamBuffDbKeyHash256Col>();
		Iterator<CFBamBuffDbKeyHash256Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash256Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash256Col)(schema.getTableDbKeyHash256Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
