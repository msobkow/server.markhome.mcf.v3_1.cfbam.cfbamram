...
// Description: Java 25 in-memory RAM DbIO implementation for FloatCol.
	...
	implements ICFBamFloatColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffFloatCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffFloatCol >();
	private Map< CFBamBuffFloatColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffFloatCol >> dictByTableIdx
		= new HashMap< CFBamBuffFloatColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffFloatCol >>();
	...
	public ICFBamFloatCol createFloatCol( ICFSecAuthorization Authorization,
		ICFBamFloatCol iBuff )
	{
		final String S_ProcName = "createFloatCol";
		
		CFBamBuffFloatCol Buff = (CFBamBuffFloatCol)(schema.getTableFloatDef().createFloatDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamFloatCol.CLASS_CODE ) {
		...
		CFBamBuffFloatColByTableIdxKey keyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryFloatCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffFloatCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffFloatCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamFloatCol.CLASS_CODE) {
	...
	public ICFBamFloatCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatCol.lockDerived";
		ICFBamFloatCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamFloatCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamFloatCol[] retList = new ICFBamFloatCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffFloatCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamFloatCol ) {
			return( (ICFBamFloatCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamFloatCol ) ) {
					filteredList.add( (ICFBamFloatCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamFloatCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffFloatColByTableIdxKey key = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryFloatCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamFloatCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffFloatCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamFloatCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffFloatCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffFloatCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffFloatCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamFloatCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamFloatCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatCol.readRec";
		ICFBamFloatCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamFloatCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamFloatCol.readAllRec";
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamFloatCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamFloatCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamFloatCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamFloatCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamFloatCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamFloatCol.readRecByTableIdx() ";
		ICFBamFloatCol buff;
		ArrayList<ICFBamFloatCol> filteredList = new ArrayList<ICFBamFloatCol>();
		ICFBamFloatCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamFloatCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffFloatCol)editCur );
	}
	...
	public ICFBamFloatCol updateFloatCol( ICFSecAuthorization Authorization,
		ICFBamFloatCol iBuff )
	{
		CFBamBuffFloatCol Buff = (CFBamBuffFloatCol)(schema.getTableFloatDef().updateFloatDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffFloatCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffFloatColByTableIdxKey existingKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryFloatCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffFloatColByTableIdxKey newKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryFloatCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffFloatCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffFloatCol >();
		...
		ICFBamFloatCol iBuff )
	{
		...
		CFBamBuffFloatCol Buff = (CFBamBuffFloatCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffFloatCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffFloatCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffFloatCol> matchSet = new LinkedList<CFBamBuffFloatCol>();
		Iterator<CFBamBuffFloatCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffFloatCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffFloatCol)(schema.getTableFloatCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
