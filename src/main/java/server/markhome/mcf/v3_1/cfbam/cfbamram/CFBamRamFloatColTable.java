	...
	implements ICFBamFloatColTable
{
		...
		ICFBamFloatCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffFloatCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffFloatCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffFloatCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffFloatCol >();
		...
		ICFBamFloatCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffFloatCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffFloatCol >();
