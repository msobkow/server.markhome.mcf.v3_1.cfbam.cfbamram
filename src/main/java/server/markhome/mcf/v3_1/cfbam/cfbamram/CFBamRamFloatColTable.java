	...
	implements ICFBamFloatColTable
{
		...
		ICFBamFloatCol iBuff )
	{
		...
		CFBamBuffFloatColByTableIdxKey keyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getFactoryFloatCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffFloatColByTableIdxKey key = (CFBamBuffFloatColByTableIdxKey)schema.getFactoryFloatCol().newByTableIdxKey();
		...
		ICFBamFloatCol iBuff )
	{
		...
		CFBamBuffFloatColByTableIdxKey existingKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getFactoryFloatCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffFloatColByTableIdxKey newKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getFactoryFloatCol().newByTableIdxKey();
