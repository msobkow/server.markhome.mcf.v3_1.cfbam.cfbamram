	...
	implements ICFBamFloatColTable
{
		...
		ICFBamFloatCol iBuff )
	{
		...
		CFBamBuffFloatColByTableIdxKey keyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamFactory().getFactoryFloatCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffFloatColByTableIdxKey key = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamFactory().getFactoryFloatCol().newByTableIdxKey();
		...
		ICFBamFloatCol iBuff )
	{
		...
		CFBamBuffFloatColByTableIdxKey existingKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamFactory().getFactoryFloatCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffFloatColByTableIdxKey newKeyTableIdx = (CFBamBuffFloatColByTableIdxKey)schema.getCFBamFactory().getFactoryFloatCol().newByTableIdxKey();
