...
// Description: Java 25 in-memory RAM DbIO implementation for DoubleCol.
	...
	implements ICFBamDoubleColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDoubleCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDoubleCol >();
	private Map< CFBamBuffDoubleColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDoubleCol >> dictByTableIdx
		= new HashMap< CFBamBuffDoubleColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDoubleCol >>();
	...
	public ICFBamDoubleCol createDoubleCol( ICFSecAuthorization Authorization,
		ICFBamDoubleCol iBuff )
	{
		final String S_ProcName = "createDoubleCol";
		
		CFBamBuffDoubleCol Buff = (CFBamBuffDoubleCol)(schema.getTableDoubleDef().createDoubleDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDoubleCol.CLASS_CODE ) {
		...
		CFBamBuffDoubleColByTableIdxKey keyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDoubleCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDoubleCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDoubleCol.CLASS_CODE) {
	...
	public ICFBamDoubleCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDoubleCol.lockDerived";
		ICFBamDoubleCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDoubleCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDoubleCol[] retList = new ICFBamDoubleCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDoubleCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDoubleCol ) {
			return( (ICFBamDoubleCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDoubleCol ) ) {
					filteredList.add( (ICFBamDoubleCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDoubleCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDoubleColByTableIdxKey key = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDoubleCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDoubleCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDoubleCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDoubleCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDoubleCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDoubleCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDoubleCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamDoubleCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDoubleCol.readRec";
		ICFBamDoubleCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDoubleCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDoubleCol.readAllRec";
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDoubleCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDoubleCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDoubleCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDoubleCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDoubleCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDoubleCol.readRecByTableIdx() ";
		ICFBamDoubleCol buff;
		ArrayList<ICFBamDoubleCol> filteredList = new ArrayList<ICFBamDoubleCol>();
		ICFBamDoubleCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDoubleCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffDoubleCol)editCur );
	}
	...
	public ICFBamDoubleCol updateDoubleCol( ICFSecAuthorization Authorization,
		ICFBamDoubleCol iBuff )
	{
		CFBamBuffDoubleCol Buff = (CFBamBuffDoubleCol)(schema.getTableDoubleDef().updateDoubleDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDoubleCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDoubleColByTableIdxKey existingKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDoubleColByTableIdxKey newKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDoubleCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDoubleCol >();
		...
		ICFBamDoubleCol iBuff )
	{
		...
		CFBamBuffDoubleCol Buff = (CFBamBuffDoubleCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDoubleCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDoubleCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDoubleCol> matchSet = new LinkedList<CFBamBuffDoubleCol>();
		Iterator<CFBamBuffDoubleCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDoubleCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDoubleCol)(schema.getTableDoubleCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
