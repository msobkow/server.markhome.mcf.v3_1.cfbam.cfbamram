	...
	implements ICFBamDoubleColTable
{
		...
		ICFBamDoubleCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDoubleCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDoubleCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleCol >();
		...
		ICFBamDoubleCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDoubleCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleCol >();
