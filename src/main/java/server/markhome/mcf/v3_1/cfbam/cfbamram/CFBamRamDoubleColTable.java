	...
	implements ICFBamDoubleColTable
{
		...
		ICFBamDoubleCol iBuff )
	{
		...
		CFBamBuffDoubleColByTableIdxKey keyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getFactoryDoubleCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDoubleColByTableIdxKey key = (CFBamBuffDoubleColByTableIdxKey)schema.getFactoryDoubleCol().newByTableIdxKey();
		...
		ICFBamDoubleCol iBuff )
	{
		...
		CFBamBuffDoubleColByTableIdxKey existingKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getFactoryDoubleCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDoubleColByTableIdxKey newKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getFactoryDoubleCol().newByTableIdxKey();
