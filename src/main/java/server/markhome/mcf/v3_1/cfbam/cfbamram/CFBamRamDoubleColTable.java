	...
	implements ICFBamDoubleColTable
{
		...
		ICFBamDoubleCol iBuff )
	{
		...
		CFBamBuffDoubleColByTableIdxKey keyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDoubleColByTableIdxKey key = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
		...
		ICFBamDoubleCol iBuff )
	{
		...
		CFBamBuffDoubleColByTableIdxKey existingKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDoubleColByTableIdxKey newKeyTableIdx = (CFBamBuffDoubleColByTableIdxKey)schema.getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
