	...
	implements ICFBamUuid6TypeTable
{
		...
		ICFBamUuid6Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUuid6Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUuid6Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUuid6Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUuid6Type >();
		...
		ICFBamUuid6Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUuid6Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUuid6Type >();
