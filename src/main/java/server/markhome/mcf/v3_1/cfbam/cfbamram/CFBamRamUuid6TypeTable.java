	...
	implements ICFBamUuid6TypeTable
{
		...
		ICFBamUuid6Type iBuff )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getFactoryUuid6Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey key = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getFactoryUuid6Type().newBySchemaIdxKey();
		...
		ICFBamUuid6Type iBuff )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getFactoryUuid6Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuid6TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getFactoryUuid6Type().newBySchemaIdxKey();
