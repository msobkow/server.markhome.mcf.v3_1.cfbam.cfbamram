...
// Description: Java 25 in-memory RAM DbIO implementation for Uuid6Type.
	...
	implements ICFBamUuid6TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUuid6Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUuid6Type >();
	private Map< CFBamBuffUuid6TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuid6Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffUuid6TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuid6Type >>();
	...
	public ICFBamUuid6Type createUuid6Type( ICFSecAuthorization Authorization,
		ICFBamUuid6Type iBuff )
	{
		final String S_ProcName = "createUuid6Type";
		
		CFBamBuffUuid6Type Buff = (CFBamBuffUuid6Type)(schema.getTableUuid6Def().createUuid6Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUuid6Type.CLASS_CODE ) {
		...
		CFBamBuffUuid6TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuid6Type.CLASS_CODE) {
	...
	public ICFBamUuid6Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Type.lockDerived";
		ICFBamUuid6Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuid6Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuid6Type[] retList = new ICFBamUuid6Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuid6Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuid6Type ) {
			return( (ICFBamUuid6Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuid6Type ) ) {
					filteredList.add( (ICFBamUuid6Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuid6Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey key = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamUuid6Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUuid6Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamUuid6Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffUuid6Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUuid6Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamUuid6Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamUuid6Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readRec";
		ICFBamUuid6Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuid6Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuid6Type.readAllRec";
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuid6Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuid6Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuid6Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuid6Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUuid6Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readRecBySchemaIdx() ";
		ICFBamUuid6Type buff;
		ArrayList<ICFBamUuid6Type> filteredList = new ArrayList<ICFBamUuid6Type>();
		ICFBamUuid6Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuid6Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUuid6Type)editCur );
	}
	...
	public ICFBamUuid6Type updateUuid6Type( ICFSecAuthorization Authorization,
		ICFBamUuid6Type iBuff )
	{
		CFBamBuffUuid6Type Buff = (CFBamBuffUuid6Type)(schema.getTableUuid6Def().updateUuid6Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuid6Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuid6TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuid6TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUuid6TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuid6Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuid6Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUuid6Type >();
		...
		ICFBamUuid6Type iBuff )
	{
		...
		CFBamBuffUuid6Type Buff = (CFBamBuffUuid6Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuid6Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamUuid6TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffUuid6Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUuid6Type> matchSet = new LinkedList<CFBamBuffUuid6Type>();
		Iterator<CFBamBuffUuid6Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuid6Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUuid6Type)(schema.getTableUuid6Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamUuid6Type.CLASS_CODE == subClassCode ) {
