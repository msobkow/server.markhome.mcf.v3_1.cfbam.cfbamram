	...
	implements ICFBamStringColTable
{
		...
		ICFBamStringCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffStringCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffStringCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffStringCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffStringCol >();
		...
		ICFBamStringCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffStringCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffStringCol >();
