	...
	implements ICFBamStringColTable
{
		...
		ICFBamStringCol iBuff )
	{
		...
		CFBamBuffStringColByTableIdxKey keyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getFactoryStringCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffStringColByTableIdxKey key = (CFBamBuffStringColByTableIdxKey)schema.getFactoryStringCol().newByTableIdxKey();
		...
		ICFBamStringCol iBuff )
	{
		...
		CFBamBuffStringColByTableIdxKey existingKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getFactoryStringCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffStringColByTableIdxKey newKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getFactoryStringCol().newByTableIdxKey();
