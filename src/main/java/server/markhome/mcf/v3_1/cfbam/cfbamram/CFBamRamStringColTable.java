	...
	implements ICFBamStringColTable
{
		...
		ICFBamStringCol iBuff )
	{
		...
		CFBamBuffStringColByTableIdxKey keyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamFactory().getFactoryStringCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffStringColByTableIdxKey key = (CFBamBuffStringColByTableIdxKey)schema.getCFBamFactory().getFactoryStringCol().newByTableIdxKey();
		...
		ICFBamStringCol iBuff )
	{
		...
		CFBamBuffStringColByTableIdxKey existingKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamFactory().getFactoryStringCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffStringColByTableIdxKey newKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamFactory().getFactoryStringCol().newByTableIdxKey();
