...
// Description: Java 25 in-memory RAM DbIO implementation for StringCol.
	...
	implements ICFBamStringColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffStringCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffStringCol >();
	private Map< CFBamBuffStringColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffStringCol >> dictByTableIdx
		= new HashMap< CFBamBuffStringColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffStringCol >>();
	...
	public ICFBamStringCol createStringCol( ICFSecAuthorization Authorization,
		ICFBamStringCol iBuff )
	{
		final String S_ProcName = "createStringCol";
		
		CFBamBuffStringCol Buff = (CFBamBuffStringCol)(schema.getTableStringDef().createStringDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamStringCol.CLASS_CODE ) {
		...
		CFBamBuffStringColByTableIdxKey keyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryStringCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffStringCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffStringCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamStringCol.CLASS_CODE) {
	...
	public ICFBamStringCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamStringCol.lockDerived";
		ICFBamStringCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamStringCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamStringCol[] retList = new ICFBamStringCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffStringCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamStringCol ) {
			return( (ICFBamStringCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamStringCol ) ) {
					filteredList.add( (ICFBamStringCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamStringCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffStringColByTableIdxKey key = (CFBamBuffStringColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryStringCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamStringCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffStringCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamStringCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffStringCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffStringCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffStringCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamStringCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamStringCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamStringCol.readRec";
		ICFBamStringCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamStringCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamStringCol.readAllRec";
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamStringCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamStringCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamStringCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamStringCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamStringCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamStringCol.readRecByTableIdx() ";
		ICFBamStringCol buff;
		ArrayList<ICFBamStringCol> filteredList = new ArrayList<ICFBamStringCol>();
		ICFBamStringCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamStringCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffStringCol)editCur );
	}
	...
	public ICFBamStringCol updateStringCol( ICFSecAuthorization Authorization,
		ICFBamStringCol iBuff )
	{
		CFBamBuffStringCol Buff = (CFBamBuffStringCol)(schema.getTableStringDef().updateStringDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffStringCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffStringColByTableIdxKey existingKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryStringCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffStringColByTableIdxKey newKeyTableIdx = (CFBamBuffStringColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryStringCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffStringCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffStringCol >();
		...
		ICFBamStringCol iBuff )
	{
		...
		CFBamBuffStringCol Buff = (CFBamBuffStringCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffStringCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
