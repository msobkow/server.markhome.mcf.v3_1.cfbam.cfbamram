	...
	implements ICFBamUInt16DefTable
{
	...
	public ICFBamUInt16Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Def.lockDerived";
		ICFBamUInt16Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt16Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffUInt16Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public ICFBamUInt16Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Def.readRec";
	...
	{
		final String S_ProcName = "CFBamRamUInt16Def.readAllRec";
		ICFBamUInt16Def buff;
		ArrayList<ICFBamUInt16Def> filteredList = new ArrayList<ICFBamUInt16Def>();
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt16Def)editCur );
	}
	...
	public ICFBamUInt16Def updateUInt16Def( ICFSecAuthorization Authorization,
		ICFBamUInt16Def iBuff )
	{
		CFBamBuffUInt16Def Buff = (CFBamBuffUInt16Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt16Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt16Def > subdict;
		...
		ICFBamUInt16Def iBuff )
	{
		...
		CFBamBuffUInt16Def Buff = (CFBamBuffUInt16Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt16Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffUInt16Def cur;
		LinkedList<CFBamBuffUInt16Def> matchSet = new LinkedList<CFBamBuffUInt16Def>();
		Iterator<CFBamBuffUInt16Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt16Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt16Def)(schema.getTableUInt16Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamUInt16Def.CLASS_CODE == subClassCode ) {
