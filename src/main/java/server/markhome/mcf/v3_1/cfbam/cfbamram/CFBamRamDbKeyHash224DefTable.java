...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash224Def.
	...
	implements ICFBamDbKeyHash224DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Def > dictByPKey
	...
	public ICFBamDbKeyHash224Def createDbKeyHash224Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash224Def";
		
		CFBamBuffDbKeyHash224Def Buff = (CFBamBuffDbKeyHash224Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash224Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash224Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.lockDerived";
		ICFBamDbKeyHash224Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash224Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash224Def[] retList = new ICFBamDbKeyHash224Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash224Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash224Def ) {
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash224Def ) ) {
					filteredList.add( (ICFBamDbKeyHash224Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash224Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash224Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readRec";
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readAllRec";
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Def buff;
		ArrayList<ICFBamDbKeyHash224Def> filteredList = new ArrayList<ICFBamDbKeyHash224Def>();
		ICFBamDbKeyHash224Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash224Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash224Def)editCur );
	}
	...
	public ICFBamDbKeyHash224Def updateDbKeyHash224Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Def iBuff )
	{
		CFBamBuffDbKeyHash224Def Buff = (CFBamBuffDbKeyHash224Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash224Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Def > subdict;
		...
		ICFBamDbKeyHash224Def iBuff )
	{
		...
		CFBamBuffDbKeyHash224Def Buff = (CFBamBuffDbKeyHash224Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash224Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffDbKeyHash224Def cur;
		LinkedList<CFBamBuffDbKeyHash224Def> matchSet = new LinkedList<CFBamBuffDbKeyHash224Def>();
		Iterator<CFBamBuffDbKeyHash224Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash224Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash224Def)(schema.getTableDbKeyHash224Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash224Def.CLASS_CODE == subClassCode ) {
