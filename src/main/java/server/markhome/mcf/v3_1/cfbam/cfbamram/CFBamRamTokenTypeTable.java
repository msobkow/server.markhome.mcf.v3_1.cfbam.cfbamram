	...
	implements ICFBamTokenTypeTable
{
		...
		ICFBamTokenType iBuff )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getFactoryTokenType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey key = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getFactoryTokenType().newBySchemaIdxKey();
		...
		ICFBamTokenType iBuff )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getFactoryTokenType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTokenTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getFactoryTokenType().newBySchemaIdxKey();
