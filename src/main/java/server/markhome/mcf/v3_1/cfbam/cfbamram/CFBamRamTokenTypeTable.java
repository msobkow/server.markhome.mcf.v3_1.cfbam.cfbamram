	...
	implements ICFBamTokenTypeTable
{
		...
		ICFBamTokenType iBuff )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTokenType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey key = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTokenType().newBySchemaIdxKey();
		...
		ICFBamTokenType iBuff )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTokenType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTokenTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTokenType().newBySchemaIdxKey();
