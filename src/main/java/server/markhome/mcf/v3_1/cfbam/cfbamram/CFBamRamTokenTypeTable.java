	...
	implements ICFBamTokenTypeTable
{
		...
		ICFBamTokenType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTokenType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTokenType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTokenType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTokenType >();
		...
		ICFBamTokenType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTokenType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTokenType >();
