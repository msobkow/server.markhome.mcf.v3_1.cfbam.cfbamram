...
// Description: Java 25 in-memory RAM DbIO implementation for TokenType.
	...
	implements ICFBamTokenTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTokenType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTokenType >();
	private Map< CFBamBuffTokenTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTokenType >> dictBySchemaIdx
		= new HashMap< CFBamBuffTokenTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTokenType >>();
	...
	public ICFBamTokenType createTokenType( ICFSecAuthorization Authorization,
		ICFBamTokenType iBuff )
	{
		final String S_ProcName = "createTokenType";
		
		CFBamBuffTokenType Buff = (CFBamBuffTokenType)(schema.getTableTokenDef().createTokenDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTokenType.CLASS_CODE ) {
		...
		CFBamBuffTokenTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTokenType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTokenType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTokenType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTokenType.CLASS_CODE) {
	...
	public ICFBamTokenType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenType.lockDerived";
		ICFBamTokenType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTokenType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTokenType[] retList = new ICFBamTokenType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTokenType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTokenType ) {
			return( (ICFBamTokenType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTokenType ) ) {
					filteredList.add( (ICFBamTokenType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTokenType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTokenTypeBySchemaIdxKey key = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTokenType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamTokenType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTokenType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamTokenType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffTokenType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTokenType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTokenType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamTokenType[0];
		}
		return( recArray );
	}
	...
	public ICFBamTokenType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenType.readRec";
		ICFBamTokenType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTokenType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTokenType.readAllRec";
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTokenType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTokenType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTokenType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTokenType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTokenType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamTokenType.readRecBySchemaIdx() ";
		ICFBamTokenType buff;
		ArrayList<ICFBamTokenType> filteredList = new ArrayList<ICFBamTokenType>();
		ICFBamTokenType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTokenType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffTokenType)editCur );
	}
	...
	public ICFBamTokenType updateTokenType( ICFSecAuthorization Authorization,
		ICFBamTokenType iBuff )
	{
		CFBamBuffTokenType Buff = (CFBamBuffTokenType)(schema.getTableTokenDef().updateTokenDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTokenType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTokenTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTokenType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTokenTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTokenTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTokenType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTokenType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTokenType >();
		...
		ICFBamTokenType iBuff )
	{
		...
		CFBamBuffTokenType Buff = (CFBamBuffTokenType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTokenType existing = dictByPKey.get( pkey );
		if( existing == null ) {
