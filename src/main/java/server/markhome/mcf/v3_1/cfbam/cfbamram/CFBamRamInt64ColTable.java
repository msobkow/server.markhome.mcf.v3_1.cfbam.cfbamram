...
// Description: Java 25 in-memory RAM DbIO implementation for Int64Col.
	...
	implements ICFBamInt64ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt64Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt64Col >();
	private Map< CFBamBuffInt64ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt64Col >> dictByTableIdx
		= new HashMap< CFBamBuffInt64ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt64Col >>();
	...
	public ICFBamInt64Col createInt64Col( ICFSecAuthorization Authorization,
		ICFBamInt64Col iBuff )
	{
		final String S_ProcName = "createInt64Col";
		
		CFBamBuffInt64Col Buff = (CFBamBuffInt64Col)(schema.getTableInt64Def().createInt64Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt64Col.CLASS_CODE ) {
		...
		CFBamBuffInt64ColByTableIdxKey keyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt64Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt64Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt64Col.CLASS_CODE) {
	...
	public ICFBamInt64Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Col.lockDerived";
		ICFBamInt64Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt64Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt64Col[] retList = new ICFBamInt64Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt64Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt64Col ) {
			return( (ICFBamInt64Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt64Col ) ) {
					filteredList.add( (ICFBamInt64Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt64Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffInt64ColByTableIdxKey key = (CFBamBuffInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamInt64Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt64Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamInt64Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffInt64Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt64Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt64Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamInt64Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt64Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Col.readRec";
		ICFBamInt64Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt64Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt64Col.readAllRec";
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt64Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt64Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt64Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt64Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt64Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamInt64Col.readRecByTableIdx() ";
		ICFBamInt64Col buff;
		ArrayList<ICFBamInt64Col> filteredList = new ArrayList<ICFBamInt64Col>();
		ICFBamInt64Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt64Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt64Col)editCur );
	}
	...
	public ICFBamInt64Col updateInt64Col( ICFSecAuthorization Authorization,
		ICFBamInt64Col iBuff )
	{
		CFBamBuffInt64Col Buff = (CFBamBuffInt64Col)(schema.getTableInt64Def().updateInt64Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt64Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt64ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt64ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt64Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt64Col >();
		...
		ICFBamInt64Col iBuff )
	{
		...
		CFBamBuffInt64Col Buff = (CFBamBuffInt64Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt64Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffInt64Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffInt64Col> matchSet = new LinkedList<CFBamBuffInt64Col>();
		Iterator<CFBamBuffInt64Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt64Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt64Col)(schema.getTableInt64Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
