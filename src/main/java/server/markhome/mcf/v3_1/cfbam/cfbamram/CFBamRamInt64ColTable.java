	...
	implements ICFBamInt64ColTable
{
		...
		ICFBamInt64Col iBuff )
	{
		...
		CFBamBuffInt64ColByTableIdxKey keyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getFactoryInt64Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt64ColByTableIdxKey key = (CFBamBuffInt64ColByTableIdxKey)schema.getFactoryInt64Col().newByTableIdxKey();
		...
		ICFBamInt64Col iBuff )
	{
		...
		CFBamBuffInt64ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getFactoryInt64Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt64ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt64ColByTableIdxKey)schema.getFactoryInt64Col().newByTableIdxKey();
