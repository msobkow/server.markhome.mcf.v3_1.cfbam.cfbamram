	...
	implements ICFBamInt64ColTable
{
		...
		ICFBamInt64Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt64Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt64Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Col >();
		...
		ICFBamInt64Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt64Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Col >();
