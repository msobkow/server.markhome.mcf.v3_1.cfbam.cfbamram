	...
	implements ICFBamClearSubDep2Table
{
		...
		ICFBamClearSubDep2 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearSubDep2 > subdictClearSubDep1Idx;
		if( dictByClearSubDep1Idx.containsKey( keyClearSubDep1Idx ) ) {
			...
			subdictClearSubDep1Idx = new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep2 >();
		...
		ICFLibKeyHash256 ClearSubDep1Id )
	{
		...
		if( dictByClearSubDep1Idx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffClearSubDep2 > subdictClearSubDep1Idx
				= new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep2 >();
		...
		ICFBamClearSubDep2 iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffClearSubDep2 > subdict;
		...
		if( dictByClearSubDep1Idx.containsKey( newKeyClearSubDep1Idx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffClearSubDep2 >();
