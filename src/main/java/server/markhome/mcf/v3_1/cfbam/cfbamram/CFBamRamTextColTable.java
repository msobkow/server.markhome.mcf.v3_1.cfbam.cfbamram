	...
	implements ICFBamTextColTable
{
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextColByTableIdxKey keyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getFactoryTextCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTextColByTableIdxKey key = (CFBamBuffTextColByTableIdxKey)schema.getFactoryTextCol().newByTableIdxKey();
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextColByTableIdxKey existingKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getFactoryTextCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTextColByTableIdxKey newKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getFactoryTextCol().newByTableIdxKey();
