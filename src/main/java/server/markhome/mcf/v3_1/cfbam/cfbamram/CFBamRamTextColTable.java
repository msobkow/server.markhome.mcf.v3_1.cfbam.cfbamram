...
// Description: Java 25 in-memory RAM DbIO implementation for TextCol.
	...
	implements ICFBamTextColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTextCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTextCol >();
	private Map< CFBamBuffTextColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTextCol >> dictByTableIdx
		= new HashMap< CFBamBuffTextColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTextCol >>();
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextCol Buff = (CFBamBuffTextCol)(schema.getTableTextDef().createTextDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTextCol.CLASS_CODE ) {
		...
		CFBamBuffTextColByTableIdxKey keyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTextCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTextCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTextCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTextCol.CLASS_CODE) {
	...
	public ICFBamTextCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTextCol.lockDerived";
		ICFBamTextCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTextCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTextCol[] retList = new ICFBamTextCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTextCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTextCol ) {
			return( (ICFBamTextCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTextCol ) ) {
					filteredList.add( (ICFBamTextCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTextCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTextColByTableIdxKey key = (CFBamBuffTextColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTextCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamTextCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTextCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamTextCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffTextCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTextCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTextCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamTextCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamTextCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTextCol.readRec";
		ICFBamTextCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTextCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTextCol.readAllRec";
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTextCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTextCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTextCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTextCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTextCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamTextCol.readRecByTableIdx() ";
		ICFBamTextCol buff;
		ArrayList<ICFBamTextCol> filteredList = new ArrayList<ICFBamTextCol>();
		ICFBamTextCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTextCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffTextCol)editCur );
	}
	...
	public ICFBamTextCol updateTextCol( ICFSecAuthorization Authorization,
		ICFBamTextCol iBuff )
	{
		CFBamBuffTextCol Buff = (CFBamBuffTextCol)(schema.getTableTextDef().updateTextDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTextCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTextColByTableIdxKey existingKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTextCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTextColByTableIdxKey newKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTextCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTextCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTextCol >();
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextCol Buff = (CFBamBuffTextCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTextCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTextCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTextCol> matchSet = new LinkedList<CFBamBuffTextCol>();
		Iterator<CFBamBuffTextCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTextCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTextCol)(schema.getTableTextCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
