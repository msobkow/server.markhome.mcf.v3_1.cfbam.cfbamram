	...
	implements ICFBamTextColTable
{
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextColByTableIdxKey keyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamFactory().getFactoryTextCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTextColByTableIdxKey key = (CFBamBuffTextColByTableIdxKey)schema.getCFBamFactory().getFactoryTextCol().newByTableIdxKey();
		...
		ICFBamTextCol iBuff )
	{
		...
		CFBamBuffTextColByTableIdxKey existingKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamFactory().getFactoryTextCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTextColByTableIdxKey newKeyTableIdx = (CFBamBuffTextColByTableIdxKey)schema.getCFBamFactory().getFactoryTextCol().newByTableIdxKey();
