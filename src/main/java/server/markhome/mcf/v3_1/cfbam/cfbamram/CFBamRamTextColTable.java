	...
	implements ICFBamTextColTable
{
		...
		ICFBamTextCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTextCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTextCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTextCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTextCol >();
		...
		ICFBamTextCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTextCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTextCol >();
