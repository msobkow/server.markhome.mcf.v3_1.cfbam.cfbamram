...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash384Gen.
	...
	implements ICFBamDbKeyHash384GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Gen > dictByPKey
	...
	public ICFBamDbKeyHash384Gen createDbKeyHash384Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Gen iBuff )
	{
		final String S_ProcName = "createDbKeyHash384Gen";
		
		CFBamBuffDbKeyHash384Gen Buff = (CFBamBuffDbKeyHash384Gen)(schema.getTableDbKeyHash384Type().createDbKeyHash384Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash384Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash384Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash384Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.lockDerived";
		ICFBamDbKeyHash384Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash384Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash384Gen[] retList = new ICFBamDbKeyHash384Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash384Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash384Gen ) {
			return( (ICFBamDbKeyHash384Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash384Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash384Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash384Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash384Type buffList[] = schema.getTableDbKeyHash384Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash384Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readRec";
		ICFBamDbKeyHash384Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash384Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readAllRec";
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash384Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash384Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash384Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash384Gen buff;
		ArrayList<ICFBamDbKeyHash384Gen> filteredList = new ArrayList<ICFBamDbKeyHash384Gen>();
		ICFBamDbKeyHash384Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash384Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash384Gen)editCur );
	}
	...
	public ICFBamDbKeyHash384Gen updateDbKeyHash384Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Gen iBuff )
	{
		CFBamBuffDbKeyHash384Gen Buff = (CFBamBuffDbKeyHash384Gen)(schema.getTableDbKeyHash384Type().updateDbKeyHash384Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash384Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Gen > subdict;
		...
		ICFBamDbKeyHash384Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash384Gen Buff = (CFBamBuffDbKeyHash384Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash384Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash384Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash384Gen> matchSet = new LinkedList<CFBamBuffDbKeyHash384Gen>();
		Iterator<CFBamBuffDbKeyHash384Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash384Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash384Gen)(schema.getTableDbKeyHash384Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
