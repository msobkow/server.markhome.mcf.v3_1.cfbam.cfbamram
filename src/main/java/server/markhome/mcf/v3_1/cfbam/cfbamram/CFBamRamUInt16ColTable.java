	...
	implements ICFBamUInt16ColTable
{
		...
		ICFBamUInt16Col iBuff )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey keyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getFactoryUInt16Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey key = (CFBamBuffUInt16ColByTableIdxKey)schema.getFactoryUInt16Col().newByTableIdxKey();
		...
		ICFBamUInt16Col iBuff )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getFactoryUInt16Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt16ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getFactoryUInt16Col().newByTableIdxKey();
