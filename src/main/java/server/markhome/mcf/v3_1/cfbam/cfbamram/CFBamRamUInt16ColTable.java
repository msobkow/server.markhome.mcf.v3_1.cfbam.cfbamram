...
// Description: Java 25 in-memory RAM DbIO implementation for UInt16Col.
	...
	implements ICFBamUInt16ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt16Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt16Col >();
	private Map< CFBamBuffUInt16ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt16Col >> dictByTableIdx
		= new HashMap< CFBamBuffUInt16ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt16Col >>();
	...
	public ICFBamUInt16Col createUInt16Col( ICFSecAuthorization Authorization,
		ICFBamUInt16Col iBuff )
	{
		final String S_ProcName = "createUInt16Col";
		
		CFBamBuffUInt16Col Buff = (CFBamBuffUInt16Col)(schema.getTableUInt16Def().createUInt16Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUInt16Col.CLASS_CODE ) {
		...
		CFBamBuffUInt16ColByTableIdxKey keyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt16Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt16Col.CLASS_CODE) {
	...
	public ICFBamUInt16Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Col.lockDerived";
		ICFBamUInt16Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt16Col[] retList = new ICFBamUInt16Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt16Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt16Col ) {
			return( (ICFBamUInt16Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt16Col ) ) {
					filteredList.add( (ICFBamUInt16Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt16Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey key = (CFBamBuffUInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamUInt16Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUInt16Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamUInt16Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffUInt16Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt16Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamUInt16Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt16Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt16Col.readRec";
		ICFBamUInt16Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt16Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt16Col.readAllRec";
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt16Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt16Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt16Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt16Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt16Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamUInt16Col.readRecByTableIdx() ";
		ICFBamUInt16Col buff;
		ArrayList<ICFBamUInt16Col> filteredList = new ArrayList<ICFBamUInt16Col>();
		ICFBamUInt16Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt16Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt16Col)editCur );
	}
	...
	public ICFBamUInt16Col updateUInt16Col( ICFSecAuthorization Authorization,
		ICFBamUInt16Col iBuff )
	{
		CFBamBuffUInt16Col Buff = (CFBamBuffUInt16Col)(schema.getTableUInt16Def().updateUInt16Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt16ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt16ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt16Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt16Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt16Col >();
		...
		ICFBamUInt16Col iBuff )
	{
		...
		CFBamBuffUInt16Col Buff = (CFBamBuffUInt16Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUInt16Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUInt16Col> matchSet = new LinkedList<CFBamBuffUInt16Col>();
		Iterator<CFBamBuffUInt16Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt16Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt16Col)(schema.getTableUInt16Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
