	...
	implements ICFBamUInt16ColTable
{
		...
		ICFBamUInt16Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt16Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUInt16Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Col >();
		...
		ICFBamUInt16Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt16Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt16Col >();
