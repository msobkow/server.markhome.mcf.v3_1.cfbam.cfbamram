	...
	implements ICFBamTZDateColTable
{
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateCol Buff = (CFBamBuffTZDateCol)(schema.getTableTZDateDef().createTZDateDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTZDateCol.CLASS_CODE ) {
		...
		CFBamBuffTZDateColByTableIdxKey keyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZDateCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTZDateCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZDateCol.CLASS_CODE) {
	...
	public ICFBamTZDateCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateCol.lockDerived";
		ICFBamTZDateCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZDateCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffTZDateCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTZDateColByTableIdxKey key = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateCol().newByTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< CFBamBuffTZDateCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTZDateCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTZDateCol >();
	...
	public ICFBamTZDateCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateCol.readRec";
		ICFBamTZDateCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZDateCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTZDateCol.readAllRec";
		ICFBamTZDateCol buff;
		ArrayList<ICFBamTZDateCol> filteredList = new ArrayList<ICFBamTZDateCol>();
	...
	public ICFBamTZDateCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamTZDateCol.readRecByTableIdx() ";
		ICFBamTZDateCol buff;
		ArrayList<ICFBamTZDateCol> filteredList = new ArrayList<ICFBamTZDateCol>();
		...
		int revision )
	{
		...
		return( (CFBamBuffTZDateCol)editCur );
	}
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZDateColByTableIdxKey newKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZDateCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTZDateCol >();
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateCol Buff = (CFBamBuffTZDateCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZDateCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTZDateCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTZDateCol> matchSet = new LinkedList<CFBamBuffTZDateCol>();
		Iterator<CFBamBuffTZDateCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZDateCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZDateCol)(schema.getTableTZDateCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
