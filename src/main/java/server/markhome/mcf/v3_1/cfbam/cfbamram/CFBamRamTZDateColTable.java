	...
	implements ICFBamTZDateColTable
{
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateColByTableIdxKey keyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamFactory().getFactoryTZDateCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZDateColByTableIdxKey key = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamFactory().getFactoryTZDateCol().newByTableIdxKey();
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamFactory().getFactoryTZDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZDateColByTableIdxKey newKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getCFBamFactory().getFactoryTZDateCol().newByTableIdxKey();
