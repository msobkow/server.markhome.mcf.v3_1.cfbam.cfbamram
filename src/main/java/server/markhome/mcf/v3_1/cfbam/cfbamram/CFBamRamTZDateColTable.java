	...
	implements ICFBamTZDateColTable
{
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateColByTableIdxKey keyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getFactoryTZDateCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZDateColByTableIdxKey key = (CFBamBuffTZDateColByTableIdxKey)schema.getFactoryTZDateCol().newByTableIdxKey();
		...
		ICFBamTZDateCol iBuff )
	{
		...
		CFBamBuffTZDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getFactoryTZDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZDateColByTableIdxKey newKeyTableIdx = (CFBamBuffTZDateColByTableIdxKey)schema.getFactoryTZDateCol().newByTableIdxKey();
