...
// Description: Java 25 in-memory RAM DbIO implementation for Int32Def.
	...
	implements ICFBamInt32DefTable
{
		...
		ICFBamInt32Def iBuff )
	{
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt32Def.CLASS_CODE) {
	...
	public ICFBamInt32Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Def.lockDerived";
		ICFBamInt32Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt32Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt32Def[] retList = new ICFBamInt32Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt32Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt32Def ) {
			return( (ICFBamInt32Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt32Def ) ) {
					filteredList.add( (ICFBamInt32Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt32Def[0] ) );
		}
	}
	...
	public ICFBamInt32Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Def.readRec";
		ICFBamInt32Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt32Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt32Def.readAllRec";
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt32Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt32Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt32Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt32Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Def buff;
		ArrayList<ICFBamInt32Def> filteredList = new ArrayList<ICFBamInt32Def>();
		ICFBamInt32Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffInt32Def)editCur );
	}
		...
		ICFBamInt32Def iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffInt32Def > subdict;
		...
		ICFBamInt32Def iBuff )
	{
		...
		CFBamBuffInt32Def Buff = (CFBamBuffInt32Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt32Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffInt32Def cur;
		LinkedList<CFBamBuffInt32Def> matchSet = new LinkedList<CFBamBuffInt32Def>();
		Iterator<CFBamBuffInt32Def> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt32Def> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt32Def)(schema.getTableInt32Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamInt32Def.CLASS_CODE == subClassCode ) {
