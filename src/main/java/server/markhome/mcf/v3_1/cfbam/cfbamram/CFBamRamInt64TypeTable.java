	...
	implements ICFBamInt64TypeTable
{
		...
		ICFBamInt64Type iBuff )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getFactoryInt64Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey key = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getFactoryInt64Type().newBySchemaIdxKey();
		...
		ICFBamInt64Type iBuff )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getFactoryInt64Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt64TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getFactoryInt64Type().newBySchemaIdxKey();
