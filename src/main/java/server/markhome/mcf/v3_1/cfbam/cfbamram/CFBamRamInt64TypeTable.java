...
// Description: Java 25 in-memory RAM DbIO implementation for Int64Type.
	...
	implements ICFBamInt64TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt64Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt64Type >();
	private Map< CFBamBuffInt64TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt64Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffInt64TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt64Type >>();
		...
		ICFBamInt64Type iBuff )
	{
		...
		CFBamBuffInt64Type Buff = (CFBamBuffInt64Type)(schema.getTableInt64Def().createInt64Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt64Type.CLASS_CODE ) {
		...
		CFBamBuffInt64TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt64Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt64Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt64Type.CLASS_CODE) {
	...
	public ICFBamInt64Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Type.lockDerived";
		ICFBamInt64Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt64Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt64Type[] retList = new ICFBamInt64Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt64Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt64Type ) {
			return( (ICFBamInt64Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt64Type ) ) {
					filteredList.add( (ICFBamInt64Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt64Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey key = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamInt64Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt64Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamInt64Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffInt64Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt64Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt64Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamInt64Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt64Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt64Type.readRec";
		ICFBamInt64Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt64Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt64Type.readAllRec";
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt64Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt64Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt64Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt64Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt64Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamInt64Type.readRecBySchemaIdx() ";
		ICFBamInt64Type buff;
		ArrayList<ICFBamInt64Type> filteredList = new ArrayList<ICFBamInt64Type>();
		ICFBamInt64Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt64Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt64Type)editCur );
	}
		...
		ICFBamInt64Type iBuff )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt64TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt64Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt64Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt64Type >();
		...
		ICFBamInt64Type iBuff )
	{
		...
		CFBamBuffInt64Type Buff = (CFBamBuffInt64Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt64Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamInt64TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffInt64Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffInt64Type> matchSet = new LinkedList<CFBamBuffInt64Type>();
		Iterator<CFBamBuffInt64Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt64Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt64Type)(schema.getTableInt64Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamInt64Type.CLASS_CODE == subClassCode ) {
