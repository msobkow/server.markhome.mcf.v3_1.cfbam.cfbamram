	...
	implements ICFBamInt64TypeTable
{
		...
		ICFBamInt64Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt64Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt64Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Type >();
		...
		ICFBamInt64Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt64Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt64Type >();
