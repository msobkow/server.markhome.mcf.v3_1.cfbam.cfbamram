	...
	implements ICFBamRoleDefTable
{
		...
		ICFBamRoleDef iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffRoleDef > subdictScopeIdx;
		if( dictByScopeIdx.containsKey( keyScopeIdx ) ) {
			subdictScopeIdx = dictByScopeIdx.get( keyScopeIdx );
		}
		else {
			subdictScopeIdx = new HashMap< ICFLibKeyHash256, CFBamBuffRoleDef >();
			dictByScopeIdx.put( keyScopeIdx, subdictScopeIdx );
		}
		subdictScopeIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFBamBuffRoleDef > subdictDefSchemaIdx;
		if( dictByDefSchemaIdx.containsKey( keyDefSchemaIdx ) ) {
			subdictDefSchemaIdx = dictByDefSchemaIdx.get( keyDefSchemaIdx );
		}
		else {
			subdictDefSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffRoleDef >();
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( dictByScopeIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffRoleDef > subdictScopeIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffRoleDef >();
		...
		ICFBamRoleDef iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffRoleDef > subdict;
		...
		if( dictByScopeIdx.containsKey( newKeyScopeIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffRoleDef >();
