...
// Description: Java 25 in-memory RAM DbIO implementation for UInt64Col.
	...
	implements ICFBamUInt64ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt64Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt64Col >();
	private Map< CFBamBuffUInt64ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt64Col >> dictByTableIdx
		= new HashMap< CFBamBuffUInt64ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt64Col >>();
	...
	public ICFBamUInt64Col createUInt64Col( ICFSecAuthorization Authorization,
		ICFBamUInt64Col iBuff )
	{
		final String S_ProcName = "createUInt64Col";
		
		CFBamBuffUInt64Col Buff = (CFBamBuffUInt64Col)(schema.getTableUInt64Def().createUInt64Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUInt64Col.CLASS_CODE ) {
		...
		CFBamBuffUInt64ColByTableIdxKey keyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt64Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt64Col.CLASS_CODE) {
	...
	public ICFBamUInt64Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Col.lockDerived";
		ICFBamUInt64Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt64Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt64Col[] retList = new ICFBamUInt64Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt64Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt64Col ) {
			return( (ICFBamUInt64Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt64Col ) ) {
					filteredList.add( (ICFBamUInt64Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt64Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffUInt64ColByTableIdxKey key = (CFBamBuffUInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamUInt64Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUInt64Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamUInt64Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffUInt64Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt64Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamUInt64Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt64Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Col.readRec";
		ICFBamUInt64Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt64Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt64Col.readAllRec";
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt64Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt64Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt64Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt64Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt64Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamUInt64Col.readRecByTableIdx() ";
		ICFBamUInt64Col buff;
		ArrayList<ICFBamUInt64Col> filteredList = new ArrayList<ICFBamUInt64Col>();
		ICFBamUInt64Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt64Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt64Col)editCur );
	}
	...
	public ICFBamUInt64Col updateUInt64Col( ICFSecAuthorization Authorization,
		ICFBamUInt64Col iBuff )
	{
		CFBamBuffUInt64Col Buff = (CFBamBuffUInt64Col)(schema.getTableUInt64Def().updateUInt64Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt64Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt64ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt64ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt64Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Col >();
		...
		ICFBamUInt64Col iBuff )
	{
		...
		CFBamBuffUInt64Col Buff = (CFBamBuffUInt64Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt64Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUInt64Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUInt64Col> matchSet = new LinkedList<CFBamBuffUInt64Col>();
		Iterator<CFBamBuffUInt64Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt64Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt64Col)(schema.getTableUInt64Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
