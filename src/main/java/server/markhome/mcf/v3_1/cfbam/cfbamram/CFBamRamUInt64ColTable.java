	...
	implements ICFBamUInt64ColTable
{
		...
		ICFBamUInt64Col iBuff )
	{
		...
		CFBamBuffUInt64ColByTableIdxKey keyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getFactoryUInt64Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUInt64ColByTableIdxKey key = (CFBamBuffUInt64ColByTableIdxKey)schema.getFactoryUInt64Col().newByTableIdxKey();
		...
		ICFBamUInt64Col iBuff )
	{
		...
		CFBamBuffUInt64ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getFactoryUInt64Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt64ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt64ColByTableIdxKey)schema.getFactoryUInt64Col().newByTableIdxKey();
