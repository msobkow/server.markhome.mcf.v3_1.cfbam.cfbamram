	...
	implements ICFBamUInt64ColTable
{
		...
		ICFBamUInt64Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt64Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUInt64Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Col >();
		...
		ICFBamUInt64Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt64Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Col >();
