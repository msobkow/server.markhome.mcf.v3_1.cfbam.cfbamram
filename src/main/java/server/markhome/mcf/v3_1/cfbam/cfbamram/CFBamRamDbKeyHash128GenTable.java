...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash128Gen.
	...
	implements ICFBamDbKeyHash128GenTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash128Gen > dictByPKey
		...
		ICFBamDbKeyHash128Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash128Gen Buff = (CFBamBuffDbKeyHash128Gen)(schema.getTableDbKeyHash128Type().createDbKeyHash128Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash128Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash128Gen.CLASS_CODE) {
	...
	public ICFBamDbKeyHash128Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.lockDerived";
		ICFBamDbKeyHash128Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash128Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash128Gen[] retList = new ICFBamDbKeyHash128Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash128Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash128Gen ) {
			return( (ICFBamDbKeyHash128Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash128Gen ) ) {
					filteredList.add( (ICFBamDbKeyHash128Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash128Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash128Type buffList[] = schema.getTableDbKeyHash128Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamDbKeyHash128Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readRec";
		ICFBamDbKeyHash128Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash128Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readAllRec";
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash128Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash128Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash128Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash128Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamDbKeyHash128Gen buff;
		ArrayList<ICFBamDbKeyHash128Gen> filteredList = new ArrayList<ICFBamDbKeyHash128Gen>();
		ICFBamDbKeyHash128Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash128Gen)cur );
		}
		...
		return( (CFBamBuffDbKeyHash128Gen)editCur );
	}
		...
		ICFBamDbKeyHash128Gen iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Gen > subdict;
		...
		ICFBamDbKeyHash128Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash128Gen Buff = (CFBamBuffDbKeyHash128Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash128Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
