	...
	implements ICFBamTZTimeColTable
{
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey keyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey key = (CFBamBuffTZTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimeColByTableIdxKey newKeyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
