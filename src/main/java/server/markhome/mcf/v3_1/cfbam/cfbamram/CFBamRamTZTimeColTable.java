	...
	implements ICFBamTZTimeColTable
{
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			...
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTZTimeCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeCol >();
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimeCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimeCol >();
