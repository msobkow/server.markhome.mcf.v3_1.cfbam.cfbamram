	...
	implements ICFBamTZTimeColTable
{
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey keyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getFactoryTZTimeCol().newByTableIdxKey();
		...
		ICFBamTZTimeCol iBuff )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getFactoryTZTimeCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimeColByTableIdxKey newKeyTableIdx = (CFBamBuffTZTimeColByTableIdxKey)schema.getFactoryTZTimeCol().newByTableIdxKey();
