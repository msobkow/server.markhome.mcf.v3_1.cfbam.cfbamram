	...
	implements ICFBamBlobTypeTable
{
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getFactoryBlobType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey key = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getFactoryBlobType().newBySchemaIdxKey();
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getFactoryBlobType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBlobTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getFactoryBlobType().newBySchemaIdxKey();
