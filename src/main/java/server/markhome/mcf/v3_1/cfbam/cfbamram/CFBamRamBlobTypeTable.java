...
// Description: Java 25 in-memory RAM DbIO implementation for BlobType.
	...
	implements ICFBamBlobTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffBlobType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffBlobType >();
	private Map< CFBamBuffBlobTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBlobType >> dictBySchemaIdx
		= new HashMap< CFBamBuffBlobTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBlobType >>();
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobType Buff = (CFBamBuffBlobType)(schema.getTableBlobDef().createBlobDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamBlobType.CLASS_CODE ) {
		...
		CFBamBuffBlobTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBlobType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBlobType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffBlobType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBlobType.CLASS_CODE) {
	...
	public ICFBamBlobType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobType.lockDerived";
		ICFBamBlobType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamBlobType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffBlobType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBlobType ) {
			return( (ICFBamBlobType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBlobType ) ) {
					filteredList.add( (ICFBamBlobType)buff );
				}
			}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey key = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBlobType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamBlobType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffBlobType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamBlobType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffBlobType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffBlobType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffBlobType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamBlobType[0];
		}
		return( recArray );
	}
	...
	public ICFBamBlobType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobType.readRec";
		ICFBamBlobType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBlobType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public ICFBamBlobType[] readAllRec( ICFSecAuthorization Authorization )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBlobType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBlobType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBlobType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBlobType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamBlobType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamBlobType.readRecBySchemaIdx() ";
		ICFBamBlobType buff;
		ArrayList<ICFBamBlobType> filteredList = new ArrayList<ICFBamBlobType>();
		ICFBamBlobType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBlobType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffBlobType)editCur );
	}
	...
	public ICFBamBlobType updateBlobType( ICFSecAuthorization Authorization,
		ICFBamBlobType iBuff )
	{
		CFBamBuffBlobType Buff = (CFBamBuffBlobType)(schema.getTableBlobDef().updateBlobDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffBlobType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBlobTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBlobType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBlobTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBlobType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBlobType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffBlobType >();
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobType Buff = (CFBamBuffBlobType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBlobType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffBlobType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffBlobType> matchSet = new LinkedList<CFBamBuffBlobType>();
		Iterator<CFBamBuffBlobType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffBlobType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffBlobType)(schema.getTableBlobType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
