	...
	implements ICFBamBlobTypeTable
{
		...
		ICFBamBlobType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBlobType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffBlobType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffBlobType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffBlobType >();
		...
		ICFBamBlobType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBlobType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffBlobType >();
