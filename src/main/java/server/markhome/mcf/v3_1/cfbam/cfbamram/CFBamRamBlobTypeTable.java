	...
	implements ICFBamBlobTypeTable
{
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBlobType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey key = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBlobType().newBySchemaIdxKey();
		...
		ICFBamBlobType iBuff )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBlobType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBlobTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBlobTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBlobType().newBySchemaIdxKey();
