...
// Description: Java 25 in-memory RAM DbIO implementation for NumberDef.
	...
	implements ICFBamNumberDefTable
{
	...
	public ICFBamNumberDef createNumberDef( ICFSecAuthorization Authorization,
		ICFBamNumberDef iBuff )
	{
		final String S_ProcName = "createNumberDef";
		
		CFBamBuffNumberDef Buff = (CFBamBuffNumberDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNumberDef.CLASS_CODE) {
	...
	public ICFBamNumberDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberDef.lockDerived";
		ICFBamNumberDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNumberDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNumberDef[] retList = new ICFBamNumberDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNumberDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNumberDef ) {
			return( (ICFBamNumberDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNumberDef ) ) {
					filteredList.add( (ICFBamNumberDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNumberDef[0] ) );
		}
	}
	...
	public ICFBamNumberDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberDef.readRec";
		ICFBamNumberDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNumberDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNumberDef.readAllRec";
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNumberDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNumberDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNumberDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNumberDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberDef buff;
		ArrayList<ICFBamNumberDef> filteredList = new ArrayList<ICFBamNumberDef>();
		ICFBamNumberDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffNumberDef)editCur );
	}
	...
	public ICFBamNumberDef updateNumberDef( ICFSecAuthorization Authorization,
		ICFBamNumberDef iBuff )
	{
		CFBamBuffNumberDef Buff = (CFBamBuffNumberDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNumberDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffNumberDef > subdict;
		...
		ICFBamNumberDef iBuff )
	{
		...
		CFBamBuffNumberDef Buff = (CFBamBuffNumberDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNumberDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffNumberDef cur;
		LinkedList<CFBamBuffNumberDef> matchSet = new LinkedList<CFBamBuffNumberDef>();
		Iterator<CFBamBuffNumberDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNumberDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNumberDef)(schema.getTableNumberDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamNumberDef.CLASS_CODE == subClassCode ) {
