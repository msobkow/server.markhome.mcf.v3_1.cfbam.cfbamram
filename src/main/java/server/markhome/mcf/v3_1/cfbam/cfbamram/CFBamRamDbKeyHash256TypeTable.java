...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash256Type.
	...
	implements ICFBamDbKeyHash256TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash256Type >();
	private Map< CFBamBuffDbKeyHash256TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash256Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffDbKeyHash256TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash256Type >>();
	...
	public ICFBamDbKeyHash256Type createDbKeyHash256Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Type iBuff )
	{
		final String S_ProcName = "createDbKeyHash256Type";
		
		CFBamBuffDbKeyHash256Type Buff = (CFBamBuffDbKeyHash256Type)(schema.getTableDbKeyHash256Def().createDbKeyHash256Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash256Type.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash256Type.CLASS_CODE) {
	...
	public ICFBamDbKeyHash256Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.lockDerived";
		ICFBamDbKeyHash256Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash256Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash256Type[] retList = new ICFBamDbKeyHash256Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash256Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash256Type ) {
			return( (ICFBamDbKeyHash256Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash256Type ) ) {
					filteredList.add( (ICFBamDbKeyHash256Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash256Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDbKeyHash256Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDbKeyHash256Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDbKeyHash256Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDbKeyHash256Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash256Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readRec";
		ICFBamDbKeyHash256Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash256Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readAllRec";
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash256Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash256Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash256Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash256Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readRecBySchemaIdx() ";
		ICFBamDbKeyHash256Type buff;
		ArrayList<ICFBamDbKeyHash256Type> filteredList = new ArrayList<ICFBamDbKeyHash256Type>();
		ICFBamDbKeyHash256Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash256Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash256Type)cur );
		}
		...
		return( (CFBamBuffDbKeyHash256Type)editCur );
	}
	...
	public ICFBamDbKeyHash256Type updateDbKeyHash256Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Type iBuff )
	{
		CFBamBuffDbKeyHash256Type Buff = (CFBamBuffDbKeyHash256Type)(schema.getTableDbKeyHash256Def().updateDbKeyHash256Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash256Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash256TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash256Type >();
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		CFBamBuffDbKeyHash256Type Buff = (CFBamBuffDbKeyHash256Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash256Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamDbKeyHash256TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffDbKeyHash256Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash256Type> matchSet = new LinkedList<CFBamBuffDbKeyHash256Type>();
		Iterator<CFBamBuffDbKeyHash256Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash256Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash256Type)(schema.getTableDbKeyHash256Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash256Type.CLASS_CODE == subClassCode ) {
