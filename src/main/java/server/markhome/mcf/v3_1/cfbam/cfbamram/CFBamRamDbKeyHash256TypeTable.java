	...
	implements ICFBamDbKeyHash256TypeTable
{
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getFactoryDbKeyHash256Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash256TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash256TypeBySchemaIdxKey)schema.getFactoryDbKeyHash256Type().newBySchemaIdxKey();
