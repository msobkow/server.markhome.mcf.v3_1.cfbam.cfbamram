	...
	implements ICFBamDbKeyHash256TypeTable
{
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type >();
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash256Type >();
