	...
	implements ICFBamDbKeyHash384TypeTable
{
		...
		ICFBamDbKeyHash384Type iBuff )
	{
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		...
		ICFBamDbKeyHash384Type iBuff )
	{
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash384TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getFactoryDbKeyHash384Type().newBySchemaIdxKey();
