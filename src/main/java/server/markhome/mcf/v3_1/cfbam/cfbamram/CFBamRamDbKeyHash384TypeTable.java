	...
	implements ICFBamDbKeyHash384TypeTable
{
		...
		ICFBamDbKeyHash384Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type >();
		...
		ICFBamDbKeyHash384Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash384Type >();
