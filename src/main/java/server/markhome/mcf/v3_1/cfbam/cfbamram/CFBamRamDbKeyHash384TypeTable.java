...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash384Type.
	...
	implements ICFBamDbKeyHash384TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash384Type >();
	private Map< CFBamBuffDbKeyHash384TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash384Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffDbKeyHash384TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash384Type >>();
	...
	public ICFBamDbKeyHash384Type createDbKeyHash384Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Type iBuff )
	{
		final String S_ProcName = "createDbKeyHash384Type";
		
		CFBamBuffDbKeyHash384Type Buff = (CFBamBuffDbKeyHash384Type)(schema.getTableDbKeyHash384Def().createDbKeyHash384Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash384Type.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash384Type.CLASS_CODE) {
	...
	public ICFBamDbKeyHash384Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Type.lockDerived";
		ICFBamDbKeyHash384Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash384Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash384Type[] retList = new ICFBamDbKeyHash384Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash384Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash384Type ) {
			return( (ICFBamDbKeyHash384Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash384Type ) ) {
					filteredList.add( (ICFBamDbKeyHash384Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash384Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey key = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDbKeyHash384Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDbKeyHash384Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDbKeyHash384Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDbKeyHash384Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash384Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Type.readRec";
		ICFBamDbKeyHash384Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash384Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Type.readAllRec";
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash384Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash384Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash384Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash384Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Type.readRecBySchemaIdx() ";
		ICFBamDbKeyHash384Type buff;
		ArrayList<ICFBamDbKeyHash384Type> filteredList = new ArrayList<ICFBamDbKeyHash384Type>();
		ICFBamDbKeyHash384Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash384Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash384Type)cur );
		}
		...
		return( (CFBamBuffDbKeyHash384Type)editCur );
	}
	...
	public ICFBamDbKeyHash384Type updateDbKeyHash384Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Type iBuff )
	{
		CFBamBuffDbKeyHash384Type Buff = (CFBamBuffDbKeyHash384Type)(schema.getTableDbKeyHash384Def().updateDbKeyHash384Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash384Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash384TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash384TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDbKeyHash384TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash384Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash384Type >();
		...
		ICFBamDbKeyHash384Type iBuff )
	{
		...
		CFBamBuffDbKeyHash384Type Buff = (CFBamBuffDbKeyHash384Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash384Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamDbKeyHash384TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffDbKeyHash384Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash384Type> matchSet = new LinkedList<CFBamBuffDbKeyHash384Type>();
		Iterator<CFBamBuffDbKeyHash384Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash384Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash384Type)(schema.getTableDbKeyHash384Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamDbKeyHash384Type.CLASS_CODE == subClassCode ) {
