...
// Description: Java 25 in-memory RAM DbIO implementation for StringDef.
	...
	implements ICFBamStringDefTable
{
	...
	public ICFBamStringDef createStringDef( ICFSecAuthorization Authorization,
		ICFBamStringDef iBuff )
	{
		final String S_ProcName = "createStringDef";
		
		CFBamBuffStringDef Buff = (CFBamBuffStringDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamStringDef.CLASS_CODE) {
	...
	public ICFBamStringDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamStringDef.lockDerived";
		ICFBamStringDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamStringDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamStringDef[] retList = new ICFBamStringDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffStringDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamStringDef ) {
			return( (ICFBamStringDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamStringDef ) ) {
					filteredList.add( (ICFBamStringDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamStringDef[0] ) );
		}
	}
	...
	public ICFBamStringDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamStringDef.readRec";
		ICFBamStringDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamStringDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamStringDef.readAllRec";
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamStringDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamStringDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamStringDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamStringDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringDef buff;
		ArrayList<ICFBamStringDef> filteredList = new ArrayList<ICFBamStringDef>();
		ICFBamStringDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffStringDef)editCur );
	}
	...
	public ICFBamStringDef updateStringDef( ICFSecAuthorization Authorization,
		ICFBamStringDef iBuff )
	{
		CFBamBuffStringDef Buff = (CFBamBuffStringDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffStringDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffStringDef > subdict;
		...
		ICFBamStringDef iBuff )
	{
		...
		CFBamBuffStringDef Buff = (CFBamBuffStringDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffStringDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		CFBamBuffStringDef cur;
		LinkedList<CFBamBuffStringDef> matchSet = new LinkedList<CFBamBuffStringDef>();
		Iterator<CFBamBuffStringDef> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffStringDef> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffStringDef)(schema.getTableStringDef().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamStringDef.CLASS_CODE == subClassCode ) {
