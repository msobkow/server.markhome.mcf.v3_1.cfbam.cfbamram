...
// Description: Java 25 in-memory RAM DbIO implementation for Int16Col.
	...
	implements ICFBamInt16ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt16Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt16Col >();
	private Map< CFBamBuffInt16ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt16Col >> dictByTableIdx
		= new HashMap< CFBamBuffInt16ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt16Col >>();
		...
		ICFBamInt16Col iBuff )
	{
		...
		CFBamBuffInt16Col Buff = (CFBamBuffInt16Col)(schema.getTableInt16Def().createInt16Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt16Col.CLASS_CODE ) {
		...
		CFBamBuffInt16ColByTableIdxKey keyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt16Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt16Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt16Col.CLASS_CODE) {
	...
	public ICFBamInt16Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Col.lockDerived";
		ICFBamInt16Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffInt16Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt16Col ) {
			return( (ICFBamInt16Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt16Col ) ) {
					filteredList.add( (ICFBamInt16Col)buff );
				}
			}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffInt16ColByTableIdxKey key = (CFBamBuffInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamInt16Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt16Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamInt16Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffInt16Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt16Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt16Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamInt16Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt16Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Col.readRec";
		ICFBamInt16Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt16Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public ICFBamInt16Col[] readAllRec( ICFSecAuthorization Authorization )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt16Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt16Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt16Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt16Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt16Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamInt16Col.readRecByTableIdx() ";
		ICFBamInt16Col buff;
		ArrayList<ICFBamInt16Col> filteredList = new ArrayList<ICFBamInt16Col>();
		ICFBamInt16Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt16Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt16Col)editCur );
	}
	...
	public ICFBamInt16Col updateInt16Col( ICFSecAuthorization Authorization,
		ICFBamInt16Col iBuff )
	{
		CFBamBuffInt16Col Buff = (CFBamBuffInt16Col)(schema.getTableInt16Def().updateInt16Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt16ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt16ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt16Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt16Col >();
		...
		ICFBamInt16Col iBuff )
	{
		...
		CFBamBuffInt16Col Buff = (CFBamBuffInt16Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffInt16Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffInt16Col> matchSet = new LinkedList<CFBamBuffInt16Col>();
		Iterator<CFBamBuffInt16Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt16Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt16Col)(schema.getTableInt16Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
