	...
	implements ICFBamInt16ColTable
{
		...
		ICFBamInt16Col iBuff )
	{
		...
		CFBamBuffInt16ColByTableIdxKey keyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getFactoryInt16Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt16ColByTableIdxKey key = (CFBamBuffInt16ColByTableIdxKey)schema.getFactoryInt16Col().newByTableIdxKey();
		...
		ICFBamInt16Col iBuff )
	{
		...
		CFBamBuffInt16ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getFactoryInt16Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt16ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt16ColByTableIdxKey)schema.getFactoryInt16Col().newByTableIdxKey();
