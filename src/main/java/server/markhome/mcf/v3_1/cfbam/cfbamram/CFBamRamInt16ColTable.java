	...
	implements ICFBamInt16ColTable
{
		...
		ICFBamInt16Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt16Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt16Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Col >();
		...
		ICFBamInt16Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt16Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Col >();
