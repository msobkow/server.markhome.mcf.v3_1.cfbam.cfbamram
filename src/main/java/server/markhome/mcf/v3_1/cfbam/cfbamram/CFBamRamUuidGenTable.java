...
// Description: Java 25 in-memory RAM DbIO implementation for UuidGen.
	...
	implements ICFBamUuidGenTable
{
		...
		ICFBamUuidGen iBuff )
	{
		...
		CFBamBuffUuidGen Buff = (CFBamBuffUuidGen)(schema.getTableUuidType().createUuidType( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUuidGen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuidGen.CLASS_CODE) {
	...
	public ICFBamUuidGen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidGen.lockDerived";
		ICFBamUuidGen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUuidGen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuidGen[] retList = new ICFBamUuidGen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuidGen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuidGen ) {
			return( (ICFBamUuidGen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuidGen ) ) {
					filteredList.add( (ICFBamUuidGen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuidGen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamUuidType buffList[] = schema.getTableUuidType().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamUuidGen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidGen.readRec";
		ICFBamUuidGen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuidGen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuidGen.readAllRec";
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidGen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuidGen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuidGen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuidGen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamUuidGen buff;
		ArrayList<ICFBamUuidGen> filteredList = new ArrayList<ICFBamUuidGen>();
		ICFBamUuidGen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffUuidGen)editCur );
	}
	...
	public ICFBamUuidGen updateUuidGen( ICFSecAuthorization Authorization,
		ICFBamUuidGen iBuff )
	{
		CFBamBuffUuidGen Buff = (CFBamBuffUuidGen)(schema.getTableUuidType().updateUuidType( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuidGen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidGen > subdict;
		...
		ICFBamUuidGen iBuff )
	{
		...
		CFBamBuffUuidGen Buff = (CFBamBuffUuidGen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuidGen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUuidGen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUuidGen> matchSet = new LinkedList<CFBamBuffUuidGen>();
		Iterator<CFBamBuffUuidGen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuidGen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUuidGen)(schema.getTableUuidGen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
