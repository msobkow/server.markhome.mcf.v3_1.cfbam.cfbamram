	...
	implements ICFBamTimestampTypeTable
{
		...
		ICFBamTimestampType iBuff )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getFactoryTimestampType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey key = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getFactoryTimestampType().newBySchemaIdxKey();
		...
		ICFBamTimestampType iBuff )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getFactoryTimestampType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimestampTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getFactoryTimestampType().newBySchemaIdxKey();
