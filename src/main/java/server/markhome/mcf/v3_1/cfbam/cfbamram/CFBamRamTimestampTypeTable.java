	...
	implements ICFBamTimestampTypeTable
{
		...
		ICFBamTimestampType iBuff )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimestampType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey key = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimestampType().newBySchemaIdxKey();
		...
		ICFBamTimestampType iBuff )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimestampType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimestampTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimestampType().newBySchemaIdxKey();
