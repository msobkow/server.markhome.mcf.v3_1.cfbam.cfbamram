	...
	implements ICFBamTimestampTypeTable
{
		...
		ICFBamTimestampType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimestampType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTimestampType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampType >();
		...
		ICFBamTimestampType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimestampType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampType >();
