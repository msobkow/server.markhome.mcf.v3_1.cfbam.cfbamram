...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash160Def.
	...
	implements ICFBamDbKeyHash160DefTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Def > dictByPKey
	...
	public ICFBamDbKeyHash160Def createDbKeyHash160Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Def iBuff )
	{
		final String S_ProcName = "createDbKeyHash160Def";
		
		CFBamBuffDbKeyHash160Def Buff = (CFBamBuffDbKeyHash160Def)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash160Def.CLASS_CODE) {
	...
	public ICFBamDbKeyHash160Def lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Def.lockDerived";
		ICFBamDbKeyHash160Def buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash160Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash160Def[] retList = new ICFBamDbKeyHash160Def[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash160Def > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash160Def ) {
			return( (ICFBamDbKeyHash160Def)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash160Def ) ) {
					filteredList.add( (ICFBamDbKeyHash160Def)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash160Def[0] ) );
		}
	}
	...
	public ICFBamDbKeyHash160Def readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Def.readRec";
		ICFBamDbKeyHash160Def buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash160Def.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Def.readAllRec";
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Def.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash160Def buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash160Def buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash160Def)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Def buff;
		ArrayList<ICFBamDbKeyHash160Def> filteredList = new ArrayList<ICFBamDbKeyHash160Def>();
		ICFBamDbKeyHash160Def[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash160Def)cur );
		}
		...
		return( (CFBamBuffDbKeyHash160Def)editCur );
	}
	...
	public ICFBamDbKeyHash160Def updateDbKeyHash160Def( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Def iBuff )
	{
		CFBamBuffDbKeyHash160Def Buff = (CFBamBuffDbKeyHash160Def)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash160Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Def > subdict;
		...
		ICFBamDbKeyHash160Def iBuff )
	{
		...
		CFBamBuffDbKeyHash160Def Buff = (CFBamBuffDbKeyHash160Def)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash160Def existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamDbKeyHash160Def.CLASS_CODE == subClassCode ) {
