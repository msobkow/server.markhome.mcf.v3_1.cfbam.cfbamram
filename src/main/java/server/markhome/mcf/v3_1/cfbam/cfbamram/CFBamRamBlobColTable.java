	...
	implements ICFBamBlobColTable
{
		...
		ICFBamBlobCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBlobCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffBlobCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffBlobCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffBlobCol >();
		...
		ICFBamBlobCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBlobCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffBlobCol >();
