...
// Description: Java 25 in-memory RAM DbIO implementation for BlobCol.
	...
	implements ICFBamBlobColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffBlobCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffBlobCol >();
	private Map< CFBamBuffBlobColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBlobCol >> dictByTableIdx
		= new HashMap< CFBamBuffBlobColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBlobCol >>();
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobCol Buff = (CFBamBuffBlobCol)(schema.getTableBlobDef().createBlobDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamBlobCol.CLASS_CODE ) {
		...
		CFBamBuffBlobColByTableIdxKey keyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBlobCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBlobCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffBlobCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBlobCol.CLASS_CODE) {
	...
	public ICFBamBlobCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobCol.lockDerived";
		ICFBamBlobCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamBlobCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamBlobCol[] retList = new ICFBamBlobCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffBlobCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBlobCol ) {
			return( (ICFBamBlobCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBlobCol ) ) {
					filteredList.add( (ICFBamBlobCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamBlobCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffBlobColByTableIdxKey key = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBlobCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamBlobCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffBlobCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamBlobCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffBlobCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffBlobCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffBlobCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamBlobCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamBlobCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobCol.readRec";
		ICFBamBlobCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBlobCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamBlobCol.readAllRec";
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBlobCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBlobCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBlobCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBlobCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamBlobCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamBlobCol.readRecByTableIdx() ";
		ICFBamBlobCol buff;
		ArrayList<ICFBamBlobCol> filteredList = new ArrayList<ICFBamBlobCol>();
		ICFBamBlobCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBlobCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffBlobCol)editCur );
	}
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobColByTableIdxKey existingKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBlobCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBlobColByTableIdxKey newKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryBlobCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBlobCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffBlobCol >();
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobCol Buff = (CFBamBuffBlobCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBlobCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffBlobCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffBlobCol> matchSet = new LinkedList<CFBamBuffBlobCol>();
		Iterator<CFBamBuffBlobCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffBlobCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffBlobCol)(schema.getTableBlobCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
