	...
	implements ICFBamBlobColTable
{
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobColByTableIdxKey keyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBlobColByTableIdxKey key = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobColByTableIdxKey existingKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBlobColByTableIdxKey newKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
