	...
	implements ICFBamBlobColTable
{
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBlobColByTableIdxKey key = (CFBamBuffBlobColByTableIdxKey)schema.getFactoryBlobCol().newByTableIdxKey();
		...
		ICFBamBlobCol iBuff )
	{
		...
		CFBamBuffBlobColByTableIdxKey existingKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getFactoryBlobCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBlobColByTableIdxKey newKeyTableIdx = (CFBamBuffBlobColByTableIdxKey)schema.getFactoryBlobCol().newByTableIdxKey();
