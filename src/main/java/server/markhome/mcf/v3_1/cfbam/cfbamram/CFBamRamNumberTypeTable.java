	...
	implements ICFBamNumberTypeTable
{
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey key = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getFactoryNumberType().newBySchemaIdxKey();
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getFactoryNumberType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNumberTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getFactoryNumberType().newBySchemaIdxKey();
