	...
	implements ICFBamNumberTypeTable
{
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNumberType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey key = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNumberType().newBySchemaIdxKey();
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNumberType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNumberTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNumberType().newBySchemaIdxKey();
