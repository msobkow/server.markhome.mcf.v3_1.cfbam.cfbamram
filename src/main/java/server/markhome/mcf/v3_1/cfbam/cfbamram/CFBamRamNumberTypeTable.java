...
// Description: Java 25 in-memory RAM DbIO implementation for NumberType.
	...
	implements ICFBamNumberTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNumberType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffNumberType >();
	private Map< CFBamBuffNumberTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNumberType >> dictBySchemaIdx
		= new HashMap< CFBamBuffNumberTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNumberType >>();
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberType Buff = (CFBamBuffNumberType)(schema.getTableNumberDef().createNumberDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamNumberType.CLASS_CODE ) {
		...
		CFBamBuffNumberTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNumberType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNumberType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffNumberType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNumberType.CLASS_CODE) {
	...
	public ICFBamNumberType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberType.lockDerived";
		ICFBamNumberType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNumberType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNumberType[] retList = new ICFBamNumberType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNumberType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNumberType ) {
			return( (ICFBamNumberType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNumberType ) ) {
					filteredList.add( (ICFBamNumberType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNumberType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey key = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNumberType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamNumberType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffNumberType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamNumberType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffNumberType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffNumberType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffNumberType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamNumberType[0];
		}
		return( recArray );
	}
	...
	public ICFBamNumberType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberType.readRec";
		ICFBamNumberType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNumberType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNumberType.readAllRec";
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNumberType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNumberType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNumberType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNumberType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamNumberType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamNumberType.readRecBySchemaIdx() ";
		ICFBamNumberType buff;
		ArrayList<ICFBamNumberType> filteredList = new ArrayList<ICFBamNumberType>();
		ICFBamNumberType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNumberType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNumberType)cur );
		}
		...
		return( (CFBamBuffNumberType)editCur );
	}
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNumberType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNumberTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNumberTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNumberType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNumberType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffNumberType >();
		...
		ICFBamNumberType iBuff )
	{
		...
		CFBamBuffNumberType Buff = (CFBamBuffNumberType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNumberType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffNumberType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffNumberType> matchSet = new LinkedList<CFBamBuffNumberType>();
		Iterator<CFBamBuffNumberType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNumberType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNumberType)(schema.getTableNumberType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
