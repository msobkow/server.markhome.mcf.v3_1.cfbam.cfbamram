	...
	implements ICFBamNumberTypeTable
{
		...
		ICFBamNumberType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNumberType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffNumberType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffNumberType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffNumberType >();
		...
		ICFBamNumberType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNumberType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffNumberType >();
