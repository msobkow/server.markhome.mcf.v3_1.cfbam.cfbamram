	...
	implements ICFBamSchemaRefTable
{
		...
		ICFBamSchemaRef iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffSchemaRef > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffSchemaRef >();
		...
		ICFLibKeyHash256 SchemaId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffSchemaRef > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffSchemaRef >();
		...
		ICFBamSchemaRef iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffSchemaRef > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffSchemaRef >();
		...
		ICFBamSchemaRef iBuff )
	{
		...
		ICFLibKeyHash256 varSchemaId = existing.getRequiredSchemaId();
