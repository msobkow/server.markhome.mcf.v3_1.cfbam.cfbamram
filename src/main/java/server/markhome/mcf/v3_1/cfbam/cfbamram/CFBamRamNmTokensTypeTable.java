	...
	implements ICFBamNmTokensTypeTable
{
		...
		ICFBamNmTokensType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokensType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffNmTokensType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensType >();
		...
		ICFBamNmTokensType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokensType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokensType >();
