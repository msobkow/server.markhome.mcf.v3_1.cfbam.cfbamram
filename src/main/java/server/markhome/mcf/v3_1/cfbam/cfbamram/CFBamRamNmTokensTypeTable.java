...
// Description: Java 25 in-memory RAM DbIO implementation for NmTokensType.
	...
	implements ICFBamNmTokensTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNmTokensType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffNmTokensType >();
	private Map< CFBamBuffNmTokensTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokensType >> dictBySchemaIdx
		= new HashMap< CFBamBuffNmTokensTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokensType >>();
	...
	public ICFBamNmTokensType createNmTokensType( ICFSecAuthorization Authorization,
		ICFBamNmTokensType iBuff )
	{
		final String S_ProcName = "createNmTokensType";
		
		CFBamBuffNmTokensType Buff = (CFBamBuffNmTokensType)(schema.getTableNmTokensDef().createNmTokensDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamNmTokensType.CLASS_CODE ) {
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokensType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNmTokensType.CLASS_CODE) {
	...
	public ICFBamNmTokensType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensType.lockDerived";
		ICFBamNmTokensType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNmTokensType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNmTokensType[] retList = new ICFBamNmTokensType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNmTokensType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNmTokensType ) {
			return( (ICFBamNmTokensType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNmTokensType ) ) {
					filteredList.add( (ICFBamNmTokensType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNmTokensType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey key = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamNmTokensType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffNmTokensType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamNmTokensType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffNmTokensType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffNmTokensType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamNmTokensType[0];
		}
		return( recArray );
	}
	...
	public ICFBamNmTokensType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokensType.readRec";
		ICFBamNmTokensType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNmTokensType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNmTokensType.readAllRec";
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokensType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNmTokensType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNmTokensType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNmTokensType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamNmTokensType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamNmTokensType.readRecBySchemaIdx() ";
		ICFBamNmTokensType buff;
		ArrayList<ICFBamNmTokensType> filteredList = new ArrayList<ICFBamNmTokensType>();
		ICFBamNmTokensType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokensType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNmTokensType)cur );
		}
		...
		return( (CFBamBuffNmTokensType)editCur );
	}
	...
	public ICFBamNmTokensType updateNmTokensType( ICFSecAuthorization Authorization,
		ICFBamNmTokensType iBuff )
	{
		CFBamBuffNmTokensType Buff = (CFBamBuffNmTokensType)(schema.getTableNmTokensDef().updateNmTokensDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNmTokensType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNmTokensTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokensType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokensType >();
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensType Buff = (CFBamBuffNmTokensType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNmTokensType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffNmTokensType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffNmTokensType> matchSet = new LinkedList<CFBamBuffNmTokensType>();
		Iterator<CFBamBuffNmTokensType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNmTokensType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNmTokensType)(schema.getTableNmTokensType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
