	...
	implements ICFBamNmTokensTypeTable
{
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getFactoryNmTokensType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey key = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getFactoryNmTokensType().newBySchemaIdxKey();
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getFactoryNmTokensType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNmTokensTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getFactoryNmTokensType().newBySchemaIdxKey();
