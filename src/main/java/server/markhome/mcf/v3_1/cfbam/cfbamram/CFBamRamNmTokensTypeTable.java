	...
	implements ICFBamNmTokensTypeTable
{
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey key = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNmTokensType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNmTokensTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffNmTokensTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryNmTokensType().newBySchemaIdxKey();
