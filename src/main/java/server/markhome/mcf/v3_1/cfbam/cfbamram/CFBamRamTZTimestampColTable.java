	...
	implements ICFBamTZTimestampColTable
{
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey keyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getFactoryTZTimestampCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey key = (CFBamBuffTZTimestampColByTableIdxKey)schema.getFactoryTZTimestampCol().newByTableIdxKey();
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getFactoryTZTimestampCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimestampColByTableIdxKey newKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getFactoryTZTimestampCol().newByTableIdxKey();
