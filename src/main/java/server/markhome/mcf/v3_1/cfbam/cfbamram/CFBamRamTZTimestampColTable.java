	...
	implements ICFBamTZTimestampColTable
{
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimestampCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTZTimestampCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampCol >();
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimestampCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampCol >();
