...
// Description: Java 25 in-memory RAM DbIO implementation for TZTimestampCol.
	...
	implements ICFBamTZTimestampColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTZTimestampCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTZTimestampCol >();
	private Map< CFBamBuffTZTimestampColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimestampCol >> dictByTableIdx
		= new HashMap< CFBamBuffTZTimestampColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimestampCol >>();
	...
	public ICFBamTZTimestampCol createTZTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTZTimestampCol iBuff )
	{
		final String S_ProcName = "createTZTimestampCol";
		
		CFBamBuffTZTimestampCol Buff = (CFBamBuffTZTimestampCol)(schema.getTableTZTimestampDef().createTZTimestampDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTZTimestampCol.CLASS_CODE ) {
		...
		CFBamBuffTZTimestampColByTableIdxKey keyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimestampCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZTimestampCol.CLASS_CODE) {
	...
	public ICFBamTZTimestampCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampCol.lockDerived";
		ICFBamTZTimestampCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZTimestampCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTZTimestampCol[] retList = new ICFBamTZTimestampCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTZTimestampCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTZTimestampCol ) {
			return( (ICFBamTZTimestampCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTZTimestampCol ) ) {
					filteredList.add( (ICFBamTZTimestampCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTZTimestampCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey key = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamTZTimestampCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTZTimestampCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamTZTimestampCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffTZTimestampCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTZTimestampCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamTZTimestampCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamTZTimestampCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampCol.readRec";
		ICFBamTZTimestampCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZTimestampCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTZTimestampCol.readAllRec";
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimestampCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTZTimestampCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTZTimestampCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTZTimestampCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTZTimestampCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamTZTimestampCol.readRecByTableIdx() ";
		ICFBamTZTimestampCol buff;
		ArrayList<ICFBamTZTimestampCol> filteredList = new ArrayList<ICFBamTZTimestampCol>();
		ICFBamTZTimestampCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimestampCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTZTimestampCol)cur );
		}
		...
		return( (CFBamBuffTZTimestampCol)editCur );
	}
	...
	public ICFBamTZTimestampCol updateTZTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTZTimestampCol iBuff )
	{
		CFBamBuffTZTimestampCol Buff = (CFBamBuffTZTimestampCol)(schema.getTableTZTimestampDef().updateTZTimestampDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZTimestampCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimestampColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimestampColByTableIdxKey newKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimestampCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampCol >();
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampCol Buff = (CFBamBuffTZTimestampCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZTimestampCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTZTimestampCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTZTimestampCol> matchSet = new LinkedList<CFBamBuffTZTimestampCol>();
		Iterator<CFBamBuffTZTimestampCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZTimestampCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZTimestampCol)(schema.getTableTZTimestampCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
