	...
	implements ICFBamTZTimestampColTable
{
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey keyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey key = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey existingKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimestampCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimestampColByTableIdxKey newKeyTableIdx = (CFBamBuffTZTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTZTimestampCol().newByTableIdxKey();
