	...
	implements ICFBamDoubleTypeTable
{
		...
		ICFBamDoubleType iBuff )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getFactoryDoubleType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey key = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getFactoryDoubleType().newBySchemaIdxKey();
		...
		ICFBamDoubleType iBuff )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getFactoryDoubleType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDoubleTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getFactoryDoubleType().newBySchemaIdxKey();
