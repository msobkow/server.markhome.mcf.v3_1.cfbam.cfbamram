	...
	implements ICFBamDoubleTypeTable
{
		...
		ICFBamDoubleType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDoubleType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDoubleType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleType >();
		...
		ICFBamDoubleType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDoubleType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDoubleType >();
