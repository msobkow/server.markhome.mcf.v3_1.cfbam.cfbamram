...
// Description: Java 25 in-memory RAM DbIO implementation for DoubleType.
	...
	implements ICFBamDoubleTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDoubleType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDoubleType >();
	private Map< CFBamBuffDoubleTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDoubleType >> dictBySchemaIdx
		= new HashMap< CFBamBuffDoubleTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDoubleType >>();
	...
	public ICFBamDoubleType createDoubleType( ICFSecAuthorization Authorization,
		ICFBamDoubleType iBuff )
	{
		final String S_ProcName = "createDoubleType";
		
		CFBamBuffDoubleType Buff = (CFBamBuffDoubleType)(schema.getTableDoubleDef().createDoubleDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDoubleType.CLASS_CODE ) {
		...
		CFBamBuffDoubleTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDoubleType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDoubleType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDoubleType.CLASS_CODE) {
	...
	public ICFBamDoubleType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDoubleType.lockDerived";
		ICFBamDoubleType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDoubleType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDoubleType[] retList = new ICFBamDoubleType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDoubleType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDoubleType ) {
			return( (ICFBamDoubleType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDoubleType ) ) {
					filteredList.add( (ICFBamDoubleType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDoubleType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey key = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamDoubleType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDoubleType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamDoubleType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffDoubleType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDoubleType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDoubleType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamDoubleType[0];
		}
		return( recArray );
	}
	...
	public ICFBamDoubleType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDoubleType.readRec";
		ICFBamDoubleType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDoubleType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDoubleType.readAllRec";
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDoubleType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDoubleType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDoubleType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDoubleType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDoubleType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDoubleType.readRecBySchemaIdx() ";
		ICFBamDoubleType buff;
		ArrayList<ICFBamDoubleType> filteredList = new ArrayList<ICFBamDoubleType>();
		ICFBamDoubleType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDoubleType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDoubleType)cur );
		}
		...
		return( (CFBamBuffDoubleType)editCur );
	}
	...
	public ICFBamDoubleType updateDoubleType( ICFSecAuthorization Authorization,
		ICFBamDoubleType iBuff )
	{
		CFBamBuffDoubleType Buff = (CFBamBuffDoubleType)(schema.getTableDoubleDef().updateDoubleDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDoubleType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDoubleTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDoubleTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryDoubleType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDoubleType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDoubleType >();
		...
		ICFBamDoubleType iBuff )
	{
		...
		CFBamBuffDoubleType Buff = (CFBamBuffDoubleType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDoubleType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDoubleType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDoubleType> matchSet = new LinkedList<CFBamBuffDoubleType>();
		Iterator<CFBamBuffDoubleType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDoubleType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDoubleType)(schema.getTableDoubleType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
