	...
	implements ICFBamDoubleTypeTable
{
		...
		ICFBamDoubleType iBuff )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDoubleType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey key = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDoubleType().newBySchemaIdxKey();
		...
		ICFBamDoubleType iBuff )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDoubleType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDoubleTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffDoubleTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryDoubleType().newBySchemaIdxKey();
