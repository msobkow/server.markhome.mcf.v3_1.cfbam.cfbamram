...
// Description: Java 25 in-memory RAM DbIO implementation for BlobDef.
	...
	implements ICFBamBlobDefTable
{
		...
		ICFBamBlobDef iBuff )
	{
		...
		CFBamBuffBlobDef Buff = (CFBamBuffBlobDef)(schema.getTableAtom().createAtom( Authorization,
			iBuff ));
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBlobDef.CLASS_CODE) {
	...
	public ICFBamBlobDef lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobDef.lockDerived";
		ICFBamBlobDef buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamBlobDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamBlobDef[] retList = new ICFBamBlobDef[ dictByPKey.values().size() ];
		Iterator< CFBamBuffBlobDef > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBlobDef ) {
			return( (ICFBamBlobDef)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBlobDef ) ) {
					filteredList.add( (ICFBamBlobDef)buff );
				}
			}
			return( filteredList.toArray( new ICFBamBlobDef[0] ) );
		}
	}
	...
	public ICFBamBlobDef readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBlobDef.readRec";
		ICFBamBlobDef buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBlobDef.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamBlobDef.readAllRec";
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBlobDef.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBlobDef buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBlobDef buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBlobDef)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBlobDef buff;
		ArrayList<ICFBamBlobDef> filteredList = new ArrayList<ICFBamBlobDef>();
		ICFBamBlobDef[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffBlobDef)editCur );
	}
	...
	public ICFBamBlobDef updateBlobDef( ICFSecAuthorization Authorization,
		ICFBamBlobDef iBuff )
	{
		CFBamBuffBlobDef Buff = (CFBamBuffBlobDef)(schema.getTableAtom().updateAtom( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffBlobDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffBlobDef > subdict;
		...
		ICFBamBlobDef iBuff )
	{
		...
		CFBamBuffBlobDef Buff = (CFBamBuffBlobDef)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBlobDef existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFLibKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamBlobDef.CLASS_CODE == subClassCode ) {
