	...
	implements ICFBamStringTypeTable
{
		...
		ICFBamStringType iBuff )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryStringType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey key = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryStringType().newBySchemaIdxKey();
		...
		ICFBamStringType iBuff )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryStringType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffStringTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryStringType().newBySchemaIdxKey();
