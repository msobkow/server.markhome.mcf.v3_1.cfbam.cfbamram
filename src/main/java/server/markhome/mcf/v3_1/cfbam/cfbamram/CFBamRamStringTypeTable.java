	...
	implements ICFBamStringTypeTable
{
		...
		ICFBamStringType iBuff )
	{
		...
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			...
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffStringType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffStringType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffStringType >();
		...
		ICFBamStringType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffStringType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffStringType >();
