...
// Description: Java 25 in-memory RAM DbIO implementation for StringType.
	...
	implements ICFBamStringTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffStringType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffStringType >();
	private Map< CFBamBuffStringTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffStringType >> dictBySchemaIdx
		= new HashMap< CFBamBuffStringTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffStringType >>();
	...
	public ICFBamStringType createStringType( ICFSecAuthorization Authorization,
		ICFBamStringType iBuff )
	{
		final String S_ProcName = "createStringType";
		
		CFBamBuffStringType Buff = (CFBamBuffStringType)(schema.getTableStringDef().createStringDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamStringType.CLASS_CODE ) {
		...
		CFBamBuffStringTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryStringType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffStringType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffStringType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamStringType.CLASS_CODE) {
	...
	public ICFBamStringType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamStringType[] retList = new ICFBamStringType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffStringType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamStringType ) {
			return( (ICFBamStringType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamStringType ) ) {
					filteredList.add( (ICFBamStringType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamStringType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey key = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryStringType().newBySchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			recArray = new ICFBamStringType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffStringType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffStringType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffStringType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamStringType[0];
		}
		return( recArray );
	}
	...
	public ICFBamStringType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamStringType.readRec";
		ICFBamStringType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamStringType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamStringType.readAllRec";
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamStringType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamStringType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamStringType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamStringType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamStringType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamStringType.readRecBySchemaIdx() ";
		ICFBamStringType buff;
		ArrayList<ICFBamStringType> filteredList = new ArrayList<ICFBamStringType>();
		ICFBamStringType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamStringType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffStringType)cur );
		}
		...
		return( (CFBamBuffStringType)editCur );
	}
	...
	public ICFBamStringType updateStringType( ICFSecAuthorization Authorization,
		ICFBamStringType iBuff )
	{
		CFBamBuffStringType Buff = (CFBamBuffStringType)(schema.getTableStringDef().updateStringDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffStringType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffStringTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryStringType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffStringTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryStringType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffStringType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffStringType >();
		...
		ICFBamStringType iBuff )
	{
		...
		CFBamBuffStringType Buff = (CFBamBuffStringType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffStringType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffStringType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffStringType> matchSet = new LinkedList<CFBamBuffStringType>();
		Iterator<CFBamBuffStringType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffStringType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffStringType)(schema.getTableStringType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
