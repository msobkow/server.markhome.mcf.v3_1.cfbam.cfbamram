	...
	implements ICFBamStringTypeTable
{
		...
		ICFBamStringType iBuff )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getFactoryStringType().newBySchemaIdxKey();
		...
		ICFBamStringType iBuff )
	{
		...
		CFBamBuffStringTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getFactoryStringType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffStringTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffStringTypeBySchemaIdxKey)schema.getFactoryStringType().newBySchemaIdxKey();
