	...
	implements ICFBamTokenColTable
{
		...
		ICFBamTokenCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTokenCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTokenCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTokenCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTokenCol >();
		...
		ICFBamTokenCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTokenCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTokenCol >();
