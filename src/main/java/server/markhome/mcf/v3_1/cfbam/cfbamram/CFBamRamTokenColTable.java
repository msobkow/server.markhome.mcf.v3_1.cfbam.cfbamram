	...
	implements ICFBamTokenColTable
{
		...
		ICFBamTokenCol iBuff )
	{
		...
		CFBamBuffTokenColByTableIdxKey keyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryTokenCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTokenColByTableIdxKey key = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryTokenCol().newByTableIdxKey();
		...
		ICFBamTokenCol iBuff )
	{
		...
		CFBamBuffTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryTokenCol().newByTableIdxKey();
