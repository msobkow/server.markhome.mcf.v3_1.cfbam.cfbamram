	...
	implements ICFBamTokenColTable
{
		...
		ICFBamTokenCol iBuff )
	{
		...
		CFBamBuffTokenColByTableIdxKey keyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getFactoryTokenCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTokenColByTableIdxKey key = (CFBamBuffTokenColByTableIdxKey)schema.getFactoryTokenCol().newByTableIdxKey();
		...
		ICFBamTokenCol iBuff )
	{
		...
		CFBamBuffTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getFactoryTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getFactoryTokenCol().newByTableIdxKey();
