...
// Description: Java 25 in-memory RAM DbIO implementation for TokenCol.
	...
	implements ICFBamTokenColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTokenCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTokenCol >();
	private Map< CFBamBuffTokenColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTokenCol >> dictByTableIdx
		= new HashMap< CFBamBuffTokenColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTokenCol >>();
	...
	public ICFBamTokenCol createTokenCol( ICFSecAuthorization Authorization,
		ICFBamTokenCol iBuff )
	{
		final String S_ProcName = "createTokenCol";
		
		CFBamBuffTokenCol Buff = (CFBamBuffTokenCol)(schema.getTableTokenDef().createTokenDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTokenCol.CLASS_CODE ) {
		...
		CFBamBuffTokenColByTableIdxKey keyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTokenCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTokenCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTokenCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTokenCol.CLASS_CODE) {
	...
	public ICFBamTokenCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenCol.lockDerived";
		ICFBamTokenCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTokenCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTokenCol[] retList = new ICFBamTokenCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTokenCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTokenCol ) {
			return( (ICFBamTokenCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTokenCol ) ) {
					filteredList.add( (ICFBamTokenCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTokenCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTokenColByTableIdxKey key = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTokenCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamTokenCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTokenCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamTokenCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffTokenCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTokenCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTokenCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamTokenCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamTokenCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTokenCol.readRec";
		ICFBamTokenCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTokenCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTokenCol.readAllRec";
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTokenCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTokenCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTokenCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTokenCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTokenCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamTokenCol.readRecByTableIdx() ";
		ICFBamTokenCol buff;
		ArrayList<ICFBamTokenCol> filteredList = new ArrayList<ICFBamTokenCol>();
		ICFBamTokenCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTokenCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffTokenCol)editCur );
	}
	...
	public ICFBamTokenCol updateTokenCol( ICFSecAuthorization Authorization,
		ICFBamTokenCol iBuff )
	{
		CFBamBuffTokenCol Buff = (CFBamBuffTokenCol)(schema.getTableTokenDef().updateTokenDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTokenCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTokenCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTokenCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTokenCol >();
		...
		ICFBamTokenCol iBuff )
	{
		...
		CFBamBuffTokenCol Buff = (CFBamBuffTokenCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTokenCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTokenCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTokenCol> matchSet = new LinkedList<CFBamBuffTokenCol>();
		Iterator<CFBamBuffTokenCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTokenCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTokenCol)(schema.getTableTokenCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
