	...
	implements ICFBamDateColTable
{
		...
		ICFBamDateCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDateCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDateCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDateCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDateCol >();
		...
		ICFBamDateCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDateCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDateCol >();
