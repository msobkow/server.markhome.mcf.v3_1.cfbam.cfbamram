	...
	implements ICFBamDateColTable
{
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDateColByTableIdxKey key = (CFBamBuffDateColByTableIdxKey)schema.getFactoryDateCol().newByTableIdxKey();
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getFactoryDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDateColByTableIdxKey newKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getFactoryDateCol().newByTableIdxKey();
