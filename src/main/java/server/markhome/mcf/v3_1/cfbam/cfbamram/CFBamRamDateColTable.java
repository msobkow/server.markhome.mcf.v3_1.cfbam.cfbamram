	...
	implements ICFBamDateColTable
{
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateColByTableIdxKey keyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamFactory().getFactoryDateCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDateColByTableIdxKey key = (CFBamBuffDateColByTableIdxKey)schema.getCFBamFactory().getFactoryDateCol().newByTableIdxKey();
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamFactory().getFactoryDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDateColByTableIdxKey newKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamFactory().getFactoryDateCol().newByTableIdxKey();
