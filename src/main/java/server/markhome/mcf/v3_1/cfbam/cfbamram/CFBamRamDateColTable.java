...
// Description: Java 25 in-memory RAM DbIO implementation for DateCol.
	...
	implements ICFBamDateColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDateCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDateCol >();
	private Map< CFBamBuffDateColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDateCol >> dictByTableIdx
		= new HashMap< CFBamBuffDateColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDateCol >>();
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateCol Buff = (CFBamBuffDateCol)(schema.getTableDateDef().createDateDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDateCol.CLASS_CODE ) {
		...
		CFBamBuffDateColByTableIdxKey keyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDateCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDateCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDateCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDateCol.CLASS_CODE) {
	...
	public ICFBamDateCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDateCol.lockDerived";
		ICFBamDateCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDateCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDateCol[] retList = new ICFBamDateCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDateCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDateCol ) {
			return( (ICFBamDateCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDateCol ) ) {
					filteredList.add( (ICFBamDateCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDateCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDateColByTableIdxKey key = (CFBamBuffDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDateCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDateCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDateCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDateCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDateCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDateCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDateCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDateCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamDateCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDateCol.readRec";
		ICFBamDateCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDateCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDateCol.readAllRec";
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDateCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDateCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDateCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDateCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDateCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDateCol.readRecByTableIdx() ";
		ICFBamDateCol buff;
		ArrayList<ICFBamDateCol> filteredList = new ArrayList<ICFBamDateCol>();
		ICFBamDateCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDateCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffDateCol)editCur );
	}
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateColByTableIdxKey existingKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDateCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDateColByTableIdxKey newKeyTableIdx = (CFBamBuffDateColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDateCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDateCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDateCol >();
		...
		ICFBamDateCol iBuff )
	{
		...
		CFBamBuffDateCol Buff = (CFBamBuffDateCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDateCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDateCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDateCol> matchSet = new LinkedList<CFBamBuffDateCol>();
		Iterator<CFBamBuffDateCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDateCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDateCol)(schema.getTableDateCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
