	...
	implements ICFBamFloatTypeTable
{
		...
		ICFBamFloatType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffFloatType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffFloatType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffFloatType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffFloatType >();
		...
		ICFBamFloatType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffFloatType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffFloatType >();
