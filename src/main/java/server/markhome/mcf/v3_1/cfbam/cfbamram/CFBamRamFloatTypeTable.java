	...
	implements ICFBamFloatTypeTable
{
		...
		ICFBamFloatType iBuff )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryFloatType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey key = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryFloatType().newBySchemaIdxKey();
		...
		ICFBamFloatType iBuff )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryFloatType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffFloatTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryFloatType().newBySchemaIdxKey();
