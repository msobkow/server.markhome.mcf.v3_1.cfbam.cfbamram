	...
	implements ICFBamFloatTypeTable
{
		...
		ICFBamFloatType iBuff )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getFactoryFloatType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey key = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getFactoryFloatType().newBySchemaIdxKey();
		...
		ICFBamFloatType iBuff )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getFactoryFloatType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffFloatTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getFactoryFloatType().newBySchemaIdxKey();
