...
// Description: Java 25 in-memory RAM DbIO implementation for FloatType.
	...
	implements ICFBamFloatTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffFloatType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffFloatType >();
	private Map< CFBamBuffFloatTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffFloatType >> dictBySchemaIdx
		= new HashMap< CFBamBuffFloatTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffFloatType >>();
	...
	public ICFBamFloatType createFloatType( ICFSecAuthorization Authorization,
		ICFBamFloatType iBuff )
	{
		final String S_ProcName = "createFloatType";
		
		CFBamBuffFloatType Buff = (CFBamBuffFloatType)(schema.getTableFloatDef().createFloatDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamFloatType.CLASS_CODE ) {
		...
		CFBamBuffFloatTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryFloatType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffFloatType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffFloatType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamFloatType.CLASS_CODE) {
	...
	public ICFBamFloatType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatType.lockDerived";
		ICFBamFloatType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamFloatType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamFloatType[] retList = new ICFBamFloatType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffFloatType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamFloatType ) {
			return( (ICFBamFloatType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamFloatType ) ) {
					filteredList.add( (ICFBamFloatType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamFloatType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffFloatTypeBySchemaIdxKey key = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryFloatType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamFloatType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffFloatType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamFloatType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffFloatType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffFloatType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffFloatType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamFloatType[0];
		}
		return( recArray );
	}
	...
	public ICFBamFloatType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamFloatType.readRec";
		ICFBamFloatType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamFloatType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamFloatType.readAllRec";
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamFloatType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamFloatType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamFloatType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamFloatType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamFloatType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamFloatType.readRecBySchemaIdx() ";
		ICFBamFloatType buff;
		ArrayList<ICFBamFloatType> filteredList = new ArrayList<ICFBamFloatType>();
		ICFBamFloatType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamFloatType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffFloatType)editCur );
	}
	...
	public ICFBamFloatType updateFloatType( ICFSecAuthorization Authorization,
		ICFBamFloatType iBuff )
	{
		CFBamBuffFloatType Buff = (CFBamBuffFloatType)(schema.getTableFloatDef().updateFloatDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffFloatType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffFloatTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryFloatType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffFloatTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffFloatTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryFloatType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffFloatType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffFloatType >();
		...
		ICFBamFloatType iBuff )
	{
		...
		CFBamBuffFloatType Buff = (CFBamBuffFloatType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffFloatType existing = dictByPKey.get( pkey );
		if( existing == null ) {
