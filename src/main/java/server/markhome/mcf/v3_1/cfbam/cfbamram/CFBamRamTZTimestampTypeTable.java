...
// Description: Java 25 in-memory RAM DbIO implementation for TZTimestampType.
	...
	implements ICFBamTZTimestampTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTZTimestampType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTZTimestampType >();
	private Map< CFBamBuffTZTimestampTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimestampType >> dictBySchemaIdx
		= new HashMap< CFBamBuffTZTimestampTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTZTimestampType >>();
	...
	public ICFBamTZTimestampType createTZTimestampType( ICFSecAuthorization Authorization,
		ICFBamTZTimestampType iBuff )
	{
		final String S_ProcName = "createTZTimestampType";
		
		CFBamBuffTZTimestampType Buff = (CFBamBuffTZTimestampType)(schema.getTableTZTimestampDef().createTZTimestampDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTZTimestampType.CLASS_CODE ) {
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimestampType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZTimestampType.CLASS_CODE) {
	...
	public ICFBamTZTimestampType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampType.lockDerived";
		ICFBamTZTimestampType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZTimestampType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTZTimestampType[] retList = new ICFBamTZTimestampType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTZTimestampType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTZTimestampType ) {
			return( (ICFBamTZTimestampType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTZTimestampType ) ) {
					filteredList.add( (ICFBamTZTimestampType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTZTimestampType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey key = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamTZTimestampType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTZTimestampType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamTZTimestampType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffTZTimestampType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTZTimestampType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamTZTimestampType[0];
		}
		return( recArray );
	}
	...
	public ICFBamTZTimestampType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZTimestampType.readRec";
		ICFBamTZTimestampType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZTimestampType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTZTimestampType.readAllRec";
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimestampType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTZTimestampType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTZTimestampType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTZTimestampType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTZTimestampType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamTZTimestampType.readRecBySchemaIdx() ";
		ICFBamTZTimestampType buff;
		ArrayList<ICFBamTZTimestampType> filteredList = new ArrayList<ICFBamTZTimestampType>();
		ICFBamTZTimestampType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTZTimestampType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTZTimestampType)cur );
		}
		...
		return( (CFBamBuffTZTimestampType)editCur );
	}
	...
	public ICFBamTZTimestampType updateTZTimestampType( ICFSecAuthorization Authorization,
		ICFBamTZTimestampType iBuff )
	{
		CFBamBuffTZTimestampType Buff = (CFBamBuffTZTimestampType)(schema.getTableTZTimestampDef().updateTZTimestampDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZTimestampType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimestampTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZTimestampType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTZTimestampType >();
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampType Buff = (CFBamBuffTZTimestampType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZTimestampType existing = dictByPKey.get( pkey );
		if( existing == null ) {
