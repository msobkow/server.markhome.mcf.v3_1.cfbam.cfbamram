	...
	implements ICFBamTZTimestampTypeTable
{
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey key = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimestampTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZTimestampType().newBySchemaIdxKey();
