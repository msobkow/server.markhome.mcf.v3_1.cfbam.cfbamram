	...
	implements ICFBamTZTimestampTypeTable
{
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey key = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getFactoryTZTimestampType().newBySchemaIdxKey();
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getFactoryTZTimestampType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimestampTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZTimestampTypeBySchemaIdxKey)schema.getFactoryTZTimestampType().newBySchemaIdxKey();
