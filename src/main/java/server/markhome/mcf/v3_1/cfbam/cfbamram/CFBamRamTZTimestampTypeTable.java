	...
	implements ICFBamTZTimestampTypeTable
{
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimestampType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTZTimestampType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampType >();
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTZTimestampType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTZTimestampType >();
