	...
	implements ICFBamTimeTypeTable
{
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey key = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getFactoryTimeType().newBySchemaIdxKey();
		...
		ICFBamTimeType iBuff )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getFactoryTimeType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimeTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getFactoryTimeType().newBySchemaIdxKey();
