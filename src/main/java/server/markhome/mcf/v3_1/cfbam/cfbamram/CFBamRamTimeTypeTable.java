	...
	implements ICFBamTimeTypeTable
{
		...
		ICFBamTimeType iBuff )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey key = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
		...
		ICFBamTimeType iBuff )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimeTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTimeTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
