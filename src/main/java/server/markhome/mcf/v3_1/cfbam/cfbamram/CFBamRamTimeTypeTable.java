	...
	implements ICFBamTimeTypeTable
{
		...
		ICFBamTimeType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimeType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTimeType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTimeType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTimeType >();
		...
		ICFBamTimeType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimeType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTimeType >();
