...
// Description: Java 25 in-memory RAM DbIO implementation for TZDateType.
	...
	implements ICFBamTZDateTypeTable
{
	...
	public ICFBamTZDateType createTZDateType( ICFSecAuthorization Authorization,
		ICFBamTZDateType iBuff )
	{
		final String S_ProcName = "createTZDateType";
		
		CFBamBuffTZDateType Buff = (CFBamBuffTZDateType)(schema.getTableTZDateDef().createTZDateDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTZDateType.CLASS_CODE ) {
		...
		CFBamBuffTZDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZDateType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTZDateType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTZDateType.CLASS_CODE) {
	...
	public ICFBamTZDateType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateType.lockDerived";
		ICFBamTZDateType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTZDateType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< CFBamBuffTZDateType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey key = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateType().newBySchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< CFBamBuffTZDateType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTZDateType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTZDateType >();
	...
	public ICFBamTZDateType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTZDateType.readRec";
		ICFBamTZDateType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTZDateType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTZDateType.readAllRec";
		ICFBamTZDateType buff;
		ArrayList<ICFBamTZDateType> filteredList = new ArrayList<ICFBamTZDateType>();
	...
	public ICFBamTZDateType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamTZDateType.readRecBySchemaIdx() ";
		ICFBamTZDateType buff;
		ArrayList<ICFBamTZDateType> filteredList = new ArrayList<ICFBamTZDateType>();
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffTZDateType)cur );
		}
		...
		return( (CFBamBuffTZDateType)editCur );
	}
	...
	public ICFBamTZDateType updateTZDateType( ICFSecAuthorization Authorization,
		ICFBamTZDateType iBuff )
	{
		CFBamBuffTZDateType Buff = (CFBamBuffTZDateType)(schema.getTableTZDateDef().updateTZDateDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTZDateType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryTZDateType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTZDateType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTZDateType >();
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateType Buff = (CFBamBuffTZDateType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTZDateType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffTZDateType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffTZDateType> matchSet = new LinkedList<CFBamBuffTZDateType>();
		Iterator<CFBamBuffTZDateType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffTZDateType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffTZDateType)(schema.getTableTZDateType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
