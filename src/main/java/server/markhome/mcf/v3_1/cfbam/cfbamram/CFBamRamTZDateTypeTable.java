	...
	implements ICFBamTZDateTypeTable
{
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getFactoryTZDateType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey key = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getFactoryTZDateType().newBySchemaIdxKey();
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getFactoryTZDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getFactoryTZDateType().newBySchemaIdxKey();
