	...
	implements ICFBamTZDateTypeTable
{
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZDateType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey key = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZDateType().newBySchemaIdxKey();
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZDateType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZDateTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffTZDateTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryTZDateType().newBySchemaIdxKey();
