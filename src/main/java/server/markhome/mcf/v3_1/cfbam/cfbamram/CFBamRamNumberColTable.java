...
// Description: Java 25 in-memory RAM DbIO implementation for NumberCol.
	...
	implements ICFBamNumberColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNumberCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffNumberCol >();
	private Map< CFBamBuffNumberColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNumberCol >> dictByTableIdx
		= new HashMap< CFBamBuffNumberColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNumberCol >>();
	...
	public ICFBamNumberCol createNumberCol( ICFSecAuthorization Authorization,
		ICFBamNumberCol iBuff )
	{
		final String S_ProcName = "createNumberCol";
		
		CFBamBuffNumberCol Buff = (CFBamBuffNumberCol)(schema.getTableNumberDef().createNumberDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamNumberCol.CLASS_CODE ) {
		...
		CFBamBuffNumberColByTableIdxKey keyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNumberCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNumberCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffNumberCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNumberCol.CLASS_CODE) {
	...
	public ICFBamNumberCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberCol.lockDerived";
		ICFBamNumberCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNumberCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNumberCol[] retList = new ICFBamNumberCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNumberCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNumberCol ) {
			return( (ICFBamNumberCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNumberCol ) ) {
					filteredList.add( (ICFBamNumberCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNumberCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffNumberColByTableIdxKey key = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNumberCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamNumberCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffNumberCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamNumberCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffNumberCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffNumberCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffNumberCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamNumberCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamNumberCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNumberCol.readRec";
		ICFBamNumberCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNumberCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNumberCol.readAllRec";
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNumberCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNumberCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNumberCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNumberCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamNumberCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamNumberCol.readRecByTableIdx() ";
		ICFBamNumberCol buff;
		ArrayList<ICFBamNumberCol> filteredList = new ArrayList<ICFBamNumberCol>();
		ICFBamNumberCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNumberCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffNumberCol)editCur );
	}
	...
	public ICFBamNumberCol updateNumberCol( ICFSecAuthorization Authorization,
		ICFBamNumberCol iBuff )
	{
		CFBamBuffNumberCol Buff = (CFBamBuffNumberCol)(schema.getTableNumberDef().updateNumberDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffNumberCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNumberColByTableIdxKey existingKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNumberCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNumberColByTableIdxKey newKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNumberCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNumberCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffNumberCol >();
		...
		ICFBamNumberCol iBuff )
	{
		...
		CFBamBuffNumberCol Buff = (CFBamBuffNumberCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNumberCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffNumberCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffNumberCol> matchSet = new LinkedList<CFBamBuffNumberCol>();
		Iterator<CFBamBuffNumberCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNumberCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNumberCol)(schema.getTableNumberCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
