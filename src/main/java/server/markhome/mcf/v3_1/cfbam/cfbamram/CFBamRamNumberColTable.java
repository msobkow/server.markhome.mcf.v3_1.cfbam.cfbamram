	...
	implements ICFBamNumberColTable
{
		...
		ICFBamNumberCol iBuff )
	{
		...
		CFBamBuffNumberColByTableIdxKey keyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getFactoryNumberCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNumberColByTableIdxKey key = (CFBamBuffNumberColByTableIdxKey)schema.getFactoryNumberCol().newByTableIdxKey();
		...
		ICFBamNumberCol iBuff )
	{
		...
		CFBamBuffNumberColByTableIdxKey existingKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getFactoryNumberCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNumberColByTableIdxKey newKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getFactoryNumberCol().newByTableIdxKey();
