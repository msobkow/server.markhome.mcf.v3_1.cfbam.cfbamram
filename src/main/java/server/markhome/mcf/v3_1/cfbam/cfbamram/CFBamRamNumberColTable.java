	...
	implements ICFBamNumberColTable
{
		...
		ICFBamNumberCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNumberCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffNumberCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffNumberCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffNumberCol >();
		...
		ICFBamNumberCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNumberCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffNumberCol >();
