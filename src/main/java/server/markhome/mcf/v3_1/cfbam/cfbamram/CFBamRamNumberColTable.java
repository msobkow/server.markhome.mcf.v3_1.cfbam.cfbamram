	...
	implements ICFBamNumberColTable
{
		...
		ICFBamNumberCol iBuff )
	{
		...
		CFBamBuffNumberColByTableIdxKey keyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNumberColByTableIdxKey key = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
		...
		ICFBamNumberCol iBuff )
	{
		...
		CFBamBuffNumberColByTableIdxKey existingKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNumberColByTableIdxKey newKeyTableIdx = (CFBamBuffNumberColByTableIdxKey)schema.getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
