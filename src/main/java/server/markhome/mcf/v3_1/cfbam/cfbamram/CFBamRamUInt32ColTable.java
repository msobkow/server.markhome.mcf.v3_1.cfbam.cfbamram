...
// Description: Java 25 in-memory RAM DbIO implementation for UInt32Col.
	...
	implements ICFBamUInt32ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt32Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt32Col >();
	private Map< CFBamBuffUInt32ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt32Col >> dictByTableIdx
		= new HashMap< CFBamBuffUInt32ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt32Col >>();
	...
	public ICFBamUInt32Col createUInt32Col( ICFSecAuthorization Authorization,
		ICFBamUInt32Col iBuff )
	{
		final String S_ProcName = "createUInt32Col";
		
		CFBamBuffUInt32Col Buff = (CFBamBuffUInt32Col)(schema.getTableUInt32Def().createUInt32Def( Authorization,
			iBuff ));
		...
		CFBamBuffUInt32ColByTableIdxKey keyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt32Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt32Col.CLASS_CODE) {
	...
	public ICFBamUInt32Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Col.lockDerived";
		ICFBamUInt32Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt32Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt32Col[] retList = new ICFBamUInt32Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt32Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt32Col ) {
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt32Col ) ) {
					filteredList.add( (ICFBamUInt32Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt32Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffUInt32ColByTableIdxKey key = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Col().newByTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			recArray = new ICFBamUInt32Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffUInt32Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt32Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamUInt32Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt32Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt32Col.readRec";
	...
	{
		final String S_ProcName = "CFBamRamUInt32Col.readAllRec";
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt32Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamUInt32Col.readRecByTableIdx() ";
		ICFBamUInt32Col buff;
		ArrayList<ICFBamUInt32Col> filteredList = new ArrayList<ICFBamUInt32Col>();
		ICFBamUInt32Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt32Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUInt32Col)editCur );
	}
	...
	public ICFBamUInt32Col updateUInt32Col( ICFSecAuthorization Authorization,
		ICFBamUInt32Col iBuff )
	{
		CFBamBuffUInt32Col Buff = (CFBamBuffUInt32Col)(schema.getTableUInt32Def().updateUInt32Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt32Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt32ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt32ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryUInt32Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt32Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt32Col >();
		...
		ICFBamUInt32Col iBuff )
	{
		...
		CFBamBuffUInt32Col Buff = (CFBamBuffUInt32Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt32Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUInt32Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUInt32Col> matchSet = new LinkedList<CFBamBuffUInt32Col>();
		Iterator<CFBamBuffUInt32Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt32Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt32Col)(schema.getTableUInt32Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
