	...
	implements ICFBamUInt32ColTable
{
		...
		ICFBamUInt32Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt32Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt32Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUInt32Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUInt32Col >();
		...
		ICFBamUInt32Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt32Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt32Col >();
