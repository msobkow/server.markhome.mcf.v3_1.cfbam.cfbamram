	...
	implements ICFBamUInt32ColTable
{
		...
		ICFBamUInt32Col iBuff )
	{
		...
		CFBamBuffUInt32ColByTableIdxKey keyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUInt32ColByTableIdxKey key = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
		...
		ICFBamUInt32Col iBuff )
	{
		...
		CFBamBuffUInt32ColByTableIdxKey existingKeyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt32ColByTableIdxKey newKeyTableIdx = (CFBamBuffUInt32ColByTableIdxKey)schema.getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
