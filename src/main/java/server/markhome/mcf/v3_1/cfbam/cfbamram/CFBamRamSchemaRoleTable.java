	...
	implements ICFBamSchemaRoleTable
{
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffSchemaRole > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffSchemaRole >();
		...
		ICFBamSchemaRole iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFBamBuffSchemaRole > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffSchemaRole >();
