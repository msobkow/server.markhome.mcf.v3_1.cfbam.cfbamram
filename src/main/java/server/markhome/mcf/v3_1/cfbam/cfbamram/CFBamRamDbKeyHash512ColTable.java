	...
	implements ICFBamDbKeyHash512ColTable
{
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col >();
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash512Col >();
