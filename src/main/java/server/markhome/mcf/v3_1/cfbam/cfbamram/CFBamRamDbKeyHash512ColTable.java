...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash512Col.
	...
	implements ICFBamDbKeyHash512ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash512Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash512Col >();
	private Map< CFBamBuffDbKeyHash512ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash512Col >> dictByTableIdx
		= new HashMap< CFBamBuffDbKeyHash512ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash512Col >>();
	...
	public ICFBamDbKeyHash512Col createDbKeyHash512Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Col iBuff )
	{
		final String S_ProcName = "createDbKeyHash512Col";
		
		CFBamBuffDbKeyHash512Col Buff = (CFBamBuffDbKeyHash512Col)(schema.getTableDbKeyHash512Def().createDbKeyHash512Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash512Col.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash512Col.CLASS_CODE) {
	...
	public ICFBamDbKeyHash512Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.lockDerived";
		ICFBamDbKeyHash512Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash512Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash512Col[] retList = new ICFBamDbKeyHash512Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash512Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash512Col ) {
			return( (ICFBamDbKeyHash512Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash512Col ) ) {
					filteredList.add( (ICFBamDbKeyHash512Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash512Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey key = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDbKeyHash512Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDbKeyHash512Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDbKeyHash512Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDbKeyHash512Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash512Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readRec";
		ICFBamDbKeyHash512Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash512Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readAllRec";
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash512Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash512Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash512Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash512Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash512Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readRecByTableIdx() ";
		ICFBamDbKeyHash512Col buff;
		ArrayList<ICFBamDbKeyHash512Col> filteredList = new ArrayList<ICFBamDbKeyHash512Col>();
		ICFBamDbKeyHash512Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash512Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash512Col)cur );
		}
		...
		return( (CFBamBuffDbKeyHash512Col)editCur );
	}
	...
	public ICFBamDbKeyHash512Col updateDbKeyHash512Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Col iBuff )
	{
		CFBamBuffDbKeyHash512Col Buff = (CFBamBuffDbKeyHash512Col)(schema.getTableDbKeyHash512Def().updateDbKeyHash512Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash512Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash512ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash512Col >();
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		CFBamBuffDbKeyHash512Col Buff = (CFBamBuffDbKeyHash512Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash512Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash512Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash512Col> matchSet = new LinkedList<CFBamBuffDbKeyHash512Col>();
		Iterator<CFBamBuffDbKeyHash512Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash512Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash512Col)(schema.getTableDbKeyHash512Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
