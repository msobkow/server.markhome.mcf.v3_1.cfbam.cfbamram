	...
	implements ICFBamDbKeyHash512ColTable
{
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey key = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash512ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash512ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash512Col().newByTableIdxKey();
