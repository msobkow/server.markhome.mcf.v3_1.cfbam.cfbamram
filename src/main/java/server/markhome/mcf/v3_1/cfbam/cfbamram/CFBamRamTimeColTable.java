...
// Description: Java 25 in-memory RAM DbIO implementation for TimeCol.
	...
	implements ICFBamTimeColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffTimeCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffTimeCol >();
	private Map< CFBamBuffTimeColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTimeCol >> dictByTableIdx
		= new HashMap< CFBamBuffTimeColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffTimeCol >>();
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeCol Buff = (CFBamBuffTimeCol)(schema.getTableTimeDef().createTimeDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamTimeCol.CLASS_CODE ) {
		...
		CFBamBuffTimeColByTableIdxKey keyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTimeCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTimeCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffTimeCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamTimeCol.CLASS_CODE) {
	...
	public ICFBamTimeCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTimeCol.lockDerived";
		ICFBamTimeCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamTimeCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamTimeCol[] retList = new ICFBamTimeCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffTimeCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamTimeCol ) {
			return( (ICFBamTimeCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamTimeCol ) ) {
					filteredList.add( (ICFBamTimeCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamTimeCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffTimeColByTableIdxKey key = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTimeCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamTimeCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffTimeCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamTimeCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffTimeCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffTimeCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffTimeCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamTimeCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamTimeCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamTimeCol.readRec";
		ICFBamTimeCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamTimeCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamTimeCol.readAllRec";
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTimeCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamTimeCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamTimeCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamTimeCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamTimeCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamTimeCol.readRecByTableIdx() ";
		ICFBamTimeCol buff;
		ArrayList<ICFBamTimeCol> filteredList = new ArrayList<ICFBamTimeCol>();
		ICFBamTimeCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamTimeCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffTimeCol)editCur );
	}
	...
	public ICFBamTimeCol updateTimeCol( ICFSecAuthorization Authorization,
		ICFBamTimeCol iBuff )
	{
		CFBamBuffTimeCol Buff = (CFBamBuffTimeCol)(schema.getTableTimeDef().updateTimeDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffTimeCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTimeColByTableIdxKey existingKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTimeCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTimeColByTableIdxKey newKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryTimeCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffTimeCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffTimeCol >();
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeCol Buff = (CFBamBuffTimeCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffTimeCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
