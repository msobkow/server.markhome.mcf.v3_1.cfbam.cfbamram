	...
	implements ICFBamTimeColTable
{
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeColByTableIdxKey keyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getFactoryTimeCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTimeColByTableIdxKey key = (CFBamBuffTimeColByTableIdxKey)schema.getFactoryTimeCol().newByTableIdxKey();
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeColByTableIdxKey existingKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getFactoryTimeCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTimeColByTableIdxKey newKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getFactoryTimeCol().newByTableIdxKey();
