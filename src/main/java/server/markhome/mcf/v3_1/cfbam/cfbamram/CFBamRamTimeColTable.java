	...
	implements ICFBamTimeColTable
{
		...
		ICFBamTimeCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimeCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTimeCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTimeCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTimeCol >();
		...
		ICFBamTimeCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimeCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTimeCol >();
