	...
	implements ICFBamTimeColTable
{
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeColByTableIdxKey keyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTimeCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTimeColByTableIdxKey key = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTimeCol().newByTableIdxKey();
		...
		ICFBamTimeCol iBuff )
	{
		...
		CFBamBuffTimeColByTableIdxKey existingKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTimeCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTimeColByTableIdxKey newKeyTableIdx = (CFBamBuffTimeColByTableIdxKey)schema.getCFBamFactory().getFactoryTimeCol().newByTableIdxKey();
