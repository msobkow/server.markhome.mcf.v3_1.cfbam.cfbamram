	...
	implements ICFBamTimestampColTable
{
		...
		ICFBamTimestampCol iBuff )
	{
		...
		CFBamBuffTimestampColByTableIdxKey keyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTimestampCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTimestampColByTableIdxKey key = (CFBamBuffTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTimestampCol().newByTableIdxKey();
		...
		ICFBamTimestampCol iBuff )
	{
		...
		CFBamBuffTimestampColByTableIdxKey existingKeyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTimestampCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTimestampColByTableIdxKey newKeyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getCFBamFactory().getFactoryTimestampCol().newByTableIdxKey();
