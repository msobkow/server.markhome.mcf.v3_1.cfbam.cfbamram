	...
	implements ICFBamTimestampColTable
{
		...
		ICFBamTimestampCol iBuff )
	{
		...
		CFBamBuffTimestampColByTableIdxKey keyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getFactoryTimestampCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTimestampColByTableIdxKey key = (CFBamBuffTimestampColByTableIdxKey)schema.getFactoryTimestampCol().newByTableIdxKey();
		...
		ICFBamTimestampCol iBuff )
	{
		...
		CFBamBuffTimestampColByTableIdxKey existingKeyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getFactoryTimestampCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTimestampColByTableIdxKey newKeyTableIdx = (CFBamBuffTimestampColByTableIdxKey)schema.getFactoryTimestampCol().newByTableIdxKey();
