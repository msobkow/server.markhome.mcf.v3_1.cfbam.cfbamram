	...
	implements ICFBamTimestampColTable
{
		...
		ICFBamTimestampCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimestampCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffTimestampCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampCol >();
		...
		ICFBamTimestampCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffTimestampCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffTimestampCol >();
