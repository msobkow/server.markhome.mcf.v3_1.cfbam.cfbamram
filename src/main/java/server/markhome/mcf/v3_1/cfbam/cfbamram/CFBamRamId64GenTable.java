...
// Description: Java 25 in-memory RAM DbIO implementation for Id64Gen.
	...
	implements ICFBamId64GenTable
{
		...
		ICFBamId64Gen iBuff )
	{
		...
		CFBamBuffId64Gen Buff = (CFBamBuffId64Gen)(schema.getTableInt64Type().createInt64Type( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamId64Gen.CLASS_CODE ) {
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamId64Gen.CLASS_CODE) {
	...
	public ICFBamId64Gen lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamId64Gen.lockDerived";
		ICFBamId64Gen buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamId64Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamId64Gen[] retList = new ICFBamId64Gen[ dictByPKey.values().size() ];
		Iterator< CFBamBuffId64Gen > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamId64Gen ) {
			return( (ICFBamId64Gen)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamId64Gen ) ) {
					filteredList.add( (ICFBamId64Gen)buff );
				}
			}
			return( filteredList.toArray( new ICFBamId64Gen[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamInt64Type buffList[] = schema.getTableInt64Type().readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
		}
	...
	public ICFBamId64Gen readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamId64Gen.readRec";
		ICFBamId64Gen buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamId64Gen.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamId64Gen.readAllRec";
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamId64Gen.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamId64Gen buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamId64Gen buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamId64Gen)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamId64Gen buff;
		ArrayList<ICFBamId64Gen> filteredList = new ArrayList<ICFBamId64Gen>();
		ICFBamId64Gen[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		int revision )
	{
		...
		return( (CFBamBuffId64Gen)editCur );
	}
	...
	public ICFBamId64Gen updateId64Gen( ICFSecAuthorization Authorization,
		ICFBamId64Gen iBuff )
	{
		CFBamBuffId64Gen Buff = (CFBamBuffId64Gen)(schema.getTableInt64Type().updateInt64Type( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffId64Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< ICFLibKeyHash256, CFBamBuffId64Gen > subdict;
		...
		ICFBamId64Gen iBuff )
	{
		...
		CFBamBuffId64Gen Buff = (CFBamBuffId64Gen)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffId64Gen existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffId64Gen cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffId64Gen> matchSet = new LinkedList<CFBamBuffId64Gen>();
		Iterator<CFBamBuffId64Gen> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffId64Gen> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffId64Gen)(schema.getTableId64Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
