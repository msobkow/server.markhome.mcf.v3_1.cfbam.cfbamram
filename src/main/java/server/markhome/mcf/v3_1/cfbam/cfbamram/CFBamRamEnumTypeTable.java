...
// Description: Java 25 in-memory RAM DbIO implementation for EnumType.
	...
	implements ICFBamEnumTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffEnumType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffEnumType >();
	private Map< CFBamBuffEnumTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffEnumType >> dictBySchemaIdx
		= new HashMap< CFBamBuffEnumTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffEnumType >>();
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumType Buff = (CFBamBuffEnumType)(schema.getTableEnumDef().createEnumDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamEnumType.CLASS_CODE ) {
		...
		CFBamBuffEnumTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryEnumType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffEnumType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffEnumType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamEnumType.CLASS_CODE) {
	...
	public ICFBamEnumType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamEnumType.lockDerived";
		ICFBamEnumType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamEnumType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamEnumType[] retList = new ICFBamEnumType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffEnumType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamEnumType ) {
			return( (ICFBamEnumType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamEnumType ) ) {
					filteredList.add( (ICFBamEnumType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamEnumType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey key = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryEnumType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamEnumType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffEnumType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamEnumType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffEnumType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffEnumType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffEnumType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamEnumType[0];
		}
		return( recArray );
	}
	...
	public ICFBamEnumType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamEnumType.readRec";
		ICFBamEnumType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamEnumType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamEnumType.readAllRec";
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamEnumType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamEnumType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamEnumType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamEnumType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamEnumType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamEnumType.readRecBySchemaIdx() ";
		ICFBamEnumType buff;
		ArrayList<ICFBamEnumType> filteredList = new ArrayList<ICFBamEnumType>();
		ICFBamEnumType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamEnumType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffEnumType)editCur );
	}
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryEnumType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffEnumTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryEnumType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffEnumType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffEnumType >();
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumType Buff = (CFBamBuffEnumType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffEnumType existing = dictByPKey.get( pkey );
		if( existing == null ) {
