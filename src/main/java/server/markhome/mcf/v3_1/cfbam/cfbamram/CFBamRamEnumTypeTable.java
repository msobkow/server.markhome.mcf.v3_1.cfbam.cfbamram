	...
	implements ICFBamEnumTypeTable
{
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey key = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getFactoryEnumType().newBySchemaIdxKey();
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getFactoryEnumType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffEnumTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getFactoryEnumType().newBySchemaIdxKey();
