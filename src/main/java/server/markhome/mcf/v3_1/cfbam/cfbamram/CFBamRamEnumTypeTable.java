	...
	implements ICFBamEnumTypeTable
{
		...
		ICFBamEnumType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffEnumType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffEnumType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffEnumType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffEnumType >();
		...
		ICFBamEnumType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffEnumType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffEnumType >();
