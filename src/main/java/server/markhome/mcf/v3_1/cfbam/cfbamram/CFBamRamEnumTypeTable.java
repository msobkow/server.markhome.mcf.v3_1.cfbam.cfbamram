	...
	implements ICFBamEnumTypeTable
{
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryEnumType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey key = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryEnumType().newBySchemaIdxKey();
		...
		ICFBamEnumType iBuff )
	{
		...
		CFBamBuffEnumTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryEnumType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffEnumTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffEnumTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryEnumType().newBySchemaIdxKey();
