	...
	implements ICFBamBoolTypeTable
{
		...
		ICFBamBoolType iBuff )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getFactoryBoolType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey key = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getFactoryBoolType().newBySchemaIdxKey();
		...
		ICFBamBoolType iBuff )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getFactoryBoolType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBoolTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getFactoryBoolType().newBySchemaIdxKey();
