	...
	implements ICFBamBoolTypeTable
{
		...
		ICFBamBoolType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBoolType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffBoolType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffBoolType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffBoolType >();
		...
		ICFBamBoolType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffBoolType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffBoolType >();
