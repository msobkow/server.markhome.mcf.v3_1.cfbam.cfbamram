	...
	implements ICFBamBoolTypeTable
{
		...
		ICFBamBoolType iBuff )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBoolType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey key = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBoolType().newBySchemaIdxKey();
		...
		ICFBamBoolType iBuff )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBoolType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBoolTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryBoolType().newBySchemaIdxKey();
