...
// Description: Java 25 in-memory RAM DbIO implementation for BoolType.
	...
	implements ICFBamBoolTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffBoolType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffBoolType >();
	private Map< CFBamBuffBoolTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBoolType >> dictBySchemaIdx
		= new HashMap< CFBamBuffBoolTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffBoolType >>();
	...
	public ICFBamBoolType createBoolType( ICFSecAuthorization Authorization,
		ICFBamBoolType iBuff )
	{
		final String S_ProcName = "createBoolType";
		
		CFBamBuffBoolType Buff = (CFBamBuffBoolType)(schema.getTableBoolDef().createBoolDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamBoolType.CLASS_CODE ) {
		...
		CFBamBuffBoolTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBoolType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBoolType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffBoolType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamBoolType.CLASS_CODE) {
	...
	public ICFBamBoolType lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBoolType.lockDerived";
		ICFBamBoolType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamBoolType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamBoolType[] retList = new ICFBamBoolType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffBoolType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamBoolType ) {
			return( (ICFBamBoolType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamBoolType ) ) {
					filteredList.add( (ICFBamBoolType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamBoolType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey key = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBoolType().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamBoolType[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffBoolType > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamBoolType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffBoolType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffBoolType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffBoolType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamBoolType[0];
		}
		return( recArray );
	}
	...
	public ICFBamBoolType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamBoolType.readRec";
		ICFBamBoolType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamBoolType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamBoolType.readAllRec";
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBoolType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamBoolType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamBoolType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamBoolType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamBoolType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamBoolType.readRecBySchemaIdx() ";
		ICFBamBoolType buff;
		ArrayList<ICFBamBoolType> filteredList = new ArrayList<ICFBamBoolType>();
		ICFBamBoolType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamBoolType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffBoolType)editCur );
	}
	...
	public ICFBamBoolType updateBoolType( ICFSecAuthorization Authorization,
		ICFBamBoolType iBuff )
	{
		CFBamBuffBoolType Buff = (CFBamBuffBoolType)(schema.getTableBoolDef().updateBoolDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffBoolType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBoolTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBoolType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBoolTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffBoolTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryBoolType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffBoolType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffBoolType >();
		...
		ICFBamBoolType iBuff )
	{
		...
		CFBamBuffBoolType Buff = (CFBamBuffBoolType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffBoolType existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffBoolType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffBoolType> matchSet = new LinkedList<CFBamBuffBoolType>();
		Iterator<CFBamBuffBoolType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffBoolType> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffBoolType)(schema.getTableBoolType().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
