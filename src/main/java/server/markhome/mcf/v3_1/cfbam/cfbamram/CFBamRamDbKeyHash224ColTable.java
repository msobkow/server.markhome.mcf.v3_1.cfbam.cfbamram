	...
	implements ICFBamDbKeyHash224ColTable
{
		...
		ICFBamDbKeyHash224Col iBuff )
	{
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getFactoryDbKeyHash224Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey key = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getFactoryDbKeyHash224Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash224Col iBuff )
	{
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getFactoryDbKeyHash224Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash224ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getFactoryDbKeyHash224Col().newByTableIdxKey();
