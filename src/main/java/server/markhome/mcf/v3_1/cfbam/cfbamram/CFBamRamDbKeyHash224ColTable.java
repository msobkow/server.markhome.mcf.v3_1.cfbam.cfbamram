	...
	implements ICFBamDbKeyHash224ColTable
{
		...
		ICFBamDbKeyHash224Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col >();
		...
		ICFBamDbKeyHash224Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash224Col >();
