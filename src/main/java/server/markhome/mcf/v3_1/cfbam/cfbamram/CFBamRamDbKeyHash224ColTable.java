...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash224Col.
	...
	implements ICFBamDbKeyHash224ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash224Col >();
	private Map< CFBamBuffDbKeyHash224ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash224Col >> dictByTableIdx
		= new HashMap< CFBamBuffDbKeyHash224ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash224Col >>();
	...
	public ICFBamDbKeyHash224Col createDbKeyHash224Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Col iBuff )
	{
		final String S_ProcName = "createDbKeyHash224Col";
		
		CFBamBuffDbKeyHash224Col Buff = (CFBamBuffDbKeyHash224Col)(schema.getTableDbKeyHash224Def().createDbKeyHash224Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash224Col.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash224Col.CLASS_CODE) {
	...
	public ICFBamDbKeyHash224Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.lockDerived";
		ICFBamDbKeyHash224Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash224Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash224Col[] retList = new ICFBamDbKeyHash224Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash224Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash224Col ) {
			return( (ICFBamDbKeyHash224Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash224Col ) ) {
					filteredList.add( (ICFBamDbKeyHash224Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash224Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey key = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDbKeyHash224Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDbKeyHash224Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDbKeyHash224Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDbKeyHash224Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash224Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readRec";
		ICFBamDbKeyHash224Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash224Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readAllRec";
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash224Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash224Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash224Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash224Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash224Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readRecByTableIdx() ";
		ICFBamDbKeyHash224Col buff;
		ArrayList<ICFBamDbKeyHash224Col> filteredList = new ArrayList<ICFBamDbKeyHash224Col>();
		ICFBamDbKeyHash224Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash224Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash224Col)cur );
		}
		...
		return( (CFBamBuffDbKeyHash224Col)editCur );
	}
	...
	public ICFBamDbKeyHash224Col updateDbKeyHash224Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Col iBuff )
	{
		CFBamBuffDbKeyHash224Col Buff = (CFBamBuffDbKeyHash224Col)(schema.getTableDbKeyHash224Def().updateDbKeyHash224Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash224Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash224ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash224ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash224ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash224Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash224Col >();
		...
		ICFBamDbKeyHash224Col iBuff )
	{
		...
		CFBamBuffDbKeyHash224Col Buff = (CFBamBuffDbKeyHash224Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash224Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash224Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash224Col> matchSet = new LinkedList<CFBamBuffDbKeyHash224Col>();
		Iterator<CFBamBuffDbKeyHash224Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash224Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash224Col)(schema.getTableDbKeyHash224Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
