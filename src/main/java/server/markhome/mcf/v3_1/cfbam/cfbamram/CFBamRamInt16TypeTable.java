	...
	implements ICFBamInt16TypeTable
{
		...
		ICFBamInt16Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt16Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt16Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Type >();
		...
		ICFBamInt16Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt16Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt16Type >();
