	...
	implements ICFBamInt16TypeTable
{
		...
		ICFBamInt16Type iBuff )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getFactoryInt16Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey key = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getFactoryInt16Type().newBySchemaIdxKey();
		...
		ICFBamInt16Type iBuff )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getFactoryInt16Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt16TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getFactoryInt16Type().newBySchemaIdxKey();
