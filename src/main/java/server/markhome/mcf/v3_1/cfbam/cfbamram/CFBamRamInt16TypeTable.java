...
// Description: Java 25 in-memory RAM DbIO implementation for Int16Type.
	...
	implements ICFBamInt16TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt16Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt16Type >();
	private Map< CFBamBuffInt16TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt16Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffInt16TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt16Type >>();
	...
	public ICFBamInt16Type createInt16Type( ICFSecAuthorization Authorization,
		ICFBamInt16Type iBuff )
	{
		final String S_ProcName = "createInt16Type";
		
		CFBamBuffInt16Type Buff = (CFBamBuffInt16Type)(schema.getTableInt16Def().createInt16Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt16Type.CLASS_CODE ) {
		...
		CFBamBuffInt16TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt16Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt16Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt16Type.CLASS_CODE) {
	...
	public ICFBamInt16Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Type.lockDerived";
		ICFBamInt16Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt16Type[] retList = new ICFBamInt16Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt16Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt16Type ) {
			return( (ICFBamInt16Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt16Type ) ) {
					filteredList.add( (ICFBamInt16Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt16Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey key = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamInt16Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt16Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamInt16Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffInt16Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt16Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt16Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamInt16Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt16Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt16Type.readRec";
		ICFBamInt16Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt16Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt16Type.readAllRec";
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt16Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt16Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt16Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt16Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt16Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamInt16Type.readRecBySchemaIdx() ";
		ICFBamInt16Type buff;
		ArrayList<ICFBamInt16Type> filteredList = new ArrayList<ICFBamInt16Type>();
		ICFBamInt16Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt16Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt16Type)editCur );
	}
	...
	public ICFBamInt16Type updateInt16Type( ICFSecAuthorization Authorization,
		ICFBamInt16Type iBuff )
	{
		CFBamBuffInt16Type Buff = (CFBamBuffInt16Type)(schema.getTableInt16Def().updateInt16Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt16Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt16TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt16TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt16TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt16Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt16Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt16Type >();
		...
		ICFBamInt16Type iBuff )
	{
		...
		CFBamBuffInt16Type Buff = (CFBamBuffInt16Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt16Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamInt16TypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffInt16Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffInt16Type> matchSet = new LinkedList<CFBamBuffInt16Type>();
		Iterator<CFBamBuffInt16Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt16Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt16Type)(schema.getTableInt16Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
			int subClassCode = cur.getClassCode();
			if( ICFBamInt16Type.CLASS_CODE == subClassCode ) {
