	...
	implements ICFBamDbKeyHash160ColTable
{
		...
		ICFBamDbKeyHash160Col iBuff )
	{
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getFactoryDbKeyHash160Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey key = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getFactoryDbKeyHash160Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash160Col iBuff )
	{
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getFactoryDbKeyHash160Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash160ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getFactoryDbKeyHash160Col().newByTableIdxKey();
