...
// Description: Java 25 in-memory RAM DbIO implementation for DbKeyHash160Col.
	...
	implements ICFBamDbKeyHash160ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffDbKeyHash160Col >();
	private Map< CFBamBuffDbKeyHash160ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash160Col >> dictByTableIdx
		= new HashMap< CFBamBuffDbKeyHash160ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffDbKeyHash160Col >>();
	...
	public ICFBamDbKeyHash160Col createDbKeyHash160Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Col iBuff )
	{
		final String S_ProcName = "createDbKeyHash160Col";
		
		CFBamBuffDbKeyHash160Col Buff = (CFBamBuffDbKeyHash160Col)(schema.getTableDbKeyHash160Def().createDbKeyHash160Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamDbKeyHash160Col.CLASS_CODE ) {
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamDbKeyHash160Col.CLASS_CODE) {
	...
	public ICFBamDbKeyHash160Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.lockDerived";
		ICFBamDbKeyHash160Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamDbKeyHash160Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamDbKeyHash160Col[] retList = new ICFBamDbKeyHash160Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffDbKeyHash160Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamDbKeyHash160Col ) {
			return( (ICFBamDbKeyHash160Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamDbKeyHash160Col ) ) {
					filteredList.add( (ICFBamDbKeyHash160Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamDbKeyHash160Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey key = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamDbKeyHash160Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamDbKeyHash160Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffDbKeyHash160Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamDbKeyHash160Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamDbKeyHash160Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readRec";
		ICFBamDbKeyHash160Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamDbKeyHash160Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readAllRec";
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamDbKeyHash160Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamDbKeyHash160Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamDbKeyHash160Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamDbKeyHash160Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readRecByTableIdx() ";
		ICFBamDbKeyHash160Col buff;
		ArrayList<ICFBamDbKeyHash160Col> filteredList = new ArrayList<ICFBamDbKeyHash160Col>();
		ICFBamDbKeyHash160Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamDbKeyHash160Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffDbKeyHash160Col)cur );
		}
		...
		return( (CFBamBuffDbKeyHash160Col)editCur );
	}
	...
	public ICFBamDbKeyHash160Col updateDbKeyHash160Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Col iBuff )
	{
		CFBamBuffDbKeyHash160Col Buff = (CFBamBuffDbKeyHash160Col)(schema.getTableDbKeyHash160Def().updateDbKeyHash160Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffDbKeyHash160Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash160ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash160ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash160ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash160Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash160Col >();
		...
		ICFBamDbKeyHash160Col iBuff )
	{
		...
		CFBamBuffDbKeyHash160Col Buff = (CFBamBuffDbKeyHash160Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffDbKeyHash160Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffDbKeyHash160Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffDbKeyHash160Col> matchSet = new LinkedList<CFBamBuffDbKeyHash160Col>();
		Iterator<CFBamBuffDbKeyHash160Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffDbKeyHash160Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffDbKeyHash160Col)(schema.getTableDbKeyHash160Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
