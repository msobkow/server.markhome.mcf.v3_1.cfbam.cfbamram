	...
	implements ICFBamDbKeyHash160ColTable
{
		...
		ICFBamDbKeyHash160Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col >();
		...
		ICFBamDbKeyHash160Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffDbKeyHash160Col >();
