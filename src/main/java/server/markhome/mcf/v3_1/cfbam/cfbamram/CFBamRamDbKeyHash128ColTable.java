	...
	implements ICFBamDbKeyHash128ColTable
{
		...
		ICFBamDbKeyHash128Col iBuff )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col >();
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey key = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col >();
	...
	public ICFBamDbKeyHash128Col updateDbKeyHash128Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Col iBuff )
	{
		CFBamBuffDbKeyHash128Col Buff = (CFBamBuffDbKeyHash128Col)(schema.getTableDbKeyHash128Def().updateDbKeyHash128Def( Authorization,	iBuff ));
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash128ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffDbKeyHash128Col >();
