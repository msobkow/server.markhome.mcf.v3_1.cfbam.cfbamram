	...
	implements ICFBamDbKeyHash128ColTable
{
		...
		ICFBamDbKeyHash128Col iBuff )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey keyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey key = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		...
		ICFBamDbKeyHash128Col iBuff )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey existingKeyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash128ColByTableIdxKey newKeyTableIdx = (CFBamBuffDbKeyHash128ColByTableIdxKey)schema.getCFBamFactory().getFactoryDbKeyHash128Col().newByTableIdxKey();
