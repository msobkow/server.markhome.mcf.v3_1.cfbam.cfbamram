	...
	implements ICFBamUInt64TypeTable
{
		...
		ICFBamUInt64Type iBuff )
	{
		...
		CFBamBuffUInt64TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt64TypeBySchemaIdxKey key = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		...
		ICFBamUInt64Type iBuff )
	{
		...
		CFBamBuffUInt64TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt64TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUInt64Type().newBySchemaIdxKey();
