	...
	implements ICFBamUInt64TypeTable
{
		...
		ICFBamUInt64Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt64Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUInt64Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Type >();
		...
		ICFBamUInt64Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUInt64Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUInt64Type >();
