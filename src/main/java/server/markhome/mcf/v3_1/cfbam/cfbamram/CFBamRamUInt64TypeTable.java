...
// Description: Java 25 in-memory RAM DbIO implementation for UInt64Type.
	...
	implements ICFBamUInt64TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUInt64Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUInt64Type >();
	private Map< CFBamBuffUInt64TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt64Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffUInt64TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUInt64Type >>();
	...
	public ICFBamUInt64Type createUInt64Type( ICFSecAuthorization Authorization,
		ICFBamUInt64Type iBuff )
	{
		final String S_ProcName = "createUInt64Type";
		
		CFBamBuffUInt64Type Buff = (CFBamBuffUInt64Type)(schema.getTableUInt64Def().createUInt64Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUInt64Type.CLASS_CODE ) {
		...
		CFBamBuffUInt64TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt64Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUInt64Type.CLASS_CODE) {
	...
	public ICFBamUInt64Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Type.lockDerived";
		ICFBamUInt64Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamUInt64Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUInt64Type[] retList = new ICFBamUInt64Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUInt64Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUInt64Type ) {
			return( (ICFBamUInt64Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUInt64Type ) ) {
					filteredList.add( (ICFBamUInt64Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUInt64Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUInt64TypeBySchemaIdxKey key = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamUInt64Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffUInt64Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamUInt64Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffUInt64Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUInt64Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamUInt64Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamUInt64Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUInt64Type.readRec";
		ICFBamUInt64Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUInt64Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUInt64Type.readAllRec";
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt64Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUInt64Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUInt64Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUInt64Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUInt64Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUInt64Type.readRecBySchemaIdx() ";
		ICFBamUInt64Type buff;
		ArrayList<ICFBamUInt64Type> filteredList = new ArrayList<ICFBamUInt64Type>();
		ICFBamUInt64Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUInt64Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffUInt64Type)cur );
		}
		...
		return( (CFBamBuffUInt64Type)editCur );
	}
	...
	public ICFBamUInt64Type updateUInt64Type( ICFSecAuthorization Authorization,
		ICFBamUInt64Type iBuff )
	{
		CFBamBuffUInt64Type Buff = (CFBamBuffUInt64Type)(schema.getTableUInt64Def().updateUInt64Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUInt64Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt64TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUInt64TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUInt64TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUInt64Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUInt64Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUInt64Type >();
		...
		ICFBamUInt64Type iBuff )
	{
		...
		CFBamBuffUInt64Type Buff = (CFBamBuffUInt64Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUInt64Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffUInt64Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUInt64Type> matchSet = new LinkedList<CFBamBuffUInt64Type>();
		Iterator<CFBamBuffUInt64Type> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUInt64Type> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffUInt64Type)(schema.getTableUInt64Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
