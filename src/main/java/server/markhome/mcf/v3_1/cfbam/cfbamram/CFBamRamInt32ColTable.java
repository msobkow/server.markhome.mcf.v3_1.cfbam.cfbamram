...
// Description: Java 25 in-memory RAM DbIO implementation for Int32Col.
	...
	implements ICFBamInt32ColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt32Col > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt32Col >();
	private Map< CFBamBuffInt32ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt32Col >> dictByTableIdx
		= new HashMap< CFBamBuffInt32ColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt32Col >>();
	...
	public ICFBamInt32Col createInt32Col( ICFSecAuthorization Authorization,
		ICFBamInt32Col iBuff )
	{
		final String S_ProcName = "createInt32Col";
		
		CFBamBuffInt32Col Buff = (CFBamBuffInt32Col)(schema.getTableInt32Def().createInt32Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt32Col.CLASS_CODE ) {
		...
		CFBamBuffInt32ColByTableIdxKey keyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt32Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt32Col >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt32Col.CLASS_CODE) {
	...
	public ICFBamInt32Col lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Col.lockDerived";
		ICFBamInt32Col buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt32Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt32Col[] retList = new ICFBamInt32Col[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt32Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt32Col ) {
			return( (ICFBamInt32Col)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt32Col ) ) {
					filteredList.add( (ICFBamInt32Col)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt32Col[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffInt32ColByTableIdxKey key = (CFBamBuffInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Col().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamInt32Col[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt32Col > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamInt32Col[ subdictTableIdx.size() ];
			Iterator< CFBamBuffInt32Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt32Col > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt32Col >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamInt32Col[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt32Col readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Col.readRec";
		ICFBamInt32Col buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt32Col.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt32Col.readAllRec";
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt32Col.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt32Col buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt32Col buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt32Col)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt32Col[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamInt32Col.readRecByTableIdx() ";
		ICFBamInt32Col buff;
		ArrayList<ICFBamInt32Col> filteredList = new ArrayList<ICFBamInt32Col>();
		ICFBamInt32Col[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt32Col.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt32Col)editCur );
	}
	...
	public ICFBamInt32Col updateInt32Col( ICFSecAuthorization Authorization,
		ICFBamInt32Col iBuff )
	{
		CFBamBuffInt32Col Buff = (CFBamBuffInt32Col)(schema.getTableInt32Def().updateInt32Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt32Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt32ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt32ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Col().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt32Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt32Col >();
		...
		ICFBamInt32Col iBuff )
	{
		...
		CFBamBuffInt32Col Buff = (CFBamBuffInt32Col)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt32Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffInt32Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffInt32Col> matchSet = new LinkedList<CFBamBuffInt32Col>();
		Iterator<CFBamBuffInt32Col> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffInt32Col> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffInt32Col)(schema.getTableInt32Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
