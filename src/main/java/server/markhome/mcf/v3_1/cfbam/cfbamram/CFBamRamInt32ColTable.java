	...
	implements ICFBamInt32ColTable
{
		...
		ICFBamInt32Col iBuff )
	{
		...
		CFBamBuffInt32ColByTableIdxKey keyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getFactoryInt32Col().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt32ColByTableIdxKey key = (CFBamBuffInt32ColByTableIdxKey)schema.getFactoryInt32Col().newByTableIdxKey();
		...
		ICFBamInt32Col iBuff )
	{
		...
		CFBamBuffInt32ColByTableIdxKey existingKeyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getFactoryInt32Col().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt32ColByTableIdxKey newKeyTableIdx = (CFBamBuffInt32ColByTableIdxKey)schema.getFactoryInt32Col().newByTableIdxKey();
