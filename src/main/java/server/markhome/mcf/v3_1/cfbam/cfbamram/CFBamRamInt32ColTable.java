	...
	implements ICFBamInt32ColTable
{
		...
		ICFBamInt32Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt32Col > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Col >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt32Col > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Col >();
		...
		ICFBamInt32Col iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt32Col > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Col >();
