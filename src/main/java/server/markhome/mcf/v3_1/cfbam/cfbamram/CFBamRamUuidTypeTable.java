	...
	implements ICFBamUuidTypeTable
{
		...
		ICFBamUuidType iBuff )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getFactoryUuidType().newBySchemaIdxKey();
		...
		ICFBamUuidType iBuff )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getFactoryUuidType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuidTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getFactoryUuidType().newBySchemaIdxKey();
