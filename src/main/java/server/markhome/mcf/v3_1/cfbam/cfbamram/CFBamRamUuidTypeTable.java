	...
	implements ICFBamUuidTypeTable
{
		...
		ICFBamUuidType iBuff )
	{
		...
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			...
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffUuidType >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffUuidType > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffUuidType >();
		...
		ICFBamUuidType iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffUuidType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffUuidType >();
