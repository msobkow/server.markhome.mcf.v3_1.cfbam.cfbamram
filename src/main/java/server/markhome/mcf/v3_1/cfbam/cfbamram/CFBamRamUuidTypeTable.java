...
// Description: Java 25 in-memory RAM DbIO implementation for UuidType.
	...
	implements ICFBamUuidTypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffUuidType > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffUuidType >();
	private Map< CFBamBuffUuidTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuidType >> dictBySchemaIdx
		= new HashMap< CFBamBuffUuidTypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffUuidType >>();
	...
	public ICFBamUuidType createUuidType( ICFSecAuthorization Authorization,
		ICFBamUuidType iBuff )
	{
		final String S_ProcName = "createUuidType";
		
		CFBamBuffUuidType Buff = (CFBamBuffUuidType)(schema.getTableUuidDef().createUuidDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamUuidType.CLASS_CODE ) {
		...
		CFBamBuffUuidTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuidType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidType > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffUuidType >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamUuidType.CLASS_CODE) {
	...
	public ICFBamUuidType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamUuidType[] retList = new ICFBamUuidType[ dictByPKey.values().size() ];
		Iterator< CFBamBuffUuidType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamUuidType ) {
			return( (ICFBamUuidType)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamUuidType ) ) {
					filteredList.add( (ICFBamUuidType)buff );
				}
			}
			return( filteredList.toArray( new ICFBamUuidType[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey key = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuidType().newBySchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			recArray = new ICFBamUuidType[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffUuidType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffUuidType > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffUuidType >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamUuidType[0];
		}
		return( recArray );
	}
	...
	public ICFBamUuidType readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamUuidType.readRec";
		ICFBamUuidType buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamUuidType.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamUuidType.readAllRec";
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidType.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamUuidType buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamUuidType buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamUuidType)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamUuidType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUuidType.readRecBySchemaIdx() ";
		ICFBamUuidType buff;
		ArrayList<ICFBamUuidType> filteredList = new ArrayList<ICFBamUuidType>();
		ICFBamUuidType[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamUuidType.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffUuidType)editCur );
	}
	...
	public ICFBamUuidType updateUuidType( ICFSecAuthorization Authorization,
		ICFBamUuidType iBuff )
	{
		CFBamBuffUuidType Buff = (CFBamBuffUuidType)(schema.getTableUuidDef().updateUuidDef( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffUuidType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuidTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuidType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuidTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryUuidType().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffUuidType > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffUuidType >();
		...
		ICFBamUuidType iBuff )
	{
		...
		CFBamBuffUuidType Buff = (CFBamBuffUuidType)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffUuidType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamUuidTypeBySchemaIdxKey argKey )
	{
		...
		CFBamBuffUuidType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffUuidType> matchSet = new LinkedList<CFBamBuffUuidType>();
		Iterator<CFBamBuffUuidType> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffUuidType> iterMatch = matchSet.iterator();
