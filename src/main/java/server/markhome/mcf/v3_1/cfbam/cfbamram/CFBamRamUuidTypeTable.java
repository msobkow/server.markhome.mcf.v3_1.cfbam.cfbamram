	...
	implements ICFBamUuidTypeTable
{
		...
		ICFBamUuidType iBuff )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey keySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUuidType().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey key = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUuidType().newBySchemaIdxKey();
		...
		ICFBamUuidType iBuff )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUuidType().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuidTypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffUuidTypeBySchemaIdxKey)schema.getCFBamFactory().getFactoryUuidType().newBySchemaIdxKey();
