...
// Description: Java 25 in-memory RAM DbIO implementation for NmTokenCol.
	...
	implements ICFBamNmTokenColTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffNmTokenCol > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffNmTokenCol >();
	private Map< CFBamBuffNmTokenColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokenCol >> dictByTableIdx
		= new HashMap< CFBamBuffNmTokenColByTableIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffNmTokenCol >>();
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenCol Buff = (CFBamBuffNmTokenCol)(schema.getTableNmTokenDef().createNmTokenDef( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamNmTokenCol.CLASS_CODE ) {
		...
		CFBamBuffNmTokenColByTableIdxKey keyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokenCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokenCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokenCol >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamNmTokenCol.CLASS_CODE) {
	...
	public ICFBamNmTokenCol lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokenCol.lockDerived";
		ICFBamNmTokenCol buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamNmTokenCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamNmTokenCol[] retList = new ICFBamNmTokenCol[ dictByPKey.values().size() ];
		Iterator< CFBamBuffNmTokenCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamNmTokenCol ) {
			return( (ICFBamNmTokenCol)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamNmTokenCol ) ) {
					filteredList.add( (ICFBamNmTokenCol)buff );
				}
			}
			return( filteredList.toArray( new ICFBamNmTokenCol[0] ) );
		}
	}
		...
		ICFLibKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey key = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokenCol().newByTableIdxKey();

		key.setRequiredTableId( TableId );
		ICFBamNmTokenCol[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffNmTokenCol > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new ICFBamNmTokenCol[ subdictTableIdx.size() ];
			Iterator< CFBamBuffNmTokenCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffNmTokenCol > subdictTableIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffNmTokenCol >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new ICFBamNmTokenCol[0];
		}
		return( recArray );
	}
	...
	public ICFBamNmTokenCol readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamNmTokenCol.readRec";
		ICFBamNmTokenCol buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamNmTokenCol.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamNmTokenCol.readAllRec";
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokenCol.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamNmTokenCol buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamNmTokenCol buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamNmTokenCol)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamNmTokenCol[] readRecByTableIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 TableId )
	{
		final String S_ProcName = "CFBamRamNmTokenCol.readRecByTableIdx() ";
		ICFBamNmTokenCol buff;
		ArrayList<ICFBamNmTokenCol> filteredList = new ArrayList<ICFBamNmTokenCol>();
		ICFBamNmTokenCol[] buffList = readDerivedByTableIdx( Authorization,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamNmTokenCol.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		{
			return( (CFBamBuffNmTokenCol)cur );
		}
		...
		return( (CFBamBuffNmTokenCol)editCur );
	}
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamBuffFactory().getFactoryNmTokenCol().newByTableIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffNmTokenCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffNmTokenCol >();
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenCol Buff = (CFBamBuffNmTokenCol)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffNmTokenCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
	...
	{
		CFBamBuffNmTokenCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<CFBamBuffNmTokenCol> matchSet = new LinkedList<CFBamBuffNmTokenCol>();
		Iterator<CFBamBuffNmTokenCol> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamBuffNmTokenCol> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = (CFBamBuffNmTokenCol)(schema.getTableNmTokenCol().readDerivedByIdIdx( Authorization,
				cur.getRequiredId() ));
