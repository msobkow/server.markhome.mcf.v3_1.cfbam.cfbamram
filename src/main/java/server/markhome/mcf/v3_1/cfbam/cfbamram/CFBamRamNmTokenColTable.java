	...
	implements ICFBamNmTokenColTable
{
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey key = (CFBamBuffNmTokenColByTableIdxKey)schema.getFactoryNmTokenCol().newByTableIdxKey();
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getFactoryNmTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getFactoryNmTokenCol().newByTableIdxKey();
