	...
	implements ICFBamNmTokenColTable
{
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokenCol > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokenCol >();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffNmTokenCol > subdictTableIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokenCol >();
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffNmTokenCol > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffNmTokenCol >();
