	...
	implements ICFBamNmTokenColTable
{
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey keyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey key = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
		...
		ICFBamNmTokenCol iBuff )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey existingKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokenColByTableIdxKey newKeyTableIdx = (CFBamBuffNmTokenColByTableIdxKey)schema.getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
