	...
	implements ICFBamInt32TypeTable
{
		...
		ICFBamInt32Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt32Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Type >();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Map< CFLibDbKeyHash256, CFBamBuffInt32Type > subdictSchemaIdx
				= new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Type >();
		...
		ICFBamInt32Type iBuff )
	{
		...
		Map< CFLibDbKeyHash256, CFBamBuffInt32Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFLibDbKeyHash256, CFBamBuffInt32Type >();
