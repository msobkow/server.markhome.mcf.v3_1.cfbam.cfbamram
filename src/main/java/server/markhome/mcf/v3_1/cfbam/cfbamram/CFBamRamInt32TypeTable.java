	...
	implements ICFBamInt32TypeTable
{
		...
		ICFBamInt32Type iBuff )
	{
		...
		CFBamBuffInt32TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getFactoryInt32Type().newBySchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt32TypeBySchemaIdxKey key = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getFactoryInt32Type().newBySchemaIdxKey();
		...
		ICFBamInt32Type iBuff )
	{
		...
		CFBamBuffInt32TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getFactoryInt32Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt32TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getFactoryInt32Type().newBySchemaIdxKey();
