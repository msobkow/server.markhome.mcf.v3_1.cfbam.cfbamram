...
// Description: Java 25 in-memory RAM DbIO implementation for Int32Type.
	...
	implements ICFBamInt32TypeTable
{
	...
	private Map< ICFLibKeyHash256,
				CFBamBuffInt32Type > dictByPKey
		= new HashMap< ICFLibKeyHash256,
				CFBamBuffInt32Type >();
	private Map< CFBamBuffInt32TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt32Type >> dictBySchemaIdx
		= new HashMap< CFBamBuffInt32TypeBySchemaIdxKey,
				Map< ICFLibKeyHash256,
					CFBamBuffInt32Type >>();
	...
	public ICFBamInt32Type createInt32Type( ICFSecAuthorization Authorization,
		ICFBamInt32Type iBuff )
	{
		final String S_ProcName = "createInt32Type";
		
		CFBamBuffInt32Type Buff = (CFBamBuffInt32Type)(schema.getTableInt32Def().createInt32Def( Authorization,
			iBuff ));
		ICFBamValue tail = null;
		if( Buff.getClassCode() == ICFBamInt32Type.CLASS_CODE ) {
		...
		CFBamBuffInt32TypeBySchemaIdxKey keySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt32Type > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< ICFLibKeyHash256, CFBamBuffInt32Type >();
		...
		if (Buff == null) {
			...
			if (classCode == ICFBamInt32Type.CLASS_CODE) {
	...
	public ICFBamInt32Type lockDerived( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Type.lockDerived";
		ICFBamInt32Type buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFBamInt32Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		ICFBamInt32Type[] retList = new ICFBamInt32Type[ dictByPKey.values().size() ];
		Iterator< CFBamBuffInt32Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		String Name )
	{
		...
		else if( buff instanceof ICFBamInt32Type ) {
			return( (ICFBamInt32Type)buff );
		}
		else {
			return( null );
		}
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		if( buffList == null ) {
			...
			ICFBamValue buff;
			ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof ICFBamInt32Type ) ) {
					filteredList.add( (ICFBamInt32Type)buff );
				}
			}
			return( filteredList.toArray( new ICFBamInt32Type[0] ) );
		}
	}
		...
		ICFLibKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt32TypeBySchemaIdxKey key = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Type().newBySchemaIdxKey();

		key.setRequiredSchemaDefId( SchemaDefId );
		ICFBamInt32Type[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< ICFLibKeyHash256, CFBamBuffInt32Type > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new ICFBamInt32Type[ subdictSchemaIdx.size() ];
			Iterator< CFBamBuffInt32Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< ICFLibKeyHash256, CFBamBuffInt32Type > subdictSchemaIdx
				= new HashMap< ICFLibKeyHash256, CFBamBuffInt32Type >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new ICFBamInt32Type[0];
		}
		return( recArray );
	}
	...
	public ICFBamInt32Type readRec( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamInt32Type.readRec";
		ICFBamInt32Type buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( buff.getClassCode() != ICFBamInt32Type.CLASS_CODE ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	{
		final String S_ProcName = "CFBamRamInt32Type.readAllRec";
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt32Type.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 Id )
	{
		...
		ICFBamInt32Type buff = readDerivedByIdIdx( Authorization,
			Id );
		...
		String Name )
	{
		...
		ICFBamInt32Type buff = readDerivedByUNameIdx( Authorization,
			ScopeId,
			Name );
		if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
			return( (ICFBamInt32Type)buff );
		...
		ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByScopeIdx( Authorization,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByPrevIdx( Authorization,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByNextIdx( Authorization,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamValue.CLASS_CODE ) ) {
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByContPrevIdx( Authorization,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedByContNextIdx( Authorization,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public ICFBamInt32Type[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		ICFLibKeyHash256 SchemaDefId )
	{
		final String S_ProcName = "CFBamRamInt32Type.readRecBySchemaIdx() ";
		ICFBamInt32Type buff;
		ArrayList<ICFBamInt32Type> filteredList = new ArrayList<ICFBamInt32Type>();
		ICFBamInt32Type[] buffList = readDerivedBySchemaIdx( Authorization,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && ( buff.getClassCode() == ICFBamInt32Type.CLASS_CODE ) ) {
		...
		int revision )
	{
		...
		return( (CFBamBuffInt32Type)editCur );
	}
	...
	public ICFBamInt32Type updateInt32Type( ICFSecAuthorization Authorization,
		ICFBamInt32Type iBuff )
	{
		CFBamBuffInt32Type Buff = (CFBamBuffInt32Type)(schema.getTableInt32Def().updateInt32Def( Authorization,	iBuff ));
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)Buff.getPKey();
		CFBamBuffInt32Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt32TypeBySchemaIdxKey existingKeySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Type().newBySchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt32TypeBySchemaIdxKey newKeySchemaIdx = (CFBamBuffInt32TypeBySchemaIdxKey)schema.getCFBamBuffFactory().getFactoryInt32Type().newBySchemaIdxKey();
		...
		Map< ICFLibKeyHash256, CFBamBuffInt32Type > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFBamBuffInt32Type >();
		...
		ICFBamInt32Type iBuff )
	{
		...
		CFBamBuffInt32Type Buff = (CFBamBuffInt32Type)ensureRec(iBuff);
		int classCode;
		ICFLibKeyHash256 pkey = (ICFLibKeyHash256)(Buff.getPKey());
		CFBamBuffInt32Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		ICFBamInt32TypeBySchemaIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( ICFBamInt32Type.CLASS_CODE == subClassCode ) {
